...
type cb_1 from commandbutton within w_bom308i
end type
type st_1 from statictext within w_bom308i
end type
type sle_fromdt from singlelineedit within w_bom308i
end type
type sle_todt from singlelineedit within w_bom308i
end type
type st_6 from statictext within w_bom308i
end type
type gb_3 from groupbox within w_bom308i
end type
type gb_4 from groupbox within w_bom308i
end type
end forward
