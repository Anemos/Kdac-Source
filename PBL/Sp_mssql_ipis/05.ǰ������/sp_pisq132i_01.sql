/************************************************************************************************/
/*	File Name	: sp_pisq132i_01.SQL                                                            */
/*	SYSTEM		: 품질관리(부품품질)                                                            */
/*	Description	: 수입검사 불량율(품번별WORST-수량별)                                           */
...
/*	Author		: 대우정보-유종희                                                               */
/************************************************************************************************/
if exists (select * from sysobjects where id = object_id('dbo.sp_pisq132i_01') and sysstat & 0xf = 4)
	drop procedure dbo.sp_pisq132i_01
GO
/*
Exec sp_pisq132i_01
		@ps_AreaCode        = 'D'               ,
...
CREATE PROCEDURE sp_pisq132i_01
