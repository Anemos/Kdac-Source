/************************************************************************************************/
/*	File Name	: sp_pisq132i_02.SQL                                                            */
/*	SYSTEM		: 품질관리(부품품질)                                                            */
/*	Description	: 수입검사 불량율(품번별WORST-LOT별)                                            */
...
/*	Notes		: 수입검사 불량율 현황중 품번별 WORST 10의 자료를 조회한다.                     */
/*	Made Date	: 2002. 09. 13                                                                  */
/*	Author		: 대우정보-유종희                                                               */
/************************************************************************************************/
if exists (select * from sysobjects where id = object_id('dbo.sp_pisq132i_02') and sysstat & 0xf = 4)
	drop procedure dbo.sp_pisq132i_02
GO
/*
Exec sp_pisq132i_02
		@ps_AreaCode        = 'D'               ,
...
/****** Object:  Stored Procedure dbo.sp_pisq132i_02    Script Date: 02-09-01  ******/
CREATE PROCEDURE sp_pisq132i_02
