/************************************************************************************************/
/*	File Name	: sp_pisq430i_01.SQL                                                            */
/*	SYSTEM		: 품질관리(고객품질)                                                            */
/*	Description	: RRPPM 및 출하현황																*/
...
/*	Notes		: RRPPM 및 출하현황을 화면에 표시한다                                      		*/
/*	Made Date	: 2002. 10. 03                                                                  */
/*	Author		: 대우정보-유종희                                                               */
/************************************************************************************************/
if exists (select * from sysobjects where id = object_id('dbo.sp_pisq430i_01') and sysstat & 0xf = 4)
	drop procedure dbo.sp_pisq430i_01
GO
/*
Exec sp_pisq430i_01
		@ps_AreaCode        = 'D' ,
...
/****** Object:  Stored Procedure dbo.sp_pisq430i_01    Script Date: 02-09-01  ******/
CREATE PROCEDURE sp_pisq430i_01
