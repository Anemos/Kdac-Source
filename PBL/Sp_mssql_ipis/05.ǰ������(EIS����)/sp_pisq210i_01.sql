/************************************************************************************************/
/*	File Name	: sp_pisq210i_01.SQL                                                            */
/*	SYSTEM		: 품질관리(공정품질)                                                            */
/*	Description	: 일별 FTTQ 현황(제품대분류별)                                                */
...
/*	Notes		: 일별 FTTQ현황중 대분류별 자료를 조회한다.                                   */
/*	Made Date	: 2002. 09. 25                                                                  */
/*	Author		: 대우정보-유종희                                                               */
/************************************************************************************************/
if exists (select * from sysobjects where id = object_id('dbo.sp_pisq210i_01') and sysstat & 0xf = 4)
	drop procedure dbo.sp_pisq210i_01
GO
/*
Exec sp_pisq210i_01
		@ps_AreaCode        = 'D' ,
...
/****** Object:  Stored Procedure dbo.sp_pisq210i_01    Script Date: 02-09-01  ******/
CREATE PROCEDURE sp_pisq210i_01
