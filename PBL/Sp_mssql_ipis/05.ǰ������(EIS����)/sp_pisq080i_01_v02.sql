...
SELECT @li_rowcnt = COUNT(*) FROM TQQCRESULT
WHERE INSPECTORCODE = '무검사' AND JUDGEFLAG = '9' AND GOODQTY = SUPPLIERDELIVERYQTY

if @li_rowcnt > 0
 Begin
  UPDATE TQQCRESULT
  SET JUDGEFLAG = '1', CONFIRMFLAG = 'Y', CONFIRMCODE = '무검사'
  WHERE INSPECTORCODE = '무검사' AND JUDGEFLAG = '9' AND GOODQTY = SUPPLIERDELIVERYQTY
 End
