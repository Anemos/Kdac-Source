/************************************************************************************************/
/*	File Name	: sp_pisq210i_04.SQL                                                            */
/*	SYSTEM		: 품질관리(공정품질)                                                            */
/*	Description	: 일별 FTTQ 현황(제품소분류별공정별)                                            */
...
/*	Author		: 대우정보-유종희                                                               */
/************************************************************************************************/
if exists (select * from sysobjects where id = object_id('dbo.sp_pisq210i_04') and sysstat & 0xf = 4)
	drop procedure dbo.sp_pisq210i_04
GO
/*
Exec sp_pisq210i_04
		@ps_AreaCode        = 'D' ,
...
/****** Object:  Stored Procedure dbo.sp_pisq210i_04    Script Date: 02-09-01  ******/
CREATE PROCEDURE sp_pisq210i_04
	  ...
	  FROM (SELECT '#00'    AS AS_PROCESS,
		    ...
		    SELECT A.PROCESSCODE       AS AS_PROCESSCODE,
			 ...
			 WHERE A.AREACODE		 =  B.AREACODE
			   ...
			   AND A.SMALLGROUPCODE  =  @ps_smallgroupcode
			   AND B.MAFLAG          LIKE @ps_maflag
			 GROUP BY A.PROCESSCODE, D.PROCESSNAME, AS_YEARGOAL, D_BSTOT, D_S01, D_S02, D_S03, D_S04, D_S05, D_S06, D_S07,D_S08,
			 	   	  D_S09, D_S10, D_S11, D_S12, D_S13, D_S14, D_S15, D_S16, D_S17, D_S18, D_S19, D_S20, D_S21, D_S22, D_S23, 
			 	   	  D_S24, D_S25, D_S26, D_S27, D_S28, D_S29, D_S30, D_S31, D_STOT
	       ) TMP
