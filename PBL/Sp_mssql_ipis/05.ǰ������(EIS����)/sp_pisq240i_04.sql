/************************************************************************************************/
/*	File Name	: sp_pisq240i_04.SQL                                                            */
/*	SYSTEM		: 품질관리(공정품질)                                                            */
/*	Description	: 일별 SCRAP 현황(제품소분류별공정별)                                           */
...
/*	Author		: 대우정보-유종희                                                               */
/************************************************************************************************/
if exists (select * from sysobjects where id = object_id('dbo.sp_pisq240i_04') and sysstat & 0xf = 4)
	drop procedure dbo.sp_pisq240i_04
GO
/*
Exec sp_pisq240i_04
		@ps_AreaCode        = 'D' ,
...
/****** Object:  Stored Procedure dbo.sp_pisq240i_04    Script Date: 02-09-01  ******/
CREATE PROCEDURE sp_pisq240i_04
