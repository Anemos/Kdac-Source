/************************************************************************************************/
/*	File Name	: sp_pisq190i_03.SQL                                                            */
/*	SYSTEM		: 품질관리(공정품질)                                                            */
/*	Description	: 월별 FTTQ 현황(제품소분류별)                                                  */
...
/*	Author		: 대우정보-유종희                                                               */
/************************************************************************************************/
if exists (select * from sysobjects where id = object_id('dbo.sp_pisq190i_03') and sysstat & 0xf = 4)
	drop procedure dbo.sp_pisq190i_03
GO
/*
Exec sp_pisq190i_03
		@ps_AreaCode        = 'D' ,
...
/****** Object:  Stored Procedure dbo.sp_pisq190i_03    Script Date: 02-09-01  ******/
CREATE PROCEDURE sp_pisq190i_03
