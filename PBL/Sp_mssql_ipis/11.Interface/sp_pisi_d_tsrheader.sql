...
Truncate table pdsle301

Insert	into pdsle301
...
--		and	stcd <> 'C'
		...
		from	#tmp_pdsle301 a, sle302_temp b
		where	a.srno = @ls_srno
		and	a.srno = b.srno
		and	b.xplant = 'D'
		and	b.div in ('A')
...
--		and	stcd <> 'C'
		...
		If (@ls_area = 'H' or @ls_area = 'V' or @ls_area = 'Y' or @ls_area = 'N' or @ls_area = 'O' or @ls_area = 'P')
		Begin
