/*
	File Name	: sp_pisk240i_01.SQL
	SYSTEM		: KDAC 통합 생산 정보 시스템
	Procedure Name	: sp_pisk240i_01
	Description	: 월별 생산 추이 (라인별)
...
If Exists (Select * From sysobjects 
	    Where id = object_id(N'[dbo].[sp_pisk240i_01]')
	      And OBJECTPROPERTY(id, N'IsProcedure') = 1)
	Drop Procedure [dbo].[sp_pisk240i_01]
GO

/*
Execute sp_pisk240i_01
	@ps_prdyear		= '2002',
	@ps_areacode		= 'D',
	@ps_divisioncode	= 'A',
	@ps_workcenter		= '%',
...
Create Procedure sp_pisk240i_01
	@ps_prdyear		char(4),
...
Where	A.AreaCode	= B.AreaCode		And
	...
	A.LineCode	= B.LineCode		And
	A.ItemCode	= B.ItemCode
Group By A.PrdYear, A.AreaCode, B.AreaName, A.DivisionCode, B.DivisionName, A.WorkCenter, B.WorkCenterName,
