/*
	File Name	: sp_pisk230i_02.SQL
	SYSTEM		: KDAC 통합 생산 정보 시스템
	Procedure Name	: sp_pisk230i_02
...
If Exists (Select * From sysobjects 
	    Where id = object_id(N'[dbo].[sp_pisk230i_02]')
	      And OBJECTPROPERTY(id, N'IsProcedure') = 1)
	Drop Procedure [dbo].[sp_pisk230i_02]
GO

/*
Execute sp_pisk230i_02
	@ps_prdmonth		= '2002.10',
	@ps_areacode		= 'D',
	@ps_divisioncode	= 'A',
	@ps_workcenter		= '4201',
...
Create Procedure sp_pisk230i_02
	@ps_prdmonth		char(7),
