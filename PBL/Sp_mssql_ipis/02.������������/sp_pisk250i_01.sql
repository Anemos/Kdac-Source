/*
	File Name	: sp_pisk250i_01.SQL
	SYSTEM		: KDAC 통합 생산 정보 시스템
	Procedure Name	: sp_pisk250i_01
	Description	: 일별 생산 추이 (모델군별)
...
If Exists (Select * From sysobjects 
	    Where id = object_id(N'[dbo].[sp_pisk250i_01]')
	      And OBJECTPROPERTY(id, N'IsProcedure') = 1)
	Drop Procedure [dbo].[sp_pisk250i_01]
GO

/*
Execute sp_pisk250i_01
	@ps_prdmonth		= '2002.12',
	@ps_areacode		= 'D',
	@ps_divisioncode	= 'A',
	@ps_productgroup	= '%',
...
Create Procedure sp_pisk250i_01
	@ps_prdmonth		char(7),
...
Where	A.AreaCode	= B.AreaCode		And
	A.DivisionCode	= B.DivisionCode		And
	A.ItemCode	= B.ItemCode
Group By A.PrdMonth, A.AreaCode, B.AreaName, A.DivisionCode, B.DivisionName, B.ProductGroup, B.ProductGroupName,
