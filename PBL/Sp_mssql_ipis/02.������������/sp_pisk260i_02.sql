/*
	File Name	: sp_pisk260i_02.SQL
	SYSTEM		: KDAC 통합 생산 정보 시스템
	Procedure Name	: sp_pisk260i_02
...
If Exists (Select * From sysobjects 
	    Where id = object_id(N'[dbo].[sp_pisk260i_02]')
	      And OBJECTPROPERTY(id, N'IsProcedure') = 1)
	Drop Procedure [dbo].[sp_pisk260i_02]
GO

/*
Execute sp_pisk260i_02
	@ps_prdyear		= '2002',
	@ps_areacode		= 'D',
	@ps_divisioncode	= 'A',
	@ps_productgroup	= '32',
...
Create Procedure sp_pisk260i_02
	@ps_prdyear		char(4),
