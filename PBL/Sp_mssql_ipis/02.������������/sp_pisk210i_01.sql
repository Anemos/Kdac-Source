/*
	File Name	: sp_pisk210i_01.SQL
	SYSTEM		: KDAC 통합 생산 정보 시스템
	Procedure Name	: sp_pisk210i_01
	Description	: 생산 현황
...
If Exists (Select * From sysobjects 
	    Where id = object_id(N'[dbo].[sp_pisk210i_01]')
	      And OBJECTPROPERTY(id, N'IsProcedure') = 1)
	Drop Procedure [dbo].[sp_pisk210i_01]
GO

/*
Execute sp_pisk210i_01
...
Create Procedure sp_pisk210i_01
	@ps_fromdate		char(10),
	@ps_todate		char(10),
