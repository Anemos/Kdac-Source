/*
	File Name	: sp_pisk010i_02.SQL
	SYSTEM		: KDAC 통합 생산 정보 시스템
	Procedure Name	: sp_pisk010i_02
...
If Exists (Select * From sysobjects 
	    Where id = object_id(N'[dbo].[sp_pisk010i_02]')
	      And OBJECTPROPERTY(id, N'IsProcedure') = 1)
	Drop Procedure [dbo].[sp_pisk010i_02]
GO

/*
Execute sp_pisk010i_02
	@ps_areacode		= 'D',
	@ps_divisioncode	= 'A',
	@ps_workcenter		= '4201',
	@ps_linecode		= 'A',
...
Create Procedure sp_pisk010i_02
