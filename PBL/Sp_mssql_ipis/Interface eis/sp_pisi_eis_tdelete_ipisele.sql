/*
	File Name	: sp_pisi_eis_tdelete_ipisele.sql
	SYSTEM		: KDAC 烹钦 积魂 沥焊 矫胶袍
	Procedure Name	: sp_pisi_eis_tdelete_ipisele
...
If Exists (Select * From sysobjects 
	    Where id = object_id(N'[dbo].[sp_pisi_eis_tdelete_ipisele]')
	      And OBJECTPROPERTY(id, N'IsProcedure') = 1)
	Drop Procedure [dbo].[sp_pisi_eis_tdelete_ipisele]
GO

/*
Execute sp_pisi_eis_tdelete_ipisele
*/

Create Procedure sp_pisi_eis_tdelete_ipisele
