/*
	File Name	: sp_pisi_eis_tdelete.sql
	SYSTEM		: KDAC 烹钦 积魂 沥焊 矫胶袍
	Procedure Name	: sp_pisi_eis_tdelete
...
If Exists (Select * From sysobjects 
	    Where id = object_id(N'[dbo].[sp_pisi_eis_tdelete]')
	      And OBJECTPROPERTY(id, N'IsProcedure') = 1)
	Drop Procedure [dbo].[sp_pisi_eis_tdelete]
GO

/*
Execute sp_pisi_eis_tdelete
*/

Create Procedure sp_pisi_eis_tdelete
...
select	*
  from	[ipisele_svr\ipis].ipis.dbo.tdelete
...
Begin
	...
	update	[ipisele_svr\ipis].ipis.dbo.tdelete
	  set	LastEmp			= 'N'
...
--from	[ipishvac_svr\ipis].ipis.dbo.tdelete
...
Begin
	...
	update	[ipishvac_svr\ipis].ipis.dbo.tdelete
	  set	LastEmp			= 'N'
	where	TableName		= @ls_TableName
	  and	DeleteData		= @ls_DeleteData
	  and	DeleteTime		= @ldt_DeleteTime
...
--from	[ipisjin_svr].ipis.dbo.tdelete
...
Begin
	...
	update	[ipisjin_svr].ipis.dbo.tdelete
	  set	LastEmp			= 'N'
	where	TableName		= @ls_TableName
	  and	DeleteData		= @ls_DeleteData
	  and	DeleteTime		= @ldt_DeleteTime
