/*
	File Name	: sp_pisi_eis_tdelete_ipishvac.sql
	SYSTEM		: KDAC 烹钦 积魂 沥焊 矫胶袍
	Procedure Name	: sp_pisi_eis_tdelete_ipishvac
...
If Exists (Select * From sysobjects 
	    Where id = object_id(N'[dbo].[sp_pisi_eis_tdelete_ipishvac]')
	      And OBJECTPROPERTY(id, N'IsProcedure') = 1)
	Drop Procedure [dbo].[sp_pisi_eis_tdelete_ipishvac]
GO

/*
Execute sp_pisi_eis_tdelete_ipishvac
*/

Create Procedure sp_pisi_eis_tdelete_ipishvac
