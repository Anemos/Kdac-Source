/*
	File Name	: sp_pisi_eis_tdelete_ipisjin.sql
	SYSTEM		: KDAC 烹钦 积魂 沥焊 矫胶袍
	Procedure Name	: sp_pisi_eis_tdelete_ipisjin
...
If Exists (Select * From sysobjects 
	    Where id = object_id(N'[dbo].[sp_pisi_eis_tdelete_ipisjin]')
	      And OBJECTPROPERTY(id, N'IsProcedure') = 1)
	Drop Procedure [dbo].[sp_pisi_eis_tdelete_ipisjin]
GO

/*
Execute sp_pisi_eis_tdelete_ipisjin
*/

Create Procedure sp_pisi_eis_tdelete_ipisjin
