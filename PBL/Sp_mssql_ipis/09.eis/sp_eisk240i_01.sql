/*
	File Name	: sp_eisk240i_01.SQL
	SYSTEM		: KDAC 통합 생산 정보 시스템
	Procedure Name	: sp_eisk240i_01
	Description	: 일별 조립간판 준수율(공장별)
...
If Exists (Select * From sysobjects 
	    Where id = object_id(N'[dbo].[sp_eisk240i_01]')
	      And OBJECTPROPERTY(id, N'IsProcedure') = 1)
	Drop Procedure [dbo].[sp_eisk240i_01]
GO

/*
Execute sp_eisk240i_01 '2002.12', 'D', 'A'
...
Create Procedure sp_eisk240i_01
	@ps_prdmonth		char(7),
	@ps_areacode		char(1),
