/*
	File Name	: sp_eiss010i_01.SQL
	SYSTEM		: KDAC 통합 생산 정보 시스템
	Procedure Name	: sp_eiss010i_01
...
If Exists (Select * From sysobjects 
	    Where id = object_id(N'[dbo].[sp_eiss010i_01]')
	      And OBJECTPROPERTY(id, N'IsProcedure') = 1)
	Drop Procedure [dbo].[sp_eiss010i_01]
GO

/*
Execute sp_eiss010i_01 '2002.12', '%'
...
Create Procedure sp_eiss010i_01
	@ps_prd1		char(7),
	@ps_prdmonth		char(7),
	@ps_areacode		char(1)
...
Select	AreaCode		= A.AreaCode,
	...
	PrdQty01		= 0,
	PlanCost01		= 0.0,
	ChangeCost01		= Sum(IsNull(A.PlanOutCost, 0) + IsNull(A.PlanOutCost, 0)),
	PrdCost01		= 0.0,
