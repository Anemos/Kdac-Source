/*
	File Name	: sp_eisk020i_01.SQL
	SYSTEM		: KDAC 통합 생산 정보 시스템
	Procedure Name	: sp_eisk020i_01
	Description	: 당월 계획 및 실적 (공장별)
...
If Exists (Select * From sysobjects 
	    Where id = object_id(N'[dbo].[sp_eisk020i_01]')
	      And OBJECTPROPERTY(id, N'IsProcedure') = 1)
	Drop Procedure [dbo].[sp_eisk020i_01]
GO

/*
Execute sp_eisk020i_01 '2002.12', 'D', 'V'
...
Create Procedure sp_eisk020i_01
	@ps_frommonth		char(7),
	@ps_tomonth		char(7),
	@ps_areacode		char(1),
