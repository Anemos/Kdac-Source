...
/*				  TMSTCUSTOMER																	*/   
/*				  TMSTPRODUCTGROUP																*/
/*  Parameter   : @ps_RaiseDate       	char(10)    => 발생일	                                */
/*	Notes		: 공장별 커스트머 전체합계 월간 RRPPM 추이를 표시한다          					*/
/*	Made Date	: 2002. 12. 12                                                                  */
/*	Author		: 대우정보-유종희                                                               */
/************************************************************************************************/
if exists (select * from sysobjects where id = object_id('dbo.sp_eisq135i_01') and sysstat & 0xf = 4)
	drop procedure dbo.sp_eisq135i_01
GO
/*
Exec sp_eisq135i_01
...
/****** Object:  Stored Procedure dbo.sp_eisq135i_01    Script Date: 02-09-01  ******/
CREATE PROCEDURE sp_eisq135i_01
