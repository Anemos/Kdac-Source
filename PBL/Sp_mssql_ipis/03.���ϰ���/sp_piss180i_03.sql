/*
	File Name	: sp_piss180i_03.SQL
	SYSTEM		: KDAC 통합 생산 정보 시스템
	Procedure Name	: sp_piss180i_03
	Description	: 미납현황(편수)
...
If Exists (Select * From sysobjects 
	    Where id = object_id(N'[dbo].[sp_piss180i_03]')
	      And OBJECTPROPERTY(id, N'IsProcedure') = 1)
	Drop Procedure [dbo].[sp_piss180i_03]
GO


/*
exec sp_piss180i_03 @ps_areacode = 'D',
                    @ps_divisioncode = 'S',
                    @ps_senddate    = '2002.09.17',
                    @ps_custcode    = 'D00001'
*/
Create Procedure sp_piss180i_03
        @ps_areacode     char(01),
