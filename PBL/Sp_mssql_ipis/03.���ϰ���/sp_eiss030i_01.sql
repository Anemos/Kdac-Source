/*
	File Name	: sp_eiss030i_01.SQL
	SYSTEM		: KDAC 통합 생산 정보 시스템
	Procedure Name	: sp_eiss030i_01
	Description	: 월별출하실적(전사)
...
If Exists (Select * From sysobjects 
	    Where id = object_id(N'[dbo].[sp_eiss030i_01]')
	      And OBJECTPROPERTY(id, N'IsProcedure') = 1)
	Drop Procedure [dbo].[sp_eiss030i_01]
GO

/*
Execute sp_eiss030i_01 '2002', 'J'
...
Create Procedure sp_eiss030i_01
	@ps_prdyear		char(4),
	@ps_areacode		char(1)
