/*
	File Name	: sp_piss130u_05.SQL
	SYSTEM		: KDAC 통합 생산 정보 시스템
	Procedure Name	: sp_piss130i_05
	Description	: 출고간판reading(출고전표)
...
If Exists (Select * From sysobjects 
	    Where id = object_id(N'[dbo].[sp_piss130u_05]')
	      And OBJECTPROPERTY(id, N'IsProcedure') = 1)
	Drop Procedure [dbo].[sp_piss130u_05]
GO


/*
exec sp_piss130u_05 @ps_areacode = 'D',       -- 지역코드
                    @ps_divisioncode = 'M',  -- 공장코드
	            @pi_truckorder = 1,      -- 차량순번
	            @ps_truckno	= '1234',    -- 차량번호
	            @ps_month = '2001.11',   -- 출고전표발행년월
	            @ps_shipdate = '2001.11.05'

*/
CREATE PROCEDURE sp_piss130u_05
...
order by a.divisioncode,a.custcode,a.shipgubun,b.psrno,b.pcgubun desc
...
SELECT	DivisionCode    = A.DivisionCode,
 ...
 WHERE 	a.shipgubun *= b.shipgubun
    and A.DivisionCode  *= B.DivisionCode
order by A.divisioncode,A.custcode,a.shipgubun,a.psrno,a.pcgubun desc
