...
If Exists (select * From tmisdept)
	...
	-- 부평물류
	exec [ipisbup_svr\ipis].ipis.dbo.sp_pisi_truncate_table 'tmstdept'
	
	insert into [ipisbup_svr\ipis].ipis.dbo.tmstdept
	select	*
	from	[ipisele_svr\ipis].ipis.dbo.tmstdept
	
	-- 군산물류
	exec [ipiskun_svr\ipis].ipis.dbo.sp_pisi_truncate_table 'tmstdept'
	
	insert into [ipiskun_svr\ipis].ipis.dbo.tmstdept
	select	*
	from	[ipisele_svr\ipis].ipis.dbo.tmstdept
