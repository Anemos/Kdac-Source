...
select	dyear +'.'+ dmonth,
	...
	0,			0,			'SYSTEM'
from	mps004
where	(dplant in ('D') and	ddvsn in ('H','V'))
and	dyear +'.'+ dmonth = @ps_month
...
-- 부평물류
delete	from [ipisbup_svr\ipis].ipis.dbo.tplanmonth
where planmonth = @ps_month

insert into [ipisbup_svr\ipis].ipis.dbo.tplanmonth
	(PlanMonth,
	AreaCode,		DivisionCode,		ItemCode,		ChangeQty,
	ChangeQtyInM,		ChangeQtyOutM,		PlanQty,		PlanQtyInM,
	PlanQtyOutM,		PlanQtyM1,		PlanQtyInM1,		PlanQtyOutM1,
...
insert into [ipisele_svr\ipis].eis.dbo.tplanmonth
select	*
from	[ipisbup_svr\ipis].ipis.dbo.tplanmonth
where	planmonth = @ps_month

-- 군산물류
delete	from [ipiskun_svr\ipis].ipis.dbo.tplanmonth
where planmonth = @ps_month

insert into [ipiskun_svr\ipis].ipis.dbo.tplanmonth
	(PlanMonth,
	AreaCode,		DivisionCode,		ItemCode,		ChangeQty,
	ChangeQtyInM,		ChangeQtyOutM,		PlanQty,		PlanQtyInM,
	PlanQtyOutM,		PlanQtyM1,		PlanQtyInM1,		PlanQtyOutM1,
...
insert into [ipisele_svr\ipis].eis.dbo.tplanmonth
select	*
from	[ipiskun_svr\ipis].ipis.dbo.tplanmonth
where	planmonth = @ps_month

-- 여주전자
delete	from [ipisyeo_svr\ipis].ipis.dbo.tplanmonth
where planmonth = @ps_month

insert into [ipisyeo_svr\ipis].ipis.dbo.tplanmonth
	(PlanMonth,
	AreaCode,		DivisionCode,		ItemCode,		ChangeQty,
	ChangeQtyInM,		ChangeQtyOutM,		PlanQty,		PlanQtyInM,
	PlanQtyOutM,		PlanQtyM1,		PlanQtyInM1,		PlanQtyOutM1,
...
select	dyear +'.'+ dmonth,
	...
	0,			0,			'SYSTEM'
from	mps004
where	dplant = 'Y' and	ddvsn = 'Y'
and	dyear +'.'+ dmonth = @ps_month

insert into [ipisele_svr\ipis].eis.dbo.tplanmonth
select	*
from	[ipisyeo_svr\ipis].ipis.dbo.tplanmonth
where	planmonth = @ps_month
