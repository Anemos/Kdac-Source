...
WHERE aa.stscd = 'N' and
  ( aa.xplant + aa.div + aa.itno + aa.chgdate in ( select xplant + div + itno + min(chgdate)
...
if @li_count > 0
  Begin
    ...
    select xplant, div, itno, itnm, spec, xunit, saud, srce, wloc, minq, maxq
    from #master_gen
...
from tmisinv101 aa inner join #master_gen bb
  on aa.xplant = bb.xplant and aa.div = bb.div and
    aa.itno = bb.itno and aa.chgdate = bb.chgdate
