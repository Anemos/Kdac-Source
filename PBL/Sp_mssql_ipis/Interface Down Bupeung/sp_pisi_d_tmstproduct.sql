...
-- 군산물류
exec [ipiskun_svr\ipis].ipis.dbo.sp_pisi_truncate_table 'tmstproductgroup'

-- tmstproductgroup
insert	into [ipiskun_svr\ipis].ipis.dbo.tmstproductgroup
	(AreaCode,	DivisionCode,	ProductGroup,	ProductGroupName,	LastEmp)
...
exec [ipiskun_svr\ipis].ipis.dbo.sp_pisi_truncate_table 'tmstmodelgroup'

-- tmstmodelgroup
insert	into [ipiskun_svr\ipis].ipis.dbo.tmstmodelgroup
	(AreaCode,		DivisionCode,	ProductGroup,			ModelGroup,
	ModelGroupName,	LastEmp)
...
exec [ipiskun_svr\ipis].ipis.dbo.sp_pisi_truncate_table 'tmstproduct'

-- tmstproduct
insert	into [ipiskun_svr\ipis].ipis.dbo.tmstproduct
	(AreaCode,		DivisionCode,		ProductGroup,			ModelGroup,
	ProductCode,		ProductName,		LastEmp)
...
-- tmstcode
delete	from [ipiskun_svr\ipis].ipis.dbo.tmstcode
where	codegroup = 'OPRODUCT'

insert into [ipiskun_svr\ipis].ipis.dbo.tmstcode
	(codegroup,	codeid,		codegroupname,	codename,	
	lastemp)
select	Distinct 'OPRODUCT',	a.prprcd,	'PRODUCT',	rtrim(ltrim(b.prname)),
	'SYSTEM'
...
-- 부평물류
exec [ipisbup_svr\ipis].ipis.dbo.sp_pisi_truncate_table 'tmstproductgroup'

-- tmstproductgroup
insert	into [ipisbup_svr\ipis].ipis.dbo.tmstproductgroup
	(AreaCode,	DivisionCode,	ProductGroup,	ProductGroupName,	LastEmp)
select 	'B',		a.prplant,	a.prprcd,	rtrim(ltrim(b.prname)),	'SYSTEM' 
from	dac004 a, dac007 b
where	a.prprcd	=	b.prprcd	and
	a.prarea	in	('B')	and
	len(a.prprcd)	= 	2
...
exec [ipisbup_svr\ipis].ipis.dbo.sp_pisi_truncate_table 'tmstmodelgroup'

-- tmstmodelgroup
insert	into [ipisbup_svr\ipis].ipis.dbo.tmstmodelgroup
	(AreaCode,		DivisionCode,	ProductGroup,			ModelGroup,
	ModelGroupName,	LastEmp)
select 	'B',			a.prplant,	substring(a.prprcd,1,2),	a.prprcd,		
	rtrim(ltrim(b.prname)),	'SYSTEM' 
from	dac004 a, dac007 b
where	a.prprcd	=	b.prprcd	and
	a.prarea	in	('B')	and
...
exec [ipisbup_svr\ipis].ipis.dbo.sp_pisi_truncate_table 'tmstproduct'

-- tmstproduct
insert	into [ipisbup_svr\ipis].ipis.dbo.tmstproduct
	(AreaCode,		DivisionCode,		ProductGroup,			ModelGroup,
	ProductCode,		ProductName,		LastEmp)
select 	'B',			a.prplant,		substring(a.prprcd,1,2),	substring(a.prprcd,1,3),
	a.prprcd,		rtrim(ltrim(b.prname)),	'SYSTEM' 
from	dac004 a, dac007 b
where	a.prprcd	=	b.prprcd	and
	a.prarea	in	('B') and
...
-- tmstcode
delete	from [ipisbup_svr\ipis].ipis.dbo.tmstcode
where	codegroup = 'OPRODUCT'

insert into [ipisbup_svr\ipis].ipis.dbo.tmstcode
	(codegroup,	codeid,		codegroupname,	codename,	
	lastemp)
select	Distinct 'OPRODUCT',	a.prprcd,	'PRODUCT',	rtrim(ltrim(b.prname)),
	'SYSTEM'
...
insert	into [ipisele_svr\ipis].eis.dbo.tmstproductgroup
select	*
from	[ipisbup_svr\ipis].ipis.dbo.tmstproductgroup

insert	into [ipisele_svr\ipis].eis.dbo.tmstproductgroup
select	*
from	[ipiskun_svr\ipis].ipis.dbo.tmstproductgroup
...
insert	into [ipisele_svr\ipis].eis.dbo.tmstmodelgroup
select	*
from	[ipisbup_svr\ipis].ipis.dbo.tmstmodelgroup

insert	into [ipisele_svr\ipis].eis.dbo.tmstmodelgroup
select	*
from	[ipiskun_svr\ipis].ipis.dbo.tmstmodelgroup
...
insert	into [ipisele_svr\ipis].eis.dbo.tmstproduct
select	*
from	[ipisbup_svr\ipis].ipis.dbo.tmstproduct

insert	into [ipisele_svr\ipis].eis.dbo.tmstproduct
select	*
from	[ipiskun_svr\ipis].ipis.dbo.tmstproduct
