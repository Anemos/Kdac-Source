...
-- 부평물류
--delete	from [ipisbup_svr\ipis].ipis.dbo.tseqworkcalendar
--where workdate like @ps_month + '%'

delete	from [ipisbup_svr\ipis].ipis.dbo.tcalendarshop
where applymonth = @ps_month

delete	from [ipisbup_svr\ipis].ipis.dbo.tcalendarwork
where applymonth = @ps_month
-- 군산물류
--delete	from [ipiskun_svr\ipis].ipis.dbo.tseqworkcalendar
--where workdate like @ps_month + '%'

delete	from [ipiskun_svr\ipis].ipis.dbo.tcalendarshop
where applymonth = @ps_month

delete	from [ipiskun_svr\ipis].ipis.dbo.tcalendarwork
where applymonth = @ps_month
...
-- 군산조향
If not exists (select *	from [ipiskun_svr\ipis].ipis.dbo.tseqworkcalendar
    where workdate like @ps_month + '%' and areacode = 'K' and divisioncode = 'S')
begin	
 insert into [ipiskun_svr\ipis].ipis.dbo.tseqworkcalendar
  ( areacode,divisioncode,workdate,workgubun,lastemp,lastdate)
 select	'K',	'S',
	substring(ghdt,1,4) + '.' + substring(ghdt,5,2) +'.'+ substring(ghdt,7,2),
	case ghgb
		when '' then 'W'
...
insert into [ipiskun_svr\ipis].ipis.dbo.tcalendarshop
	(AreaCode,	DivisionCode,	
	ApplyMonth,	
	ApplyDate,
	DayNo,		
...
-- 군산제동
If not exists (select *	from [ipiskun_svr\ipis].ipis.dbo.tseqworkcalendar
    where workdate like @ps_month + '%' and areacode = 'K' and divisioncode = 'M')
begin	
 insert into [ipiskun_svr\ipis].ipis.dbo.tseqworkcalendar
 ( areacode,divisioncode,workdate,workgubun,lastemp,lastdate)
 select	'K',	'M',
...
-- 군산공조
If not exists (select *	from [ipiskun_svr\ipis].ipis.dbo.tseqworkcalendar
    where workdate like @ps_month + '%' and areacode = 'K' and divisioncode = 'H')
begin	
 insert into [ipiskun_svr\ipis].ipis.dbo.tseqworkcalendar
 ( areacode,divisioncode,workdate,workgubun,lastemp,lastdate)
 select	'K',	'H',
...
-- 군산압축
If not exists (select *	from [ipiskun_svr\ipis].ipis.dbo.tseqworkcalendar
    where workdate like @ps_month + '%' and areacode = 'K' and divisioncode = 'V')
begin	
 insert into [ipiskun_svr\ipis].ipis.dbo.tseqworkcalendar
 ( areacode,divisioncode,workdate,workgubun,lastemp,lastdate)
 select	'K',	'V',
...
-- 부평
If not exists (select *	from [ipisbup_svr\ipis].ipis.dbo.tseqworkcalendar
    where workdate like @ps_month + '%' and areacode = 'B' and divisioncode = 'A')
begin	
 insert into [ipisbup_svr\ipis].ipis.dbo.tseqworkcalendar
 ( areacode,divisioncode,workdate,workgubun,lastemp,lastdate)
 select	'B',	'A',
	substring(ghdt,1,4) + '.' + substring(ghdt,5,2) +'.'+ substring(ghdt,7,2),
	case ghgb
...
If not exists (select *	from [ipisbup_svr\ipis].ipis.dbo.tseqworkcalendar
    where workdate like @ps_month + '%' and areacode = 'B' and divisioncode = 'M')
begin	
 insert into [ipisbup_svr\ipis].ipis.dbo.tseqworkcalendar
 ( areacode,divisioncode,workdate,workgubun,lastemp,lastdate)
 select	'B',	'M',
...
If not exists (select *	from [ipisbup_svr\ipis].ipis.dbo.tseqworkcalendar
    where workdate like @ps_month + '%' and areacode = 'B' and divisioncode = 'S')
begin	
 insert into [ipisbup_svr\ipis].ipis.dbo.tseqworkcalendar
 ( areacode,divisioncode,workdate,workgubun,lastemp,lastdate)
 select	'B',	'S',
...
If not exists (select *	from [ipisbup_svr\ipis].ipis.dbo.tseqworkcalendar
    where workdate like @ps_month + '%' and areacode = 'B' and divisioncode = 'H')
begin	
 insert into [ipisbup_svr\ipis].ipis.dbo.tseqworkcalendar
 ( areacode,divisioncode,workdate,workgubun,lastemp,lastdate)
 select	'B',	'H',
...
If not exists (select *	from [ipisbup_svr\ipis].ipis.dbo.tseqworkcalendar
    where workdate like @ps_month + '%' and areacode = 'B' and divisioncode = 'V')
begin	
 insert into [ipisbup_svr\ipis].ipis.dbo.tseqworkcalendar
 ( areacode,divisioncode,workdate,workgubun,lastemp,lastdate)
 select	'B',	'V',
...
If not exists (select *	from [ipisbup_svr\ipis].ipis.dbo.tseqworkcalendar
    where workdate like @ps_month + '%' and areacode = 'B' and divisioncode = 'Y')
begin	
 insert into [ipisbup_svr\ipis].ipis.dbo.tseqworkcalendar
 ( areacode,divisioncode,workdate,workgubun,lastemp,lastdate)
 select	'B',	'Y',
...
insert into [ipisbup_svr\ipis].ipis.dbo.tcalendarshop
	(AreaCode,	DivisionCode,	
	ApplyMonth,	
	ApplyDate,
	DayNo,		
