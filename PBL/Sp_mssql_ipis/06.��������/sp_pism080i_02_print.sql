...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[sp_pism080i_02_print]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[sp_pism080i_02_print]
GO
...
SELECT  A.sMonth,
  ...
  I.tarLPI,
  I.divtarLPI,
  J.BasicTime/3600 as basictime ,
  J.BasicTime as basictime1
