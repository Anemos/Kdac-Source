...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[sp_pism230i_summary_option]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[sp_pism230i_summary_option]
GO


/*****************************************/ 
/*    공장별 대당 표준 및 실투입MH 호환품 Summary    */ 
/* exec sp_pism230i_summary_option 'D','A','2012.10.23'  */
/*****************************************/ 

CREATE PROCEDURE sp_pism230i_summary_option
  @ps_AreaCode Char(1),
