...
group by aa.areacode, aa.divisioncode, aa.suppliercode, aa.itemcode
  ...
  inner join tmstpartkb ee
  on tmp.areacode = ee.areacode and tmp.divisioncode = ee.divisioncode and
    tmp.suppliercode = ee.suppliercode and tmp.itemcode = ee.itemcode
