/*
  File Name : sp_pisar01i_02.SQL
  SYSTEM    : KDAC 통합 생산 정보 시스템
  Procedure Name  : sp_pisar01i_02
  Description : 
...
If Exists (Select * From sysobjects
      Where id = object_id(N'[dbo].[sp_pisar01i_02]')
        And OBJECTPROPERTY(id, N'IsProcedure') = 1)
  Drop Procedure [dbo].[sp_pisar01i_02]
GO

------------------------------------------------------------------
--         업체별 납기준수 현황 출력 ( DataWindow )			--
-- exec sp_pisar01i_02 '%','%','%','2004.01.01','2004.01.31','Y'
------------------------------------------------------------------

CREATE  PROCEDURE sp_pisar01i_02
	@ps_area		Char(1),	-- 지역
...
if @ps_tempchk = 'Y'
	...
	FROM		#SUPPLIER_tmp	A,
		TMSTSUPPLIER	D
	WHERE		A.SupplierCode 	= D.SupplierCode
