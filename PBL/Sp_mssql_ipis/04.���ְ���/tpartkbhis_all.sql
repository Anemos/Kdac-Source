CREATE TABLE [TPARTKBHIS_ALL] (
	[PartKBNo] [char] (11) COLLATE Korean_Wansung_CI_AS NOT NULL ,
	[ApplyDate] [char] (10) COLLATE Korean_Wansung_CI_AS NOT NULL ,
	[PartOrderSeq] [smallint] NOT NULL ,
	...
	[PartObeyDateFlag] [bit] NOT NULL ,
	[PartObeyTimeFlag] [bit] NOT NULL ,
	...
	CONSTRAINT [PK_TPARTKBHIS_ALL] PRIMARY KEY  CLUSTERED 
	(
		[PartKBNo],
		[ApplyDate],
		[PartOrderSeq]
