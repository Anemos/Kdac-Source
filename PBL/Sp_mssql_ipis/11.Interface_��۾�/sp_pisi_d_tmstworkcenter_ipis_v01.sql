...
delete from tmstworkcenter
from tmstworkcenter a, tmstdept b
where (a.areacode <> b.areacode or a.divisioncode <> b.DivisionCode) and
    a.workcenter = b.deptcode
...
-- EIS tmstworkcenter
delete	from [ipis_daegu].eis.dbo.tmstworkcenter
where	areacode in (select areacode from tmstworkcenter)
and	divisioncode in (select divisioncode from tmstworkcenter)

insert into [ipis_daegu].eis.dbo.tmstworkcenter
select	*
from	tmstworkcenter


-- EIS tmstline
delete	from [ipis_daegu].eis.dbo.tmstline
where	areacode in (select areacode from tmstline)
and	divisioncode in (select divisioncode from tmstline)

insert into [ipis_daegu].eis.dbo.tmstline
select	*
from	tmstline
