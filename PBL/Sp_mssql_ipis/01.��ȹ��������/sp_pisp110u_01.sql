/*
	File Name	: sp_pisp110i_01.SQL
	SYSTEM		: KDAC 통합 생산 정보 시스템
	Procedure Name	: sp_pisp110i_01
	Description	: 무간판 생산/입고 이력 조회
...
If Exists (Select * From sysobjects 
	    Where id = object_id(N'[dbo].[sp_pisp110i_01]')
	      And OBJECTPROPERTY(id, N'IsProcedure') = 1)
	Drop Procedure [dbo].[sp_pisp110i_01]
GO

/*
Execute sp_pisp110i_01
...
Create Procedure sp_pisp110i_01
