/*
	File Name	: sp_pisp210u_02.SQL
	SYSTEM		: KDAC 통합 생산 정보 시스템
	Procedure Name	: sp_pisp210u_02
	Description	: 간판 마스터 조회 - 상세정보
...
If Exists (Select * From sysobjects 
	    Where id = object_id(N'[dbo].[sp_pisp210u_02]')
	      And OBJECTPROPERTY(id, N'IsProcedure') = 1)
	Drop Procedure [dbo].[sp_pisp210u_02]
GO

/*
Execute sp_pisp210u_02
	@ps_areacode		= 'D',
	@ps_divisioncode	= 'A',
	@ps_workcenter		= '4201',
	@ps_linecode		= 'A',
...
Create Procedure sp_pisp210u_02
