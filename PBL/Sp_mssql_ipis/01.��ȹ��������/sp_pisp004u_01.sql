/*
	File Name	: sp_pisp004u_01.SQL
	SYSTEM		: KDAC 통합 생산 정보 시스템
	Procedure Name	: sp_pisp004u_01
...
If Exists (Select * From sysobjects 
	    Where id = object_id(N'[dbo].[sp_pisp004u_01]')
	      And OBJECTPROPERTY(id, N'IsProcedure') = 1)
	Drop Procedure [dbo].[sp_pisp004u_01]
GO

/*
Execute sp_pisp004u_01
	@ps_areacode		= 'D',
	@ps_divisioncode	= 'A',
	@ps_workcenter		= '%'
...
Create Procedure sp_pisp004u_01
