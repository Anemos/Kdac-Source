/*
	File Name	: sp_pisp040u_01.SQL
	SYSTEM		: KDAC 통합 생산 정보 시스템
	Procedure Name	: sp_pisp040u_01
	Description	: 월간 생산 계획 조회
...
If Exists (Select * From sysobjects 
	    Where id = object_id(N'[dbo].[sp_pisp040u_01]')
	      And OBJECTPROPERTY(id, N'IsProcedure') = 1)
	Drop Procedure [dbo].[sp_pisp040u_01]
GO

/*
Execute sp_pisp040u_01 '2002.09', 'D', 'A', '%', '%'
*/

Create Procedure sp_pisp040u_01
...
Select	AreaCode		= A.AreaCode,
	...
	ProductGubunName	= Case	When A.ProductGubun = 'P'		Then '계획생산'
					...
					Else 'OEM생산'
				   End,
	InvQtyBefore		= Sum(IsNull(B.InvQtyBefore, 0)),
	PlanQty			= Sum(IsNull(B.PlanQty, 0)),
	ChangeQty		= Sum(IsNull(B.ChangeQty, 0)),
--	InvQtyAfter		= Sum(IsNull(B.InvQtyAfter, 0))
	InvQtyAfter		= IsNull(A.SafetyInvQty, 0)
From	(Select	AreaCode		= A.AreaCode,			-- 지역코드
		...
		ProductGubun		= A.ProductGubun,		-- 제품 구분
	...
	Group By A.AreaCode, A.AreaName, A.DivisionCode, A.DivisionName, A.ProductGroup, A.ProductGroupName, A.ModelGroup, A.ModelGroupName,
		A.ItemCode, A.ItemName, A.ModelID, A.ProductGubun, A.SafetyInvQty)	A,
	tplanmonth	B
...
Group By A.AreaCode, A.AreaName, A.DivisionCode, A.DivisionName, A.ProductGroup, A.ProductGroupName, A.ModelGroup, A.ModelGroupName,
	A.SortOrder, A.ItemCode, A.ItemName, A.ModelID, A.ProductGubun, A.SafetyInvQty
