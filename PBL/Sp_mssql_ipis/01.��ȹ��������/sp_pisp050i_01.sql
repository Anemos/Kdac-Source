/*
	File Name	: sp_pisp050i_01.SQL
	SYSTEM		: KDAC 통합 생산 정보 시스템
	Procedure Name	: sp_pisp050i_01
	Description	: 제품별 생산 계획
			  일일생산계획을 제품군/제품별로 조회한다.
...
If Exists (Select * From sysobjects 
	    Where id = object_id(N'[dbo].[sp_pisp050i_01]')
	      And OBJECTPROPERTY(id, N'IsProcedure') = 1)
	Drop Procedure [dbo].[sp_pisp050i_01]
GO

/*
Execute sp_pisp050i_01
...
Create Procedure sp_pisp050i_01
	@ps_todate		char(10),
