...
sum(case when tmp_sum.zdate = '201001' then truncate(tmp_sum.zunitqty * tmp_sum.zrcpcost,3)
	else 0 end),
sum(case when tmp_sum.zdate = '201002' then truncate(tmp_sum.zunitqty * tmp_sum.zrcpcost,3)
	else 0 end),
sum(case when tmp_sum.zdate = '201003' then truncate(tmp_sum.zunitqty * tmp_sum.zrcpcost,3)
	else 0 end),
sum(case when tmp_sum.zdate = '201004' then truncate(tmp_sum.zunitqty * tmp_sum.zrcpcost,3)
	else 0 end),
sum(case when tmp_sum.zdate = '201005' then truncate(tmp_sum.zunitqty * tmp_sum.zrcpcost,3)
	else 0 end),
sum(case when tmp_sum.zdate = '201006' then truncate(tmp_sum.zunitqty * tmp_sum.zrcpcost,3)
	else 0 end)
from
...
a.zdate,a.zpitno,a.zitno,a.zunitqty,a.zrcpcost,truncate(a.zunitqty * a.zrcpcost,3)
from ( SELECT
...
) tmp_inv,pbpdm.bomt13 a
where a.zcmcd = '01' and a.zdate >= '201001' and a.zdate <= '201006' and
