...
//고객사 유상사급 금액 재공반영분 확인
//DELETE FROM PBWIP.WIP018 A
//WHERE A.WBCMCD = '01' AND A.WBYYMMDD = '20121005' AND
//EXISTS ( SELECT B.WBYYMMDD FROM PBWIP.WIP018 B
//	WHERE A.WBCMCD = B.WBCMCD AND 
//		A.WBYEAR = B.WBYEAR AND A.WBMONTH = B.WBMONTH AND 
//		A.WBPLANT = B.WBPLANT AND A.WBDVSN = B.WBDVSN AND
//		A.WBIOCD = B.WBIOCD AND B.WBYYMMDD = '20121006' ) ;

//UPDATE PBWIP.WIP018 A
//SET WBYYMMDD = '20121005'
//WHERE A.WBCMCD = '01' AND A.WBYYMMDD >= '20121005';
