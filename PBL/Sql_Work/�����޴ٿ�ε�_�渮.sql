...
cc.costav,cc.xunit, ff.pdcd, ff.wdprno, ff.itnm, ff.xunit, ff.pqtym, ff.wdprqt
from ( select aa.wbcmcd as wbcmcd,aa.wbplant as wbplant,aa.wbdvsn as wbdvsn,
  ...
  where aa.wbcmcd = '01' and aa.wbyear = '2005' and
        aa.wbiocd = '2' and
  ...
  aa.wborct ,bb.vndnm, bb.vndr,aa.wbitno ,aa.wbpdcd,dd.prname,aa.wbdesc ,
	...
	left outer join ( select aa.wdplant as wdplant,aa.wddvsn as wddvsn,
		...
		from (select wdcmcd,wdplant,wddvsn, wdchdpt, wditno, wdprno, sum(wdprqt) as wdprqt
			from pbtest.wip004
			where wdcmcd = '01' and wdslty = 'WC' and wdiocd = '2' and wddate >= '20050101' and wddate <= '20051231'
			group by wdcmcd,wdplant,wddvsn, wdchdpt, wditno, wdprno) aa
