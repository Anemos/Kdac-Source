SELECT "PBINV"."INV401"."COMLTD",   
         ...
         "PBINV"."INV401"."TDTE4",
			...
			"PBINV"."INV401"."TQTY3",   
         "PBINV"."INV401"."TQTY4"     
    FROM {"PBINV"."INV401"  EXCEPTION JOIN ( SELECT "PBWIP"."WIP004"."WDPRSRTY","PBWIP"."WIP004"."WDPRSRNO",
																...
																WHERE ( "PBWIP"."WIP004"."WDCMCD" = :a_cmcd ) AND
																		...
																		( {fn substring("PBWIP"."WIP004"."WDDATE",1,6)} = :a_curmonth )) BBB
									ON "PBINV"."INV401"."SLIPTYPE" = "WDPRSRTY" AND 
										"PBINV"."INV401"."SRNO" = "WDPRSRNO" AND
										"PBINV"."INV401"."SRNO1" = "WDPRSRNO1" AND
										"PBINV"."INV401"."SRNO2" = "WDPRSRNO2"   }  
   WHERE ("PBINV"."INV401"."COMLTD" = :a_cmcd) AND  
         ...
         ("PBINV"."INV401"."CLS" in ('10','30','40','50')) AND
			...
			("PBINV"."INV401"."SRCE" = '04' OR "PBINV"."INV401"."SRCE" = '05' OR "PBINV"."INV401"."SRCE" = '06')))) AND  
         ({fn substring("PBINV"."INV401"."TDTE4",1,6)} = :a_curmonth) 