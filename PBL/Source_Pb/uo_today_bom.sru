$PBExportHeader$uo_today_bom.sru
$PBExportComments$일자 선택 - 금일 - is_uo_date
forward
global type uo_today_bom from userobject
end type
type pb_next from picturebutton within uo_today_bom
end type
type pb_prev from picturebutton within uo_today_bom
end type
type sle_date from singlelineedit within uo_today_bom
end type
type pb_ddlb from picturebutton within uo_today_bom
end type
type dw_cal from datawindow within uo_today_bom
end type
end forward
...
global uo_today_bom uo_today_bom
