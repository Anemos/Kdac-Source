$PBExportHeader$w_pisr110c.srw
$PBExportComments$발주간판처리/삭제(제품군)
forward
global type w_pisr110c from w_ipis_sheet01
end type
type rb_1 from radiobutton within w_pisr110c
end type
type rb_2 from radiobutton within w_pisr110c
end type
type dw_pisr110b_01 from datawindow within w_pisr110c
end type
type dw_pisr110b_02 from u_vi_std_datawindow within w_pisr110c
end type
type uo_area from u_pisc_select_area within w_pisr110c
end type
type uo_division from u_pisc_select_division within w_pisr110c
end type
type dw_scan from datawindow within w_pisr110c
end type
type dw_lastedit from datawindow within w_pisr110c
end type
type dw_summary from datawindow within w_pisr110c
end type
type dw_orderseq from datawindow within w_pisr110c
end type
type cb_1 from commandbutton within w_pisr110c
end type
type cb_2 from commandbutton within w_pisr110c
end type
type gb_2 from groupbox within w_pisr110c
end type
type gb_3 from groupbox within w_pisr110c
end type
type gb_scan from groupbox within w_pisr110c
end type
type gb_1 from groupbox within w_pisr110c
end type
end forward
...
CASE True		//발주등록
		...
		If ll_Row = -1 Then 
			...
			Goto EndReturn_
		End If
		If f_pisr_ordercalc_productgroup(dw_pisr110b_01, idt_nowtime, is_jobdate, is_applydate, ls_message) = -1 Then 
...
type uo_status from w_ipis_sheet01`uo_status within w_pisr110c
integer y = 1884
end type
