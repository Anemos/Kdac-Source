$PBExportHeader$w_origin_sheet04.srw
$PBExportComments$(조회, 인쇄, 처음, 이전, 다음, 끝, 닫기, 상세조회, 화면인쇄, 특수문자)
forward
global type w_origin_sheet04 from window
end type
type uo_status from uo_commonstatus within w_origin_sheet04
end type
end forward
...
global w_origin_sheet04 w_origin_sheet04

type variables
// Icon의 Enabled 상태
boolean i_b_retrieve, i_b_print, i_b_first, i_b_prev, i_b_next
boolean i_b_last, i_b_delete, i_b_dretrieve, i_b_dprint, i_b_dchar
...
forward prototypes
public subroutine wf_icon_onoff (boolean ag_retrieve, boolean ag_print, boolean ag_first, boolean ag_prev, boolean ag_next, boolean ag_last, boolean ag_dretrieve, boolean ag_dprint, boolean ag_dchar)
end prototypes
...
public subroutine wf_icon_onoff (boolean ag_retrieve, boolean ag_print, boolean ag_first, boolean ag_prev, boolean ag_next, boolean ag_last, boolean ag_dretrieve, boolean ag_dprint, boolean ag_dchar);/////////////////////////////////////////////////////////////////////////////////////////
//       wf_button(조회, 인쇄, 처음, 다음, 끝, 상세조회, 화면인쇄, 특수문자)
...
////////////////////////////////////////////////////////////////////////////////////////////
f_icon_set(true,  false, false, false, true,  true,  true,  true,  true,  false, &
