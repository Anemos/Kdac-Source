$PBExportHeader$w_pism220i.srw
$PBExportComments$완제품 단위당 표준시간 개선율 조회
forward
global type w_pism220i from w_pism_sheet02
end type
type tv_divmod from u_pism_tv_divmod within w_pism220i
end type
type dw_divprod from u_pism_dw within w_pism220i
end type
type st_vsplitbar from u_pism_splitbar within w_pism220i
end type
end forward
...
f_pism_working_msg(istr_mh.year + '년' + istr_mh.month + '월', &
						 dw_divprod.Title + "을 조회중입니다. 잠시만 기다려 주십시오.") 

Choose Case ltvi_Item.Level 
	Case 2 		// 제품군 
		ls_ProductGroup = ltvi_Item.Data; ls_modelGroup = '%' 
		If dw_divprod.DataObject <> 'd_pism220i_01' Then dw_divprod.DataObject = 'd_pism220i_01' 
		
		dw_divprod.SetTransObject(SqlPIS) 
		dw_divprod.Retrieve(istr_mh.area, istr_mh.div, ls_ProductGroup, ls_modelGroup, is_MonthlastDay) 
	Case 3		// 모델군 
	...
	If dw_divprod.DataObject <> 'd_pism220i_02' Then dw_divprod.DataObject = 'd_pism220i_02' 
	
	dw_divprod.SetTransObject(SqlPIS) 
	dw_divprod.Retrieve(istr_mh.area, istr_mh.div, ls_divModItem, is_MonthlastDay) 
End Choose 
...
lstr_prt.DataObject = 'd_pism220i_01_p' 
...
type uo_status from w_pism_sheet02`uo_status within w_pism220i
end type

type st_fromto from w_pism_sheet02`st_fromto within w_pism220i
end type

type uo_todate from w_pism_sheet02`uo_todate within w_pism220i
end type

type gb_2 from w_pism_sheet02`gb_2 within w_pism220i
end type

type uo_fromdate from w_pism_sheet02`uo_fromdate within w_pism220i
end type

type uo_month from w_pism_sheet02`uo_month within w_pism220i
end type
...
type uo_year from w_pism_sheet02`uo_year within w_pism220i
end type

type uo_area from w_pism_sheet02`uo_area within w_pism220i
end type

type uo_div from w_pism_sheet02`uo_div within w_pism220i
end type
...
type gb_1 from w_pism_sheet02`gb_1 within w_pism220i
end type
...
integer taborder = 40
boolean bringtotop = true
string title = "완제품 단위당 표준시간 개선율"
string dataobject = "d_pism220i_01"
