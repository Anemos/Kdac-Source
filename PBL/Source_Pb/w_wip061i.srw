$PBExportHeader$w_wip061i.srw
$PBExportComments$일일재공수불현황(공제전)
forward
global type w_wip061i from w_origin_sheet04
end type
type dw_1 from datawindow within w_wip061i
end type
type dw_2 from datawindow within w_wip061i
end type
type dw_3 from datawindow within w_wip061i
end type
type pb_1 from picturebutton within w_wip061i
end type
type gb_1 from groupbox within w_wip061i
end type
end forward
...
if i_s_iocd = '1' then
	dw_1.dataobject = 'd_wip061i_linelist'
	dw_1.settransobject(sqlca)
	l_n_rowcnt = dw_1.retrieve(g_s_company, ls_plant, ls_dvsn, i_s_iocd, ls_pdcd, i_s_fromdt, i_s_yesterday)
	
	dw_2.dataobject = 'd_wip061i_linerpt'
	dw_2.settransobject(sqlca)
elseif i_s_iocd = '2' then
	dw_1.dataobject = 'd_wip061i_vndlist'
	dw_1.settransobject(sqlca)
	l_n_rowcnt = dw_1.retrieve(g_s_company, ls_plant, ls_dvsn, i_s_iocd, ls_pdcd, i_s_fromdt, i_s_yesterday)
	
   dw_2.dataobject = 'd_wip061i_vndrpt'
	dw_2.settransobject(sqlca) 
else
	dw_1.dataobject = 'd_wip061i_stklist'
	dw_1.settransobject(sqlca)
	l_n_rowcnt = dw_1.retrieve(g_s_company, ls_plant, ls_dvsn, ls_pdcd, i_s_fromdt, i_s_yesterday)
	
   dw_2.dataobject = 'd_wip061i_stkrpt'
	dw_2.settransobject(sqlca)
end if
...
type uo_status from w_origin_sheet04`uo_status within w_wip061i
end type
...
string dataobject = "d_wip061i_linelist"
...
boolean bringtotop = true
string title = "none"
string dataobject = "d_wip061i_linerpt"
boolean livescroll = true
borderstyle borderstyle = stylelowered!
end type
...
boolean bringtotop = true
string title = "none"
string dataobject = "d_wip061i_01"
