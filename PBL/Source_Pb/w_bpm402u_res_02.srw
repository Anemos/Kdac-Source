$PBExportHeader$w_bpm402u_res_02.srw
$PBExportComments$상위품번 복사 Response Window
forward
global type w_bpm402u_res_02 from window
end type
type p_1 from picture within w_bpm402u_res_02
end type
type dw_1 from datawindow within w_bpm402u_res_02
end type
type sle_1 from singlelineedit within w_bpm402u_res_02
end type
type sle_2 from singlelineedit within w_bpm402u_res_02
end type
type cb_1 from commandbutton within w_bpm402u_res_02
end type
type cb_2 from commandbutton within w_bpm402u_res_02
end type
type gb_1 from groupbox within w_bpm402u_res_02
end type
type gb_2 from groupbox within w_bpm402u_res_02
end type
end forward
...
global w_bpm402u_res_02 w_bpm402u_res_02
...
f_bpm_job_start(l_s_applyyear,l_s_revno,'w_bpm402u',g_s_empno,'C','사업계획BOM정보 상위품번복사')
for i = 1 to l_n_rows
	l_d_plant 	= l_s_plant
   l_d_div 		= l_s_div
	l_d_pcitn 	= l_s_pcitn
