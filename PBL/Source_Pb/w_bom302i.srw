$PBExportHeader$w_bom302i.srw
$PBExportComments$가공관리비 M-BOM 조회(월별)
forward
global type w_bom302i from w_origin_sheet02
end type
type pb_excel from picturebutton within w_bom302i
end type
type uo_1 from uo_plandiv_pdcd within w_bom302i
end type
type st_1 from statictext within w_bom302i
end type
type uo_date from uo_ccyymm_mps within w_bom302i
end type
type st_2 from statictext within w_bom302i
end type
type sle_1 from singlelineedit within w_bom302i
end type
type pb_1 from picturebutton within w_bom302i
end type
type dw_bom_print from datawindow within w_bom302i
end type
type tab_1 from tab within w_bom302i
end type
...
type st_4 from statictext within w_bom302i
end type
type rb_pre from radiobutton within w_bom302i
end type
type rb_post from radiobutton within w_bom302i
end type
type st_5 from statictext within w_bom302i
end type
type st_itnm from statictext within w_bom302i
end type
type gb_1 from groupbox within w_bom302i
end type
end forward
...
type uo_status from w_origin_sheet02`uo_status within w_bom302i
integer y = 2468
end type
...
integer taborder = 30
boolean bringtotop = true
string dataobject = "d_bom302i_print"
...
integer height = 1936
integer taborder = 80
string dataobject = "d_bom302i_retrieve"
...
integer height = 1812
integer taborder = 90
string dataobject = "d_bom302i_knockdown"
boolean hscrollbar = true
boolean vscrollbar = true
boolean hsplitscroll = true
boolean livescroll = true
...
integer height = 1940
integer taborder = 80
string dataobject = "d_bom302i_partlist_fta_allproduct"
boolean hscrollbar = true
boolean vscrollbar = true
boolean hsplitscroll = true
boolean livescroll = true
