$PBExportHeader$w_pisr030i.srw
$PBExportComments$월간 자재소요량예시 간판매수
forward
global type w_pisr030i from w_ipis_sheet01
end type
type uo_area from u_pisc_select_area within w_pisr030i
end type
type uo_division from u_pisc_select_division within w_pisr030i
end type
type tv_partkb from u_pisr_treeview within w_pisr030i
end type
type dw_pisr030i_01 from u_vi_std_datawindow within w_pisr030i
end type
type uo_today from u_pisc_date_applydate within w_pisr030i
end type
type dw_pisr030i_02 from datawindow within w_pisr030i
end type
type st_vsplitbar from u_pism_splitbar within w_pisr030i
end type
type st_vsplitbar2 from u_pism_splitbar within w_pisr030i
end type
type st_2 from statictext within w_pisr030i
end type
type st_jobdays from statictext within w_pisr030i
end type
type gb_1 from groupbox within w_pisr030i
end type
type dw_print from datawindow within w_pisr030i
end type
end forward
...
tv_partkb tv_partkb
dw_pisr030i_01 dw_pisr030i_01
uo_today uo_today
dw_pisr030i_02 dw_pisr030i_02
...
st_vsplitbar.of_Register(dw_pisr030i_01, st_vsplitbar.RIGHT)
st_vsplitbar2.of_Register(dw_pisr030i_01, st_vsplitbar.LEFT)
st_vsplitbar2.of_Register(dw_pisr030i_02, st_vsplitbar.RIGHT)
...
on w_pisr030i.create
int iCurrent
call super::create
this.uo_area=create uo_area
this.uo_division=create uo_division
this.tv_partkb=create tv_partkb
this.dw_pisr030i_01=create dw_pisr030i_01
this.uo_today=create uo_today
this.dw_pisr030i_02=create dw_pisr030i_02
...
dw_pisr030i_01.Height= tv_partkb.Height
dw_pisr030i_02.x 		= dw_pisr030i_01.x + dw_pisr030i_01.Width + ls_split
dw_pisr030i_02.Width = newwidth - ( dw_pisr030i_02.x + ls_gap )
dw_pisr030i_02.Height= tv_partkb.Height
//dw_pisr030i_02.x		= newwidth	- ( dw_pisr020i_02.Width + ls_gap )

st_vsplitbar.y 		= tv_partkb.y
st_vsplitbar.Height 	= tv_partkb.Height
st_vsplitbar2.x 		= dw_pisr030i_02.x - ls_split
...
dw_pisr030i_01.SetRedraw(False)
dw_pisr030i_01.SetTransObject(Sqlpis)
dw_pisr030i_01.Retrieve( istr_partKB.areaCode, istr_partKB.divCode, istr_partKB.suppCode, istr_partKB.applydate)
dw_pisr030i_01.SetRedraw(True)

//MessageBox( "테스트", istr_partkb.areacode+','+istr_partkb.divcode+','+istr_partkb.suppcode+','+istr_partkb.itemcode+','+istr_partkb.applydate  )
dw_pisr030i_02.SetRedraw(False)
dw_pisr030i_02.SetTransObject(Sqlpis)
dw_pisr030i_02.Retrieve( istr_partKB.areaCode, istr_partKB.divCode, istr_partKB.suppCode, istr_partKB.applydate )
dw_pisr030i_02.SetRedraw(True)
...
type uo_status from w_ipis_sheet01`uo_status within w_pisr030i
end type
...
integer taborder = 11
boolean bringtotop = true
string dataobject = "d_pisr030i_01"
...
ll_jobdays	= dw_pisr030i_01.GetItemNumber( 1, 'jobdays' )
...
ib_Scrolling2 = True
dw_pisr030i_02.Modify("DataWindow.VerticalScrollPosition=" + String(scrollpos))
ib_Scrolling2 = False
end event
...
boolean bringtotop = true
string title = "none"
string dataobject = "d_pisr030i_02"
boolean hscrollbar = true
boolean vscrollbar = true
...
ib_Scrolling1 = True
dw_pisr030i_01.Modify("DataWindow.VerticalScrollPosition=" + String(scrollpos))
ib_Scrolling1 = False
end event
