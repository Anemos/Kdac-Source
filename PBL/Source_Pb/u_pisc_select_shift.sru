$PBExportHeader$u_pisc_select_shift.sru
$PBExportComments$주/야 선택 - is_uo_shiftcode, is_uo_shiftname
forward
global type u_pisc_select_shift from userobject
end type
type st_2 from statictext within u_pisc_select_shift
end type
type dw_1 from datawindow within u_pisc_select_shift
end type
end forward
...
global u_pisc_select_shift u_pisc_select_shift
...
on u_pisc_select_shift.destroy
destroy(this.st_2)
destroy(this.dw_1)
end on
