$PBExportHeader$w_pisr143j.srw
$PBExportComments$간판진행정보조회(제품군)
forward
global type w_pisr143j from w_ipis_sheet01
end type
type uo_division from u_pisc_select_division within w_pisr143j
end type
type uo_area from u_pisc_select_area within w_pisr143j
end type
type dw_2 from u_vi_std_datawindow within w_pisr143j
end type
type dw_condition from datawindow within w_pisr143j
end type
type dw_condition2 from datawindow within w_pisr143j
end type
type pb_1 from picturebutton within w_pisr143j
end type
type gb_3 from groupbox within w_pisr143j
end type
type gb_4 from groupbox within w_pisr143j
end type
type gb_1 from groupbox within w_pisr143j
end type
type dw_3 from u_vi_std_datawindow within w_pisr143j
end type
type dw_print from datawindow within w_pisr143j
end type
type pb_2 from picturebutton within w_pisr143j
end type
type pb_3 from picturebutton within w_pisr143j
end type
type pb_4 from picturebutton within w_pisr143j
end type
end forward
...
type uo_status from w_ipis_sheet01`uo_status within w_pisr143j
end type
...
integer taborder = 11
boolean bringtotop = true
string dataobject = "d_pisr143j_01"
