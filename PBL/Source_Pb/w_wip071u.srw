$PBExportHeader$w_wip071u.srw
$PBExportComments$유상사급 진행현황관리(경리)
forward
global type w_wip071u from w_origin_sheet02
end type
type uo_1 from uo_wip_plandiv within w_wip071u
end type
type uo_to from uo_yymm_boongi within w_wip071u
end type
type st_1 from statictext within w_wip071u
end type
type dw_wip05bu_01 from datawindow within w_wip071u
end type
type dw_wip05bu_02 from datawindow within w_wip071u
end type
type cb_confirm from commandbutton within w_wip071u
end type
type pb_down from picturebutton within w_wip071u
end type
type rb_free from radiobutton within w_wip071u
end type
type rb_cost from radiobutton within w_wip071u
end type
type gb_1 from groupbox within w_wip071u
end type
end forward
...
this.Control[iCurrent+8]=this.rb_free
this.Control[iCurrent+9]=this.rb_cost
this.Control[iCurrent+10]=this.gb_1
end on

on w_wip071u.destroy
call super::destroy
destroy(this.uo_1)
destroy(this.uo_to)
destroy(this.st_1)
...
ll_rowcnt = dw_wip05bu_01.retrieve(mid(is_adjdt,1,4), mid(is_adjdt,5,2), '01', ls_plant, ls_dvsn, ls_iocd)
if ll_rowcnt < 1 then
...
type uo_status from w_origin_sheet02`uo_status within w_wip071u
end type
...
integer taborder = 40
boolean bringtotop = true
string dataobject = "d_wip071u_01"
...
string ls_year, ls_month, ls_cmcd, ls_plant, ls_dvsn, ls_vendor, ls_iocd
...
if ls_colname = 'wip009_wfstscd' then
	...
	ls_iocd = This.getitemstring(row,'wip009_wfiocd')
...
event doubleclicked;String ls_plant, ls_dvsn, ls_year, ls_month, ls_vendor, ls_iocd
long ll_rowcnt
...
ll_rowcnt = dw_wip05bu_02.retrieve('01',ls_plant,ls_dvsn,ls_vendor,ls_year,ls_month,ls_iocd)
if ll_rowcnt < 1 then
	uo_status.st_message.text = '조회할 자료가 없습니다.'
else
	uo_status.st_message.text = '조회되었습니다.'
...
boolean bringtotop = true
string title = "none"
string dataobject = "d_wip071u_02"
boolean hscrollbar = true
boolean vscrollbar = true
boolean livescroll = true
borderstyle borderstyle = stylelowered!
...
string ls_plant, ls_dvsn, ls_vendor, ls_yyyy, ls_month, ls_iocd
...
ls_iocd = dw_wip05bu_01.getitemstring(ll_selrow,"wip009_wfiocd")
...
WHERE wfyear = :ls_yyyy AND wfmonth = :ls_month AND
	...
	wfvendor = :ls_vendor AND wfiocd = :ls_iocd
using sqlca;
