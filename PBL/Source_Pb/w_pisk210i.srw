...
If dw_1.Retrieve(	uo_fromdate.is_uo_date, 			uo_todate.is_uo_date, &
						...
						'%') > 0 Then
	uo_status.st_message.text =  "생산 현황 정보" //+ f_message("변경된 데이타가 없습니다.")
Else
	uo_status.st_message.text =  "생산 현황 정보가 존재하지 않습니다" //+ f_message("변경된 데이타가 없습니다.")
	MessageBox("생산 현황", "생산 현황 정보가 존재하지 않습니다")
End If
...
ls_date	= "기준일 : " + uo_fromdate.is_uo_date + ' - ' + uo_todate.is_uo_date
