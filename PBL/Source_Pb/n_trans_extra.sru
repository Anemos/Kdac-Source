$PBExportHeader$n_trans_extra.sru
$PBExportComments$간접재용 Transaction
forward
global type n_trans_extra from transaction
end type
end forward

global type n_trans_extra from transaction
end type
global n_trans_extra n_trans_extra

type prototypes
//2009.02.10 : 낙찰율(P1),납기준수율(P2)
subroutine SP_EVL_P1(string I_DEPT, string I_VSRNO, string I_GUBUN) RPCFUNC ALIAS FOR "PBPUR.SP_EVL_P1"
//end: 2009.02.10
...
subroutine SP_VNDEVL4(string I_YEAR) RPCFUNC ALIAS FOR "PBPUR.SP_VNDEVL4"	//사용중단 2007.08.30
subroutine SP_VNDEVL5(string I_YEAR) RPCFUNC ALIAS FOR "PBPUR.SP_VNDEVL5"
//2007.08.30 품질평가 기준 변경..
subroutine SP_VNDEVL7(string I_YEAR) RPCFUNC ALIAS FOR "PBPUR.SP_VNDEVL7"
...
*/
//피복 : 인사자력생성
subroutine SP_CLOBASE(string S_EMPNO) RPCFUNC ALIAS FOR "PBPUR.SP_CLOBASE"
subroutine SP_CLO803(string S_GUBUN, string S_EMPNO) RPCFUNC ALIAS FOR "PBPUR.SP_CLO803"
subroutine SP_CLO804(string S_XYEAR, string S_ITEM, string S_GUBUN, string S_EMPNO) RPCFUNC ALIAS FOR "PBPUR.SP_CLO804"
end prototypes
on n_trans_extra.create
call super::create
TriggerEvent( this, "constructor" )
end on

on n_trans_extra.destroy
