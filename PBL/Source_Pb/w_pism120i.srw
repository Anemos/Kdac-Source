$PBExportHeader$w_pism120i.srw
$PBExportComments$조내 일별 생산실적 현황
forward
global type w_pism120i from w_pism_sheet03
end type
type dw_realprod from u_pism_dw within w_pism120i
end type
type pb_excel from picturebutton within w_pism120i
end type
type cbx_1 from checkbox within w_pism120i
end type
type gb_3 from groupbox within w_pism120i
end type
end forward
...
global w_pism120i w_pism120i

on w_pism120i.create
int iCurrent
call super::create
...
type uo_status from w_pism_sheet03`uo_status within w_pism120i
end type

type uo_wc from w_pism_sheet03`uo_wc within w_pism120i
end type

type st_fromto from w_pism_sheet03`st_fromto within w_pism120i
end type

type gb_1 from w_pism_sheet03`gb_1 within w_pism120i
end type

type uo_fromdate from w_pism_sheet03`uo_fromdate within w_pism120i
end type

type uo_year from w_pism_sheet03`uo_year within w_pism120i
integer x = 2464
integer y = 148
integer width = 567
end type

type uo_month from w_pism_sheet03`uo_month within w_pism120i
end type

type uo_frmonth from w_pism_sheet03`uo_frmonth within w_pism120i
end type

type gb_2 from w_pism_sheet03`gb_2 within w_pism120i
end type

type uo_tomonth from w_pism_sheet03`uo_tomonth within w_pism120i
end type

type st_fromtomonth from w_pism_sheet03`st_fromtomonth within w_pism120i
long backcolor = 12632256
end type

type uo_todate from w_pism_sheet03`uo_todate within w_pism120i
end type

type uo_area from w_pism_sheet03`uo_area within w_pism120i
end type

type uo_div from w_pism_sheet03`uo_div within w_pism120i
end type
...
string dataobject = "d_pism120i_01"
...
event clicked;if cbx_1.checked = false then
	dw_realprod.dataobject = 'd_pism120i_01'
else
	dw_realprod.dataobject = 'd_pism120i_01_rev1'
end if
end event
