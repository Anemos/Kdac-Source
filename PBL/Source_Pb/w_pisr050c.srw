$PBExportHeader$w_pisr050c.srw
$PBExportComments$간판매수계산및추가발행(제품군)
forward
global type w_pisr050c from w_ipis_sheet01
end type
type uo_area from u_pisc_select_area within w_pisr050c
end type
type uo_division from u_pisc_select_division within w_pisr050c
end type
type tab_main from tab within w_pisr050c
end type
type tabpage_1 from userobject within tab_main
end type
type dw_pisr050c_01 from u_vi_std_datawindow within tabpage_1
end type
type tabpage_1 from userobject within tab_main
dw_pisr050c_01 dw_pisr050c_01
end type
...
type tv_partkb from u_pisr_treeview within w_pisr050c
end type
type st_vsplitbar from u_pism_splitbar within w_pisr050c
end type
type cb_aschange from commandbutton within w_pisr050c
end type
type cb_5 from commandbutton within w_pisr050c
end type
type uo_month from u_pisc_date_scroll_month within w_pisr050c
end type
type gb_1 from groupbox within w_pisr050c
end type
type gb_5 from groupbox within w_pisr050c
end type
type gb_6 from groupbox within w_pisr050c
end type
end forward
...
st_vsplitbar.of_Register(tab_main.tabpage_1.dw_pisr050c_01, st_vsplitbar.RIGHT)
st_vsplitbar.of_Register(tv_partkb, st_vsplitbar.LEFT)
...
type uo_status from w_ipis_sheet01`uo_status within w_pisr050c
end type
...
dw_pisr050c_01.Height 	= newheight - ( tab_name + ls_gap * 4 + tab_control) 
dw_pisr050c_01.x 			= tv_partkb.Width + ls_split
dw_pisr050c_01.Width 	= newwidth - ( dw_pisr050c_01.x + ls_gap * 8)
...
dw_pisr050c_01.SetRedraw(False)
dw_pisr050c_01.SetTransObject(Sqlpis)
dw_pisr050c_01.Retrieve(istr_partKB.areaCode, istr_partKB.divCode, istr_partKB.suppCode, uo_month.is_uo_month)
dw_pisr050c_01.SetRedraw(True)
...
ll_rowCnt = dw_pisr050c_01.RowCount()
...
FOR I = 1 TO ll_rowCnt STEP 1
	ls_suppCode 	= dw_pisr050c_01.GetItemString( I, 'suppliercode' )
	ls_itemCode 	= dw_pisr050c_01.GetItemString( I, 'itemcode' )
	ls_modelID	 	= dw_pisr050c_01.GetItemString( I, 'partmodelid' )
	ls_NormalSN		= dw_pisr050c_01.GetItemString( I, 'normalkbsn' )
	ls_partKBL 		= Left( ls_NormalSN, 8 )
	ll_partKBR 		= long( Right( ls_NormalSN, 3 ))
	ll_printCnt 	= dw_pisr050c_01.GetItemNumber( I, 'partkbprintcount' )
	ll_activeCnt 	= dw_pisr050c_01.GetItemNumber( I, 'partkbactivecount' )
	ll_planCnt 		= dw_pisr050c_01.GetItemNumber( I, 'partkbplancount' )
...
on tabpage_1.create
this.dw_pisr050c_01=create dw_pisr050c_01
this.Control[]={this.dw_pisr050c_01}
end on

on tabpage_1.destroy
destroy(this.dw_pisr050c_01)
end on
...
integer height = 1424
integer taborder = 11
string dataobject = "d_pisr050c_01"
