$PBExportHeader$w_bpm427i.srw
$PBExportComments$품목별재료비 비교(임시작업)
forward
global type w_bpm427i from w_origin_sheet04
end type
type pb_excel from picturebutton within w_bpm427i
end type
type uo_1 from uo_plandiv_pdcd_all within w_bpm427i
end type
type dw_bpm427i_01 from datawindow within w_bpm427i
end type
type uo_2 from uo_ccyy_mps within w_bpm427i
end type
type st_sort from statictext within w_bpm427i
end type
type cb_sort from commandbutton within w_bpm427i
end type
type st_4 from statictext within w_bpm427i
end type
type uo_3 from u_bpm_select_arev within w_bpm427i
end type
type st_3 from statictext within w_bpm427i
end type
type ddlb_divcode from dropdownlistbox within w_bpm427i
end type
type st_1 from statictext within w_bpm427i
end type
type uo_4 from uo_ccyymm_mps within w_bpm427i
end type
type gb_1 from groupbox within w_bpm427i
end type
end forward
...
this.dw_bpm427i_01=create dw_bpm427i_01
...
this.Control[iCurrent+3]=this.dw_bpm427i_01
...
on w_bpm427i.destroy
call super::destroy
destroy(this.pb_excel)
destroy(this.uo_1)
destroy(this.dw_bpm427i_01)
destroy(this.uo_2)
...
dw_bpm427i_01.reset()
if dw_bpm427i_01.retrieve(ls_year,ls_revno,ls_divcode,ls_plant,ls_div,ls_pdcd,ls_yyyy + '01' + '01', ls_yyyy + ls_mm + '31') > 0 then
	cb_sort.enabled  = true
	pb_excel.visible = true
	pb_excel.enabled = true
	uo_status.st_message.text	=	"  " + string(dw_bpm427i_01.rowcount()) + " 개의 정보가 " + f_message("I010")
else
...
dw_bpm427i_01.Width = newwidth	- (ls_gap * 5)
dw_bpm427i_01.Height= newheight - (dw_bpm427i_01.y + ls_status)
end event

type uo_status from w_origin_sheet04`uo_status within w_bpm427i
end type
...
event clicked;f_save_to_excel_number(dw_bpm427i_01)
end event
...
boolean bringtotop = true
string title = "none"
string dataobject = "d_bpm427i_01"
...
openwithparm(w_gms_setsort ,dw_bpm427i_01)
...
dw_bpm427i_01.setsort(l_str_rtn.rtnsort)
dw_bpm427i_01.setredraw(false)
dw_bpm427i_01.sort()
dw_bpm427i_01.setredraw(true)
