$PBExportHeader$w_piss100u.srw
$PBExportComments$수량분할
forward
global type w_piss100u from window
end type
type cb_add from commandbutton within w_piss100u
end type
type st_remainqty from statictext within w_piss100u
end type
type st_8 from statictext within w_piss100u
end type
type dw_truckorder from datawindow within w_piss100u
end type
type dw_change_truckload from datawindow within w_piss100u
end type
type cb_2 from commandbutton within w_piss100u
end type
type cb_save from commandbutton within w_piss100u
end type
type st_modelid from statictext within w_piss100u
end type
type st_rackqty from statictext within w_piss100u
end type
type st_notloadqty from statictext within w_piss100u
end type
type st_loadplan from statictext within w_piss100u
end type
type st_srno from statictext within w_piss100u
end type
type st_5 from statictext within w_piss100u
end type
type st_4 from statictext within w_piss100u
end type
type st_3 from statictext within w_piss100u
end type
type st_1 from statictext within w_piss100u
end type
type gb_1 from groupbox within w_piss100u
end type
type gb_2 from groupbox within w_piss100u
end type
end forward
...
event clicked;dw_change_truckload.insertrow(0)
int li_rowcount
string ls_null
setnull(ls_null)
li_rowcount = dw_change_truckload.rowcount()
...
integer taborder = 10
string title = "none"
string dataobject = "d_piss100u_02"
...
integer taborder = 30
string title = "none"
string dataobject = "d_piss100u_01"
...
event clicked;If ib_change then
	CloseWithReturn(w_piss100u, 'YES')
Else
	CloseWithReturn(w_piss100u, 'NO')
End If
end event
