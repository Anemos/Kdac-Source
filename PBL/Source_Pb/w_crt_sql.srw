$PBExportHeader$w_crt_sql.srw
$PBExportComments$엑셀양식레이아웃을SQL문장전환
forward
global type w_crt_sql from w_origin_sheet09
end type
type tab_1 from tab within w_crt_sql
end type
...
type uo_status from w_origin_sheet09`uo_status within w_crt_sql
integer y = 2468
end type
