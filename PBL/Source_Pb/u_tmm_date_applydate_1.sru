$PBExportHeader$u_tmm_date_applydate_1.sru
$PBExportComments$일자 선택 - 시스템 기준일 - is_uo_date
forward
global type u_tmm_date_applydate_1 from userobject
end type
type pb_next from picturebutton within u_tmm_date_applydate_1
end type
type pb_prev from picturebutton within u_tmm_date_applydate_1
end type
type sle_date from singlelineedit within u_tmm_date_applydate_1
end type
type pb_ddlb from picturebutton within u_tmm_date_applydate_1
end type
type dw_cal from datawindow within u_tmm_date_applydate_1
end type
end forward
...
global u_tmm_date_applydate_1 u_tmm_date_applydate_1
...
on u_tmm_date_applydate_1.create
...
on u_tmm_date_applydate_1.destroy
