$PBExportHeader$w_wip064i.srw
$PBExportComments$일일재공이체현황(공제전)
forward
global type w_wip064i from w_origin_sheet04
end type
type dw_1 from datawindow within w_wip064i
end type
type dw_2 from datawindow within w_wip064i
end type
type dw_3 from datawindow within w_wip064i
end type
type pb_1 from picturebutton within w_wip064i
end type
type gb_1 from groupbox within w_wip064i
end type
end forward
...
type uo_status from w_origin_sheet04`uo_status within w_wip064i
end type
...
string dataobject = "d_wip064i_linelist"
...
boolean bringtotop = true
string title = "none"
string dataobject = "d_wip064i_linerpt"
boolean livescroll = true
borderstyle borderstyle = stylelowered!
end type
...
if ls_colname = 'wip001_waiocd' then
	if data = '1' then
		dw_1.dataobject = 'd_wip064i_linelist'
		dw_1.settransobject(sqlca)
		dw_2.dataobject = 'd_wip064i_linerpt'
		dw_2.settransobject(sqlca)
	elseif data = '2' then
		dw_1.dataobject = 'd_wip064i_vndlist'
		dw_1.settransobject(sqlca)
		dw_2.dataobject = 'd_wip064i_vndrpt'
		dw_2.settransobject(sqlca) 
	else
		dw_1.dataobject = 'd_wip064i_stklist'
		dw_1.settransobject(sqlca)
		dw_2.dataobject = 'd_wip064i_stkrpt'
		dw_2.settransobject(sqlca)
	end if
end if
end event
