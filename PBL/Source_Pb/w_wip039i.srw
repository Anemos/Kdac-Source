$PBExportHeader$w_wip039i.srw
$PBExportComments$재공수불현황(공제후)
forward
global type w_wip039i from w_origin_sheet04
end type
type dw_1 from datawindow within w_wip039i
end type
type dw_2 from datawindow within w_wip039i
end type
type dw_3 from datawindow within w_wip039i
end type
type pb_1 from picturebutton within w_wip039i
end type
type gb_1 from groupbox within w_wip039i
end type
end forward
...
type uo_status from w_origin_sheet04`uo_status within w_wip039i
end type
...
string dataobject = "d_wip039i_linelist"
...
if dw_1.dataobject = 'd_wip039i_stklist' then
...
boolean bringtotop = true
string title = "none"
string dataobject = "d_wip039i_linerpt"
boolean livescroll = true
borderstyle borderstyle = stylelowered!
end type
...
boolean bringtotop = true
string title = "none"
string dataobject = "d_wip039i_01"
