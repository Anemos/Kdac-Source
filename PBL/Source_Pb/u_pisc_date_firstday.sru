$PBExportHeader$u_pisc_date_firstday.sru
$PBExportComments$일자 선택 - 매달 첫째일 - is_uo_date
forward
global type u_pisc_date_firstday from userobject
end type
type st_name from statictext within u_pisc_date_firstday
end type
type pb_next from picturebutton within u_pisc_date_firstday
end type
type pb_prev from picturebutton within u_pisc_date_firstday
end type
type sle_date from singlelineedit within u_pisc_date_firstday
end type
type pb_ddlb from picturebutton within u_pisc_date_firstday
end type
type dw_cal from datawindow within u_pisc_date_firstday
end type
end forward
...
global u_pisc_date_firstday u_pisc_date_firstday
...
on u_pisc_date_firstday.create
...
on u_pisc_date_firstday.destroy
...
id_uo_date = Date(String(f_pisc_get_date_nowtime(), "YYYY.MM") + ".01")
