$PBExportHeader$u_per_applydate_from.sru
$PBExportComments$일자 선택 - 시스템 기준일 - is_uo_date
forward
global type u_per_applydate_from from userobject
end type
type pb_next from picturebutton within u_per_applydate_from
end type
type pb_prev from picturebutton within u_per_applydate_from
end type
type sle_date from singlelineedit within u_per_applydate_from
end type
type pb_ddlb from picturebutton within u_per_applydate_from
end type
type dw_cal from datawindow within u_per_applydate_from
end type
end forward
...
global u_per_applydate_from u_per_applydate_from
...
on u_per_applydate_from.create
...
on u_per_applydate_from.destroy
...
BringToTop = True
id_uo_date = Date(string(Mid(g_s_date,1,6)+'01','@@@@-@@-@@'))
...
integer height = 572
integer taborder = 10
string dataobject = "d_per_dddw_cal"
