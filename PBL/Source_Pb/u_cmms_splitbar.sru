$PBExportHeader$u_cmms_splitbar.sru
$PBExportComments$Splitbar
forward
global type u_cmms_splitbar from statictext
end type
end forward
...
global u_cmms_splitbar u_cmms_splitbar
...
public function boolean of_IsSupported ()
...
on u_cmms_splitbar.create
end on

on u_cmms_splitbar.destroy
end on
