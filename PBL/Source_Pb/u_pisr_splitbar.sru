$PBExportHeader$u_pisr_splitbar.sru
$PBExportComments$Splitbar
forward
global type u_pisr_splitbar from statictext
end type
end forward
...
global u_pisr_splitbar u_pisr_splitbar
...
on u_pisr_splitbar.create
end on

on u_pisr_splitbar.destroy
end on
