...
$PBExportComments$엑셀자료 업로드(기본정보)
forward
...
if MessageBox("경고", "해당 기본정보을 모두삭제합니다. ~r" + &
		"새로 업로드합니다. 계속하시겠습니까?", Exclamation!, OKCancel!, 2) = 2 then
	return 0
end if
...
choose case is_cocode
	...
	case 'O'
		ls_table = 'twemail'
	case else
		messagebox("알림","시스템개발 담당자에게 연락바랍니다.")
		return 0
end choose
...
long backcolor = 12632256
boolean enabled = false
string text = "◎  기본정보 EXCEL 자료 LOAD  ◎"
