$PBExportHeader$w_wip032u.srw
$PBExportComments$전월재공 유상사급품 수정
forward
global type w_wip032u from w_origin_sheet02
end type
type st_4 from statictext within w_wip032u
end type
type dw_report from datawindow within w_wip032u
end type
type dw_wip032u_01 from datawindow within w_wip032u
end type
type dw_wip032u_02 from datawindow within w_wip032u
end type
type dw_wip032u_03 from datawindow within w_wip032u
end type
type pb_down from picturebutton within w_wip032u
end type
type uo_1 from uo_ccyymm_mps within w_wip032u
end type
type gb_1 from groupbox within w_wip032u
end type
end forward
...
st_4 st_4
dw_report dw_report
dw_wip032u_01 dw_wip032u_01
dw_wip032u_02 dw_wip032u_02
dw_wip032u_03 dw_wip032u_03
pb_down pb_down
uo_1 uo_1
gb_1 gb_1
end type
global w_wip032u w_wip032u
...
//마감월 말일 날짜 가져오기
ls_adjdate = f_relativedate(uf_wip_addmonth(string(uo_1.uf_yyyymm()),1) + '01', -1)
...
ls_adjdate = string(uo_1.uf_yyyymm())
...
this.dw_wip032u_01=create dw_wip032u_01
this.dw_wip032u_02=create dw_wip032u_02
this.dw_wip032u_03=create dw_wip032u_03
...
this.Control[iCurrent+3]=this.dw_wip032u_01
this.Control[iCurrent+4]=this.dw_wip032u_02
this.Control[iCurrent+5]=this.dw_wip032u_03
this.Control[iCurrent+6]=this.pb_down
this.Control[iCurrent+7]=this.uo_1
this.Control[iCurrent+8]=this.gb_1
end on

on w_wip032u.destroy
call super::destroy
destroy(this.st_4)
destroy(this.dw_report)
destroy(this.dw_wip032u_01)
destroy(this.dw_wip032u_02)
destroy(this.dw_wip032u_03)
...
dw_wip032u_01.settransobject(sqlca)
dw_wip032u_02.settransobject(sqlca)
dw_wip032u_03.settransobject(sqlca)

dw_wip032u_01.getchild("wip001_waplant",dwc_01)
	dwc_01.settransobject(sqlca)
	dwc_01.retrieve('SLE220')
dw_wip032u_01.getchild("wip001_wadvsn",dwc_02)
	dwc_02.settransobject(sqlca)
	dwc_02.retrieve('D')
dw_wip032u_01.getchild("inv101_pdcd",dwc_05)
	dwc_05.settransobject(sqlca)
	dwc_05.retrieve('A')	

dw_wip032u_01.insertrow(0)
dw_wip032u_01.setitem(1,"inv101_srce",'01')
...
//필수입력 체크
dw_wip032u_01.accepttext()
dw_wip032u_02.reset()
dw_wip032u_03.reset()
if f_wip_mandantory_chk(dw_wip032u_01) = -1 then							
...
ls_dvsn  = dw_wip032u_01.getitemstring(1, "wip001_wadvsn")
ls_iocd = '3'
ls_orct = dw_wip032u_01.getitemstring(1,"wip001_waorct")
ls_pdcd = trim(dw_wip032u_01.getitemstring(1,"inv101_pdcd"))
ls_srce = trim(dw_wip032u_01.getitemstring(1,"inv101_srce"))
...
if f_spacechk(ls_orct) = -1 then
	li_rowcnt = dw_wip032u_02.retrieve(g_s_company, ls_plant, ls_dvsn,ls_pdcd, ls_iocd, '%', ls_srce, mid(ls_adjdate,1,4),mid(ls_adjdate,5,2))  //전업체
else
	
	ls_rtnvalue = f_get_vendor01(g_s_company, dw_wip032u_01.getitemstring(1,"vndr"))
	if f_spacechk(ls_rtnvalue) = -1 then		//사업자번호가 입력된경우
		uo_status.st_message.text = "사업자번호에 해당하는 업체가 없습니다."
		return 0
	end if
	li_rowcnt = dw_wip032u_02.retrieve(g_s_company, ls_plant, ls_dvsn,ls_pdcd, ls_iocd, ls_orct + '%', ls_srce, mid(ls_adjdate,1,4),mid(ls_adjdate,5,2))  //해당업체
end if
...
dw_wip032u_02.accepttext()
ls_adjdate = string(uo_1.uf_yyyymm())
ls_postdate = uf_wip_addmonth(ls_adjdate,1)
ls_closedate = f_relativedate(uf_wip_addmonth(ls_adjdate,1) + '01', -1)
li_rowcnt = dw_wip032u_02.rowcount()
for li_cnt = 1 to li_rowcnt
	ls_plant = dw_wip032u_02.getitemstring(li_cnt,"wip002_wbplant")
	ls_dvsn = dw_wip032u_02.getitemstring(li_cnt,"wip002_wbdvsn")
	ls_orct = dw_wip032u_02.getitemstring(li_cnt,"wip002_wborct")
	ls_itno = dw_wip032u_02.getitemstring(li_cnt,"wip002_wbitno")
	ls_iocd = dw_wip032u_02.getitemstring(li_cnt,"wip002_wbiocd")
	ls_itnm = dw_wip032u_02.getitemstring(li_cnt,"inv002_itnm")
	ls_cls = dw_wip032u_02.getitemstring(li_cnt,"inv101_cls")
	ls_srce = dw_wip032u_02.getitemstring(li_cnt,"inv101_srce")
	ls_pdcd = mid(dw_wip032u_02.getitemstring(li_cnt,"inv101_pdcd"),1,2)
	ls_xunit = dw_wip032u_02.getitemstring(li_cnt,"inv101_xunit")
	lc_convqty = dw_wip032u_02.getitemnumber(li_cnt,"inv101_convqty")
	lc_ohqt = dw_wip032u_02.getitemnumber(li_cnt,"ohqt")
	lc_phohqt = dw_wip032u_02.getitemnumber(li_cnt,"phohqt")
	...
	lc_phohqt = dw_wip032u_02.getitemnumber(li_cnt,"phohqt") * lc_convqty
	...
	//lc_convqty = dw_wip032u_02.getitemdecimal(li_cnt,"inv101_convqty")
	lc_costav = dw_wip032u_02.getitemdecimal(li_cnt,"wip002_wbavrg1")
	lc_costav = lc_costav / lc_convqty
...
type uo_status from w_origin_sheet02`uo_status within w_wip032u
end type
...
boolean bringtotop = true
string title = "none"
string dataobject = "d_wip032u_02"
...
dw_wip032u_03.retrieve(g_s_company, ls_plant, ls_dvsn, ls_iocd, ls_orct,ls_itno, ls_fromdt, ls_todt, lc_convqty)
end event
...
boolean bringtotop = true
string title = "none"
string dataobject = "d_wip032u_03"
boolean hscrollbar = true
boolean vscrollbar = true
boolean livescroll = true
borderstyle borderstyle = stylelowered!
...
event clicked;if dw_wip032u_02.rowcount() < 1 then
	return 0
end if
...
event constructor;call super::constructor;string ls_premonth
ls_premonth = f_relative_month(g_s_date,-1)
uo_1.uf_reset(integer(mid(ls_premonth,1,4)),integer(mid(ls_premonth,5,2)))
end event

event ue_modify;call super::ue_modify;string ls_premonth, ls_ccyymm

ls_ccyymm = string(yyyy * 100 + mm)
if ls_ccyymm >= mid(g_s_date,1,6) then
	ls_premonth = f_relative_month(g_s_date,-1)
	uo_1.uf_reset(integer(mid(ls_premonth,1,4)),integer(mid(ls_premonth,5,2)))
end if
end event
