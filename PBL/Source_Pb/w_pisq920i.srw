$PBExportHeader$w_pisq920i.srw
$PBExportComments$검사성적서 조회 및 출력 - 검사성적서 세부내역 수정(운영자용)
forward
global type w_pisq920i from w_ipis_sheet01
end type
type dw_pisq920i from u_vi_std_datawindow within w_pisq920i
end type
type uo_area from u_pisc_select_area within w_pisq920i
end type
type uo_division from u_pisc_select_division within w_pisq920i
end type
type st_4 from statictext within w_pisq920i
end type
type cb_detail from commandbutton within w_pisq920i
end type
type uo_date from u_pisc_date_applydate within w_pisq920i
end type
type uo_dateto from u_pisc_date_applydate_1 within w_pisq920i
end type
type rb_qcdate from radiobutton within w_pisq920i
end type
type rb_makedate from radiobutton within w_pisq920i
end type
type cb_saveas from commandbutton within w_pisq920i
end type
type cb_print from commandbutton within w_pisq920i
end type
type st_5 from statictext within w_pisq920i
end type
type st_3 from statictext within w_pisq920i
end type
type sle_suppliercode from singlelineedit within w_pisq920i
end type
type sle_itemcode from singlelineedit within w_pisq920i
end type
type sle_itemname from singlelineedit within w_pisq920i
end type
type sle_suppliername from singlelineedit within w_pisq920i
end type
type pb_serch from picturebutton within w_pisq920i
end type
type pb_serch2 from picturebutton within w_pisq920i
end type
type gb_1 from groupbox within w_pisq920i
end type
end forward
...
on w_pisq920i.create
int iCurrent
call super::create
this.dw_pisq920i=create dw_pisq920i
...
this.Control[iCurrent+1]=this.dw_pisq920i
...
on w_pisq920i.destroy
call super::destroy
destroy(this.dw_pisq920i)
...
of_resize_register(dw_pisq920i, FULL)
...
// 데이타를 조회한다
//
dw_pisq920i.Retrieve(ls_AreaCode, ls_DivisionCode, ls_SupplierCode, ls_itemcode, ls_datefm, ls_dateto, ls_chkflag)

// 데이타윈도우의 첫번째 포커스행에 반전표시를 나타낸다
//
f_SetHighlight(dw_pisq920i, 1, True)	
...
// 트랜잭션을 연결한다
//
dw_pisq920i.SetTransObject(SQLPIS)
...
type uo_status from w_ipis_sheet01`uo_status within w_pisq920i
integer x = 18
integer width = 3598
end type
...
//
IF dw_pisq920i.GetSelectedRow(0) = 0 THEN
...
// 기준서출력에 필요한 정보를 구한다
//
ls_AreaCode			= dw_pisq920i.GetItemString(dw_pisq920i.GetSelectedRow(0), "AreaCode")
ls_DivisionCode	= dw_pisq920i.GetItemString(dw_pisq920i.GetSelectedRow(0), "DivisionCode")
ls_SupplierCode	= dw_pisq920i.GetItemString(dw_pisq920i.GetSelectedRow(0), "SupplierCode")
ls_Deliveryno		= dw_pisq920i.GetItemString(dw_pisq920i.GetSelectedRow(0), "Deliveryno")
ls_ItemCode			= dw_pisq920i.GetItemString(dw_pisq920i.GetSelectedRow(0), "ItemCode")
...
// 검사성적서 세부내역 화면 오픈
//
OpenWithParm(w_pisq925i, istr_parms)
