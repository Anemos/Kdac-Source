$PBExportHeader$w_today.srw
$PBExportComments$데이터윈도우용 달력윈도우
forward
global type w_today from window
end type
type cb_1 from commandbutton within w_today
end type
type uo_1 from u_dw_today within w_today
end type
end forward
