$PBExportHeader$u_pisc_select_division.sru
$PBExportComments$공장 선택 - is_uo_divisioncode, is_uo_divisionname, is_uo_divisionnameeng
forward
global type u_pisc_select_division from userobject
end type
type dw_1 from datawindow within u_pisc_select_division
end type
type st_1 from statictext within u_pisc_select_division
end type
end forward
...
global u_pisc_select_division u_pisc_select_division
...
on u_pisc_select_division.create
...
on u_pisc_select_division.destroy
destroy(this.dw_1)
destroy(this.st_1)
end on
...
If is_uo_divisioncode <> ls_divisioncode Then
	...
	Else
		...
		End If
	End If
	gs_divisioncode	= is_uo_divisioncode
	f_pisc_set_server("DIVISION", gs_areacode, is_uo_divisioncode)
