$PBExportHeader$u_mpms_date_scroll_month.sru
$PBExportComments$일자 선택 - 월선택 - 스크롤 사용 - is_uo_month
forward
global type u_mpms_date_scroll_month from u_vi_cst_basic
end type
type st_1 from statictext within u_mpms_date_scroll_month
end type
type em_date from editmask within u_mpms_date_scroll_month
end type
type vsb_1 from vscrollbar within u_mpms_date_scroll_month
end type
end forward
...
global u_mpms_date_scroll_month u_mpms_date_scroll_month
...
on u_mpms_date_scroll_month.create
int iCurrent
call super::create
...
on u_mpms_date_scroll_month.destroy
call super::destroy
destroy(this.st_1)
