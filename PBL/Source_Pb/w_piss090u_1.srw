$PBExportHeader$w_piss090u_1.srw
$PBExportComments$상차계획
forward
global type w_piss090u_1 from w_ipis_sheet01
end type
type cbx_1 from checkbox within w_piss090u_1
end type
type cb_srview from commandbutton within w_piss090u_1
end type
type cb_split from commandbutton within w_piss090u_1
end type
type cb_print from commandbutton within w_piss090u_1
end type
type tab_1 from tab within w_piss090u_1
end type
...
type cb_trucknew from commandbutton within w_piss090u_1
end type
type dw_plancancel from datawindow within w_piss090u_1
end type
type st_2 from statictext within w_piss090u_1
end type
type st_3 from statictext within w_piss090u_1
end type
type st_4 from statictext within w_piss090u_1
end type
type st_shipqty from statictext within w_piss090u_1
end type
type st_minapqty from statictext within w_piss090u_1
end type
type st_invqty from statictext within w_piss090u_1
end type
type dw_id from datawindow within w_piss090u_1
end type
type dw_truckorder from datawindow within w_piss090u_1
end type
type dw_print from datawindow within w_piss090u_1
end type
type sle_checksrno from singlelineedit within w_piss090u_1
end type
type em_shipeditno from editmask within w_piss090u_1
end type
type sle_custcode from singlelineedit within w_piss090u_1
end type
type st_5 from statictext within w_piss090u_1
end type
type uo_shipoemgubun from u_pisc_select_code within w_piss090u_1
end type
type em_applyfrom from editmask within w_piss090u_1
end type
type uo_date from u_pisc_date_applydate within w_piss090u_1
end type
type uo_area from u_pisc_select_area within w_piss090u_1
end type
type uo_division from u_pisc_select_division within w_piss090u_1
end type
type gb_1 from groupbox within w_piss090u_1
end type
type gb_2 from groupbox within w_piss090u_1
end type
type gb_4 from groupbox within w_piss090u_1
end type
type gb_5 from groupbox within w_piss090u_1
end type
type gb_6 from groupbox within w_piss090u_1
end type
type gb_8 from groupbox within w_piss090u_1
end type
type gb_7 from groupbox within w_piss090u_1
end type
type gb_9 from groupbox within w_piss090u_1
end type
type gb_10 from groupbox within w_piss090u_1
end type
type gb_50 from groupbox within w_piss090u_1
end type
type dw_truck from datawindow within w_piss090u_1
end type
type gb_truck from groupbox within w_piss090u_1
end type
end forward
...
global w_piss090u_1 w_piss090u_1
...
public function boolean wf_update_tloadplan_child (string fs_shipplandate, long fl_truckorder, string fs_srno, string fs_areacode, string fs_divisioncode, long fl_truckplan);long ll_parent_qty,ll_child_qty,ll_count,ll_shipeditno,ll_cnt
...
this.Control[iCurrent+11]=this.st_shipqty
this.Control[iCurrent+12]=this.st_minapqty
this.Control[iCurrent+13]=this.st_invqty
this.Control[iCurrent+14]=this.dw_id
this.Control[iCurrent+15]=this.dw_truckorder
this.Control[iCurrent+16]=this.dw_print
this.Control[iCurrent+17]=this.sle_checksrno
this.Control[iCurrent+18]=this.em_shipeditno
this.Control[iCurrent+19]=this.sle_custcode
this.Control[iCurrent+20]=this.st_5
this.Control[iCurrent+21]=this.uo_shipoemgubun
this.Control[iCurrent+22]=this.em_applyfrom
this.Control[iCurrent+23]=this.uo_date
this.Control[iCurrent+24]=this.uo_area
this.Control[iCurrent+25]=this.uo_division
...
this.Control[iCurrent+33]=this.gb_9
this.Control[iCurrent+34]=this.gb_10
this.Control[iCurrent+35]=this.gb_50
this.Control[iCurrent+36]=this.dw_truck
this.Control[iCurrent+37]=this.gb_truck
end on

on w_piss090u_1.destroy
call super::destroy
destroy(this.cbx_1)
...
type uo_status from w_ipis_sheet01`uo_status within w_piss090u_1
integer x = 18
integer y = 2404
end type
...
event ue_lmousedown;//uo_status.st_message.text = "lmousedown start"
wf_truck_dw_lmouse_down(flags, xpos, ypos)
//uo_status.st_message.text = "lmousedown end"


end event

event ue_lmouseup;//uo_status.st_message.text = "lmousedup start"
wf_truck_dw_lmouse_up(flags, xpos, ypos)
//uo_status.st_message.text = "lmousedown up"
end event

event ue_mousemove;//uo_status.st_message.text = "lmousemove start"
wf_truck_dw_mousemove(flags, xpos, ypos)
//uo_status.st_message.text = "lmousemove end"
end event
...
if TypeOf (ldo_object) = DataWindow! then
	ldw_control = ldo_object
	dw_truck.object.modicheck[il_truckrow] = 'Y'
...
event rowfocuschanged;//uo_status.st_message.text = "rowfocuschenged start : " + string(getrow())
If GetRow() > 0 then
	SelectRow (0, False)
...
End If
//uo_status.st_message.text = "rowfocuschenged end : " + string(getrow())
end event

event clicked;uo_status.st_message.text = "click start : " + string(row)
//if row >0 then 
	il_delete_truckorder = dw_truck.object.truck[row]
	wf_truck_dw_clicked(xpos, ypos, row, dwo)
//end if

uo_status.st_message.text = "click end" + string(dw_truck.rowcount())
