$PBExportHeader$w_mpms_find_dept.srw
$PBExportComments$외주업체 및 사용처 찾기
forward
global type w_mpms_find_dept from window
end type
type dw_find from u_vi_std_datawindow within w_mpms_find_dept
end type
type pb_find from picturebutton within w_mpms_find_dept
end type
type rb_supp from radiobutton within w_mpms_find_dept
end type
type rb_line from radiobutton within w_mpms_find_dept
end type
type sle_1 from singlelineedit within w_mpms_find_dept
end type
type cb_2 from commandbutton within w_mpms_find_dept
end type
type cb_enter from commandbutton within w_mpms_find_dept
end type
type gb_1 from groupbox within w_mpms_find_dept
end type
type gb_2 from groupbox within w_mpms_find_dept
end type
end forward
...
global w_mpms_find_dept w_mpms_find_dept

type variables

end variables

on w_mpms_find_dept.create
...
integer height = 884
integer taborder = 40
string dataobject = "d_mpms_find_dept"
...
If rb_line.checked Then
	ll_Row = dw_find.retrieve('1', ls_key)
Else
	ll_Row = dw_find.retrieve('2', ls_key)
End If
...
ls_rtnparm = dw_find.getitemstring(ll_row, 'findcode')
