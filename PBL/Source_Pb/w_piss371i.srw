$PBExportHeader$w_piss371i.srw
$PBExportComments$제품입고현황
forward
global type w_piss371i from w_ipis_sheet01
end type
type dw_sheet from u_vi_std_datawindow within w_piss371i
end type
type uo_area from u_pisc_select_area within w_piss371i
end type
type uo_division from u_pisc_select_division within w_piss371i
end type
type uo_date from u_pisc_date_applydate within w_piss371i
end type
type uo_1 from u_pisc_date_applydate_1 within w_piss371i
end type
type st_2 from statictext within w_piss371i
end type
type dw_print from datawindow within w_piss371i
end type
type gb_1 from groupbox within w_piss371i
end type
end forward
...
ll_count = dw_sheet.retrieve(is_areacode,is_divisioncode,is_prddate,is_prddate1)
...
type uo_status from w_ipis_sheet01`uo_status within w_piss371i
end type
...
string dataobject = "d_piss371i_01"
...
boolean bringtotop = true
string title = "none"
string dataobject = "d_piss371i_02"
