$PBExportHeader$w_tmm_prt.srw
$PBExportComments$(출력물인쇄)
forward
global type w_tmm_prt from window
end type
type pb_down from picturebutton within w_tmm_prt
end type
type cb_scroll from commandbutton within w_tmm_prt
end type
type em_scrollpage from editmask within w_tmm_prt
end type
type cbx_rulers from checkbox within w_tmm_prt
end type
type st_6 from statictext within w_tmm_prt
end type
type ddlb_scale from dropdownlistbox within w_tmm_prt
end type
type st_1 from statictext within w_tmm_prt
end type
type dw_preview from datawindow within w_tmm_prt
end type
type uo_status from uo_commonstatus within w_tmm_prt
end type
type gb_2 from groupbox within w_tmm_prt
end type
type gb_1 from groupbox within w_tmm_prt
end type
end forward
...
event ue_dwset;integer li_rowcnt
...
//dw_preview.reset()
//choose case mid(i_str_prt.dwsyntax,1,1)
//	case '1'
//		dw_preview.DataObject = "d_tmm410u_02_tablet"
//		dw_preview.SettransObject(i_str_prt.transaction)
//		li_rowcnt = dw_preview.retrieve(mid(i_str_prt.dwsyntax,2,8),mid(i_str_prt.dwsyntax,10,8))
//	case '2'
//		dw_preview.DataObject = "d_tmm410u_03"
//		dw_preview.SettransObject(i_str_prt.transaction)
//		li_rowcnt = dw_preview.retrieve(mid(i_str_prt.dwsyntax,2,8),mid(i_str_prt.dwsyntax,10,8))
//	case '3'
//		dw_preview.DataObject = "d_tmm410u_04"
//		dw_preview.SettransObject(i_str_prt.transaction)
//		li_rowcnt = dw_preview.retrieve(mid(i_str_prt.dwsyntax,2,8),mid(i_str_prt.dwsyntax,10,8),mid(i_str_prt.dwsyntax,18,1))
//	case '4'
//		dw_preview.DataObject = "d_tmm410u_05"
//		dw_preview.SettransObject(i_str_prt.transaction)
//		li_rowcnt = dw_preview.retrieve(mid(i_str_prt.dwsyntax,2,8),mid(i_str_prt.dwsyntax,10,8))
//	case else
//		MessageBox("알 림", "DataObject가 지정되지 않았습니다!~r~n" + &
...
event clicked;f_save_to_excel(dw_preview)
end event
