$PBExportHeader$w_pism260i.srw
$PBExportComments$[사업계획]WorkCenter 대당MH 조회
forward
global type w_pism260i from w_pism_sheet02
end type
type dw_pism260i_01 from u_pism_dw within w_pism260i
end type
type cb_maiindown from commandbutton within w_pism260i
end type
type st_4 from statictext within w_pism260i
end type
type uo_2 from uo_ccyy_mps within w_pism260i
end type
type uo_3 from u_bpm_select_arev within w_pism260i
end type
type gb_3 from groupbox within w_pism260i
end type
end forward
...
dw_pism260i_01.Width = newwidth 	- ( ls_gap * 4 )
dw_pism260i_01.Height= newheight - (dw_pism260i_01.y + ls_split + ls_status)
...
f_pism_working_msg(uo_div.is_uo_divisionname + "공장", dw_pism260i_01.Title + "를 조회중입니다. 잠시만 기다려 주십시오.") 
 
dw_pism260i_01.SetTransObject(SqlPIS)
li_ret = dw_pism260i_01.Retrieve(istr_mh.area, istr_mh.div, ls_year, ls_revno ) 

If IsValid(w_pism_working) Then Close(w_pism_working) 
If li_ret = 0 Then f_pism_messagebox(Information!, -1, "조회실패", " 해당 기준일의 MH정보가 존재하지 않습니다.")

dw_pism260i_01.SetFocus() 
end event

on w_pism260i.create
int iCurrent
call super::create
this.dw_pism260i_01=create dw_pism260i_01
...
this.Control[iCurrent+1]=this.dw_pism260i_01
...
on w_pism260i.destroy
call super::destroy
destroy(this.dw_pism260i_01)
...
type uo_status from w_pism_sheet02`uo_status within w_pism260i
end type

type st_fromto from w_pism_sheet02`st_fromto within w_pism260i
end type

type uo_todate from w_pism_sheet02`uo_todate within w_pism260i
integer x = 2043
end type

type gb_2 from w_pism_sheet02`gb_2 within w_pism260i
end type

type uo_fromdate from w_pism_sheet02`uo_fromdate within w_pism260i
integer x = 1280
integer width = 667
integer height = 92
end type

type uo_month from w_pism_sheet02`uo_month within w_pism260i
boolean visible = false
integer x = 1285
integer y = 44
end type

type uo_year from w_pism_sheet02`uo_year within w_pism260i
boolean visible = false
integer x = 1289
integer y = 44
end type

type uo_date from w_pism_sheet02`uo_date within w_pism260i
boolean visible = false
integer x = 1275
integer y = 48
end type

type uo_area from w_pism_sheet02`uo_area within w_pism260i
end type

type uo_div from w_pism_sheet02`uo_div within w_pism260i
end type

type uo_frmonth from w_pism_sheet02`uo_frmonth within w_pism260i
boolean visible = false
integer x = 1271
integer y = 44
end type

type st_fromtomonth from w_pism_sheet02`st_fromtomonth within w_pism260i
boolean visible = false
integer x = 1925
integer y = 44
end type

type gb_1 from w_pism_sheet02`gb_1 within w_pism260i
end type

type uo_tomonth from w_pism_sheet02`uo_tomonth within w_pism260i
boolean visible = false
integer x = 1280
integer y = 48
end type
...
string dataobject = "d_pism260i_01"
...
event clicked;f_save_to_excel_number(dw_pism260i_01)
end event
