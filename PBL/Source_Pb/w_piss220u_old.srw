$PBExportHeader$w_piss220u_old.srw
$PBExportComments$BACKSHIP
forward
global type w_piss220u_old from w_ipis_sheet01
end type
type uo_division from u_pisc_select_division within w_piss220u_old
end type
type uo_area from u_pisc_select_area within w_piss220u_old
end type
type uo_date from u_pisc_date_applydate within w_piss220u_old
end type
type st_8 from statictext within w_piss220u_old
end type
type uo_scustgubun from u_pisc_select_code within w_piss220u_old
end type
type uo_custcode from u_piss_select_custcode within w_piss220u_old
end type
type dw_2 from datawindow within w_piss220u_old
end type
type st_10 from statictext within w_piss220u_old
end type
type st_2 from statictext within w_piss220u_old
end type
type uo_1 from u_pisc_date_applydate_1 within w_piss220u_old
end type
type sle_citno from singlelineedit within w_piss220u_old
end type
type st_11 from statictext within w_piss220u_old
end type
type ddlb_gubun from dropdownlistbox within w_piss220u_old
end type
type dw_save from datawindow within w_piss220u_old
end type
type dw_print from datawindow within w_piss220u_old
end type
type dw_3 from datawindow within w_piss220u_old
end type
type gb_1 from groupbox within w_piss220u_old
end type
type sle_1 from singlelineedit within w_piss220u_old
end type
type dw_4 from datawindow within w_piss220u_old
end type
type st_3 from statictext within w_piss220u_old
end type
type st_4 from statictext within w_piss220u_old
end type
type dw_sheet from u_vi_std_datawindow within w_piss220u_old
end type
type pb_excel from picturebutton within w_piss220u_old
end type
type gb_2 from groupbox within w_piss220u_old
end type
end forward
...
global w_piss220u_old w_piss220u_old
...
for j = 1 to ll_count step 1
	...
	where areacode     = :is_areacode
	  and divisioncode = :is_divisioncode
	  and applyfrom    like substring(:ls_close_date,1,7) + '%'
	...
	ls_temp_kbno = is_areacode + is_divisioncode + 'Z' + mid(ls_close_date,3,2) + mid(ls_close_date,6,2) + ls_seqno
	dw_save.ReSet()
...
type uo_status from w_ipis_sheet01`uo_status within w_piss220u_old
integer y = 2504
end type
