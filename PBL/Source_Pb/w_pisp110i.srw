$PBExportHeader$w_pisp110i.srw
$PBExportComments$무간판 생산/입고 이력
forward
global type w_pisp110i from w_ipis_sheet01
end type
type dw_1 from u_vi_std_datawindow within w_pisp110i
end type
type uo_area from u_pisc_select_area within w_pisp110i
end type
type uo_division from u_pisc_select_division within w_pisp110i
end type
type uo_workcenter from u_pisc_select_workcenter within w_pisp110i
end type
type uo_line from u_pisc_select_line within w_pisp110i
end type
type uo_code from u_pisc_select_code within w_pisp110i
end type
type st_2 from statictext within w_pisp110i
end type
type uo_fromdate from u_pisc_date_firstday within w_pisp110i
end type
type uo_todate from u_pisc_date_applydate_1 within w_pisp110i
end type
type dw_print from datawindow within w_pisp110i
end type
type cb_1 from commandbutton within w_pisp110i
end type
type gb_1 from groupbox within w_pisp110i
end type
type gb_2 from groupbox within w_pisp110i
end type
type gb_3 from groupbox within w_pisp110i
end type
type gb_4 from groupbox within w_pisp110i
end type
end forward
...
global w_pisp110i w_pisp110i

type variables
Boolean	ib_open
end variables

on w_pisp110i.create
int iCurrent
call super::create
...
lstr_prt.title			= '무간판 생산/입고 이력'
lstr_prt.tag			= '무간판 생산/입고 이력'
...
type uo_status from w_ipis_sheet01`uo_status within w_pisp110i
integer width = 3598
end type
...
string dataobject = "d_pisp110i_01"
...
string title = "인쇄"
string dataobject = "d_pisp110i_01_print"
boolean hscrollbar = true
boolean vscrollbar = true
...
fontfamily fontfamily = modern!
string facename = "굴림체"
string text = "무간판원인 등록(&I)"
end type

event clicked;istr_parms.string_arg[1] = is_size
istr_parms.string_arg[2] = "PNOKB"
istr_parms.string_arg[3] = "무간판생산등록원인"
