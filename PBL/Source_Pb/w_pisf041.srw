$PBExportHeader$w_pisf041.srw
$PBExportComments$예방정비이력 보고서
forward
global type w_pisf041 from w_cmms_sheet01
end type
type em_2 from editmask within w_pisf041
end type
type cb_2 from commandbutton within w_pisf041
end type
type cb_1 from commandbutton within w_pisf041
end type
type em_1 from editmask within w_pisf041
end type
type st_2 from statictext within w_pisf041
end type
type st_1 from statictext within w_pisf041
end type
type dw_1 from uo_datawindow within w_pisf041
end type
type uo_area from u_cmms_select_area within w_pisf041
end type
type uo_division from u_cmms_select_division within w_pisf041
end type
type pb_1 from picturebutton within w_pisf041
end type
type gb_1 from groupbox within w_pisf041
end type
end forward
...
sql=" and task_hist.area_code = '"+gs_kmarea+"' and task_hist.factory_code = '"&
		+gs_kmdivision+"' and convert(varchar(10),task_hist.end_date,120) between '"&
		+em_1.text+"' and '"+em_2.text+"'"+"order by task_hist.end_date Desc"
...
type uo_status from w_cmms_sheet01`uo_status within w_pisf041
end type
...
integer height = 1392
integer taborder = 10
string dataobject = "d_task_report"
