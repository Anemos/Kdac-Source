$PBExportHeader$w_bpm402u_res_04.srw
forward
global type w_bpm402u_res_04 from window
end type
type tv_1 from treeview within w_bpm402u_res_04
end type
type dw_1 from datawindow within w_bpm402u_res_04
end type
type cb_3 from commandbutton within w_bpm402u_res_04
end type
type cb_2 from commandbutton within w_bpm402u_res_04
end type
end forward
...
global w_bpm402u_res_04 w_bpm402u_res_04
...
ids_data1.reset()
l_n_count = ids_data1.retrieve(l_s_applyyear,l_s_revno,l_s_plant,l_s_div,l_s_pitno,g_s_date)
wf_add_items(ag_handle,l_n_level,l_n_count,ag_tvcurrent)


end subroutine

on w_bpm402u_res_04.create
...
ids_data1.dataobject = "d_bpm504_secitem"
...
dw_1.retrieve(l_s_applyyear,l_s_revno,l_s_plant,l_s_div,l_s_itno,g_s_date)
...
for k = 1 to i
	...
	UPDATE "PBBPM"."BPM504"  
   	SET "PEDTE" = :l_s_enddate,   
          "PCHCD" = 'D'  
   	WHERE ( "PBBPM"."BPM504"."PCMCD" = :g_s_company ) AND 
         	...
         	( "PBBPM"."BPM504"."PPITN" = :l_s_ppitn ) AND  
         	( "PBBPM"."BPM504"."PCITN" = :l_s_citno[k] ) AND  
         	( "PBBPM"."BPM504"."PCHDT" = :l_s_chdt )   
            using sqlca;
...
//         	( "PBBPM"."BPM504"."PDVSN" = :l_s_div ) AND  
//         	( "PBBPM"."BPM504"."PPITN" = :l_s_ppitn ) AND  
//         	( "PBBPM"."BPM504"."PCITN" = :l_s_citno[k] )
//				using sqlca ;
//   if sqlca.sqlcode = 0 then
//		commit using sqlca;
//	end if
