$PBExportHeader$u_cmms_date_applydate.sru
$PBExportComments$일자 선택 - 시스템 기준일 - is_uo_date
forward
global type u_cmms_date_applydate from userobject
end type
type st_name from statictext within u_cmms_date_applydate
end type
type pb_next from picturebutton within u_cmms_date_applydate
end type
type pb_prev from picturebutton within u_cmms_date_applydate
end type
type sle_date from singlelineedit within u_cmms_date_applydate
end type
type pb_ddlb from picturebutton within u_cmms_date_applydate
end type
type dw_cal from datawindow within u_cmms_date_applydate
end type
end forward
...
global u_cmms_date_applydate u_cmms_date_applydate
...
on u_cmms_date_applydate.create
...
on u_cmms_date_applydate.destroy
