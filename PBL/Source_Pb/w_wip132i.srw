$PBExportHeader$w_wip132i.srw
$PBExportComments$재공수불총괄표(유상사급)
forward
global type w_wip132i from w_origin_sheet04
end type
type dw_2 from datawindow within w_wip132i
end type
type dw_4 from datawindow within w_wip132i
end type
type pb_1 from picturebutton within w_wip132i
end type
type dw_report from datawindow within w_wip132i
end type
type dw_exch_rpt from datawindow within w_wip132i
end type
type gb_1 from groupbox within w_wip132i
end type
end forward
   	 ...
   	 l_s_pdcd    = arg_ds.getitemstring(i,"prodcd")   
		 ...
		 if i_s_ioindex = '4' then
   	 	...
   	 	arg_ds.setitem(i,"dvsn_nm",trim(f_get_coflname(g_s_company,'DAC030', arg_ds.object.wip003_wcdvsn[i])))
		 	...
		 	arg_ds.setitem(i,"plant_nm",trim(f_get_coflname(g_s_company,'SLE220', arg_ds.object.wip014_wbplant[i])))
   	 	arg_ds.setitem(i,"dvsn_nm",trim(f_get_coflname(g_s_company,'DAC030', arg_ds.object.wip014_wbdvsn[i])))
		 end if
		 if mid(l_s_pdcd,1,2) = '90' then
			 continue
		 end if	 
...
choose case i_s_ioindex
	case '3'
		lds_01 = create datastore
		lds_01.dataobject = 'd_wip132i_line_vendor'
		lds_01.settransobject(sqlca)
		dw_2.dataobject = 'd_wip132i_line_vendor'
		dw_2.settransobject(sqlca)
      dw_report.dataobject = 'd_wip132i_line_vendorrpt'
		dw_report.settransobject(sqlca)
	   lds_01.retrieve(g_s_company, arg_plant, arg_dvsn, '3', i_s_fromdt, i_s_fromdt)

		ds_linevendor.retrieve(g_s_company, arg_plant, arg_dvsn, '3', i_s_todt, i_s_fromdt)
  ...
  case else
		uo_status.st_message.text = "해당하는 구분이 없습니다."
		return 0
end choose
	...
	case 'D'
		for ll_cnt = 1 to 5
			...
			choose case i_s_ioindex
				case '3'
					lds_01.reset()
					lds_01.retrieve(g_s_company, ls_plant, ls_dvsn, '3', i_s_fromdt, i_s_fromdt)
					ds_linevendor.retrieve(g_s_company, ls_plant, ls_dvsn, '3', i_s_todt, i_s_fromdt)
					wf_set_linevendor_onhand_amount(lds_01)
...
dw_4.insertrow(0)
dw_4.setitem(1,"wip001_waiocd",'3')
dw_4.setitem(1,"gubun",'1')

dw_2.settransobject(sqlca)

ds_linevendor = create datastore               
ds_linevendor.dataobject = "d_wip132i_line_vendor"
...
type uo_status from w_origin_sheet04`uo_status within w_wip132i
end type
...
string title = "none"
string dataobject = "d_wip132i_line_vendor"
...
integer taborder = 60
boolean bringtotop = true
string dataobject = "d_wip132i_01"
