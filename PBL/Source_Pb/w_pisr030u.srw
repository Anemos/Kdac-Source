$PBExportHeader$w_pisr030u.srw
$PBExportComments$Work Calendar
forward
global type w_pisr030u from w_ipis_sheet01
end type
type dw_1 from u_vi_std_datawindow within w_pisr030u
end type
type uo_area from u_pisc_select_area within w_pisr030u
end type
type uo_division from u_pisc_select_division within w_pisr030u
end type
type uo_month from u_pisc_date_scroll_month within w_pisr030u
end type
type dw_workgubun from datawindow within w_pisr030u
end type
type dw_print from datawindow within w_pisr030u
end type
type gb_1 from groupbox within w_pisr030u
end type
type gb_3 from groupbox within w_pisr030u
end type
end forward
	...
	IF li_return = 1 THEN	//2
		...
		For li_i = 1 To 31 Step 1
			...
			ll_DayNo	= DaysAfter (Date( left(uo_month.is_uo_month, 4) + '.01.01'), Date(ls_date)) + 1
			  INSERT INTO TPARTCALENDAR  
						( AreaCode, DivisionCode, ApplyMonth, ApplyDate, DayNo, WorkGubun, Remark, LastEmp, LastDate )  
...
type uo_status from w_ipis_sheet01`uo_status within w_pisr030u
end type
...
string dataobject = "d_pisr030u_01"
end type
...
string title = "none"
string dataobject = "d_pisr030u_02"
