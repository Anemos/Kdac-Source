$PBExportHeader$w_piss460u.srw
$PBExportComments$생관SR확정
forward
global type w_piss460u from w_ipis_sheet01
end type
type gb_4 from groupbox within w_piss460u
end type
type dw_sheet from u_vi_std_datawindow within w_piss460u
end type
type uo_division from u_pisc_select_division within w_piss460u
end type
type uo_area from u_pisc_select_area within w_piss460u
end type
type dw_2 from u_vi_std_datawindow within w_piss460u
end type
type dw_print from datawindow within w_piss460u
end type
type st_v_bar from uo_xc_splitbar within w_piss460u
end type
type rb_1 from radiobutton within w_piss460u
end type
type rb_2 from radiobutton within w_piss460u
end type
type rb_3 from radiobutton within w_piss460u
end type
type gb_2 from groupbox within w_piss460u
end type
type gb_3 from groupbox within w_piss460u
end type
type gb_1 from groupbox within w_piss460u
end type
type sle_custcode from singlelineedit within w_piss460u
end type
end forward
...
this.Control[iCurrent+7]=this.st_v_bar
...
this.Control[iCurrent+14]=this.sle_custcode
end on

on w_piss460u.destroy
call super::destroy
destroy(this.gb_4)
...
//messagebox("AA",sqlpis.servername)
dw_2.reset()
dw_sheet.reset()
...
type uo_status from w_ipis_sheet01`uo_status within w_piss460u
end type
