$PBExportHeader$u_per_todt.sru
$PBExportComments$일자 선택 - 시스템 기준일 - is_uo_date
forward
global type u_per_todt from userobject
end type
type pb_next from picturebutton within u_per_todt
end type
type pb_prev from picturebutton within u_per_todt
end type
type sle_date from singlelineedit within u_per_todt
end type
type pb_ddlb from picturebutton within u_per_todt
end type
type dw_cal from datawindow within u_per_todt
end type
end forward
