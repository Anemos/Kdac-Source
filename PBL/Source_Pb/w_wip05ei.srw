$PBExportHeader$w_wip05ei.srw
$PBExportComments$클레임현황조회(경리)
forward
global type w_wip05ei from w_origin_sheet04
end type
type tab_1 from tab within w_wip05ei
end type
...
type dw_report from datawindow within w_wip05ei
end type
...
type uo_status from w_origin_sheet04`uo_status within w_wip05ei
end type
