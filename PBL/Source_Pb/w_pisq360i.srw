$PBExportHeader$w_pisq360i.srw
$PBExportComments$제조월별 Warranty 불량유형 현황
forward
global type w_pisq360i from w_ipis_sheet01
end type
type uo_area from u_pisc_select_area within w_pisq360i
end type
type uo_division from u_pisc_select_division within w_pisq360i
end type
type gb_2 from groupbox within w_pisq360i
end type
type dw_pisq360i_01 from datawindow within w_pisq360i
end type
type st_3 from statictext within w_pisq360i
end type
type sle_itemcode from singlelineedit within w_pisq360i
end type
type sle_itemname from singlelineedit within w_pisq360i
end type
type uo_month from u_pisc_date_scroll_month within w_pisq360i
end type
type pb_serch from picturebutton within w_pisq360i
end type
type dw_print from datawindow within w_pisq360i
end type
type gb_3 from groupbox within w_pisq360i
end type
end forward
...
integer width = 4681
integer height = 2784
string title = "제조월별 Warranty 불량유형 현황"
uo_area uo_area
uo_division uo_division
gb_2 gb_2
dw_pisq360i_01 dw_pisq360i_01
st_3 st_3
...
on w_pisq360i.create
int iCurrent
call super::create
this.uo_area=create uo_area
this.uo_division=create uo_division
this.gb_2=create gb_2
this.dw_pisq360i_01=create dw_pisq360i_01
...
this.Control[iCurrent+4]=this.dw_pisq360i_01
...
on w_pisq360i.destroy
call super::destroy
destroy(this.uo_area)
destroy(this.uo_division)
destroy(this.gb_2)
destroy(this.dw_pisq360i_01)
destroy(this.st_3)
...
event ue_retrieve;
String	ls_areacode, ls_DivisionCode, ls_itemcode, ls_datefm, ls_dateto
...
// 데이타를 조회한다
//
dw_pisq360i_01.Retrieve(ls_areacode, ls_DivisionCode, ls_itemcode, ls_datefm, ls_dateto)
...
// 트랜잭션을 연결한다
//
dw_pisq360i_01.SetTransObject(SQLPIS)
...
dw_pisq360i_01.ShareData(dw_print)
...
lstr_prt.title			= "제조월별 Warranty 불량유형 현황"
...
type uo_status from w_ipis_sheet01`uo_status within w_pisq360i
integer x = 18
integer y = 2592
integer width = 3598
end type
...
boolean bringtotop = true
string title = "none"
string dataobject = "d_pisq360i_01"
...
boolean bringtotop = true
string title = "none"
string dataobject = "d_pisq360i_01_print"
boolean hscrollbar = true
boolean vscrollbar = true
boolean livescroll = true
borderstyle borderstyle = stylelowered!
