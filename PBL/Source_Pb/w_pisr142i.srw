$PBExportHeader$w_pisr142i.srw
$PBExportComments$입고간판조회
forward
global type w_pisr142i from w_ipis_sheet01
end type
type uo_division from u_pisc_select_division within w_pisr142i
end type
type uo_area from u_pisc_select_area within w_pisr142i
end type
type rb_1 from radiobutton within w_pisr142i
end type
type rb_2 from radiobutton within w_pisr142i
end type
type dw_2 from u_vi_std_datawindow within w_pisr142i
end type
type uo_fromdate from u_pisc_date_applydate within w_pisr142i
end type
type uo_todate from u_pisc_date_applydate_1 within w_pisr142i
end type
type st_2 from statictext within w_pisr142i
end type
type dw_condition from datawindow within w_pisr142i
end type
type dw_condition2 from datawindow within w_pisr142i
end type
type gb_3 from groupbox within w_pisr142i
end type
type gb_2 from groupbox within w_pisr142i
end type
type gb_4 from groupbox within w_pisr142i
end type
type gb_1 from groupbox within w_pisr142i
end type
type dw_print from datawindow within w_pisr142i
end type
end forward
...
IF rb_1.Checked THEN
	dw_2.DataObject = "d_pisr142i_01"
	dw_2.SetRedraw(False)
	dw_2.SetTransObject(sqlpis)
	dw_2.Retrieve( istr_partkb.areacode, istr_partkb.divcode, ls_suppCode, ls_itemCode, ls_productGroup, ls_FromDate)
	dw_2.SetRedraw(True)
ELSE
	dw_2.DataObject = "d_pisr142i_02"
	dw_2.SetRedraw(False)
	dw_2.SetTransObject(sqlpis)
...
//	End If
	dw_print.DataObject = "d_pisr142p_01"
...
type uo_status from w_ipis_sheet01`uo_status within w_pisr142i
end type
...
integer taborder = 11
boolean bringtotop = true
string dataobject = "d_pisr142i_01"
...
string title = "발주대기간판LIST 출력"
string dataobject = "d_pisr142p_01"
boolean hscrollbar = true
boolean vscrollbar = true
boolean livescroll = true
borderstyle borderstyle = stylelowered!
