$PBExportHeader$w_pisr150c.srw
$PBExportComments$개별간판 Active, Sleeping 전환(제품군)
forward
global type w_pisr150c from w_ipis_sheet01
end type
type rb_1 from radiobutton within w_pisr150c
end type
type rb_2 from radiobutton within w_pisr150c
end type
type dw_pisr150b_01 from datawindow within w_pisr150c
end type
type dw_pisr150b_02 from u_vi_std_datawindow within w_pisr150c
end type
type uo_area from u_pisc_select_area within w_pisr150c
end type
type uo_division from u_pisc_select_division within w_pisr150c
end type
type dw_scan from datawindow within w_pisr150c
end type
type cb_1 from commandbutton within w_pisr150c
end type
type cb_2 from commandbutton within w_pisr150c
end type
type gb_2 from groupbox within w_pisr150c
end type
type gb_3 from groupbox within w_pisr150c
end type
type gb_scan from groupbox within w_pisr150c
end type
type gb_1 from groupbox within w_pisr150c
end type
end forward
...
type uo_status from w_ipis_sheet01`uo_status within w_pisr150c
integer y = 1884
end type
