$PBExportHeader$w_origin_sheet01_per.srw
$PBExportComments$(조회, 입력, 저장, 삭제,  닫기, 상세조회, 화면인쇄, 특수문자)
forward
global type w_origin_sheet01_per from window
end type
type uo_status from uo_commonstatus_per within w_origin_sheet01_per
end type
end forward
...
global w_origin_sheet01_per w_origin_sheet01_per
...
forward prototypes
public subroutine wf_icon_onoff (boolean ag_retrieve, boolean ag_insert, boolean ag_save, boolean ag_delete, boolean ag_dretrieve, boolean ag_dprint, boolean ag_dchar)
end prototypes
...
public subroutine wf_icon_onoff (boolean ag_retrieve, boolean ag_insert, boolean ag_save, boolean ag_delete, boolean ag_dretrieve, boolean ag_dprint, boolean ag_dchar);//////////////////////////////////////////////////////////////////////////
//       wf_button(조회, 입력, 저장, 삭제, 상세조회, 화면인쇄, 특수문자)
...
on w_origin_sheet01_per.create
this.uo_status=create uo_status
this.Control[]={this.uo_status}
end on

on w_origin_sheet01_per.destroy
...
////////////////////////////////////////////////////////////////////////////////////////////
f_icon_set(true,  true,  true,  true,  false, false, false, false, false, false, &
