$PBExportHeader$w_origin_sheet09_per.srw
$PBExportComments$(조회, 입력, 저장, 삭제, 인쇄, 닫기, 상세조회, 화면인쇄, 자료생성, 특수문자)
forward
global type w_origin_sheet09_per from window
end type
type uo_status from uo_commonstatus_per within w_origin_sheet09_per
end type
end forward
...
global w_origin_sheet09_per w_origin_sheet09_per
...
on w_origin_sheet09_per.create
this.uo_status=create uo_status
this.Control[]={this.uo_status}
end on

on w_origin_sheet09_per.destroy
...
event timer;select	current time into :g_s_time from pbcommon.comm000 
using 		sqlca;
