$PBExportHeader$u_pisc_date_yesterday.sru
$PBExportComments$일자 선택 - 어제 - is_uo_date
forward
global type u_pisc_date_yesterday from userobject
end type
type st_name from statictext within u_pisc_date_yesterday
end type
type pb_next from picturebutton within u_pisc_date_yesterday
end type
type pb_prev from picturebutton within u_pisc_date_yesterday
end type
type sle_date from singlelineedit within u_pisc_date_yesterday
end type
type pb_ddlb from picturebutton within u_pisc_date_yesterday
end type
type dw_cal from datawindow within u_pisc_date_yesterday
end type
end forward
...
global u_pisc_date_yesterday u_pisc_date_yesterday
...
on u_pisc_date_yesterday.create
...
on u_pisc_date_yesterday.destroy
