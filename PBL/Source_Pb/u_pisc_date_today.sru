$PBExportHeader$u_pisc_date_today.sru
$PBExportComments$일자 선택 - 금일 - is_uo_date
forward
global type u_pisc_date_today from userobject
end type
type st_name from statictext within u_pisc_date_today
end type
type pb_next from picturebutton within u_pisc_date_today
end type
type pb_prev from picturebutton within u_pisc_date_today
end type
type sle_date from singlelineedit within u_pisc_date_today
end type
type pb_ddlb from picturebutton within u_pisc_date_today
end type
type dw_cal from datawindow within u_pisc_date_today
end type
end forward
...
global u_pisc_date_today u_pisc_date_today
...
BringToTop = True
id_uo_date = Date(f_pisc_get_date_nowtime())
