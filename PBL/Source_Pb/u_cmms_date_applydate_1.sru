$PBExportHeader$u_cmms_date_applydate_1.sru
$PBExportComments$일자 선택 - 시스템 기준일 - is_uo_date
forward
global type u_cmms_date_applydate_1 from userobject
end type
type pb_next from picturebutton within u_cmms_date_applydate_1
end type
type pb_prev from picturebutton within u_cmms_date_applydate_1
end type
type sle_date from singlelineedit within u_cmms_date_applydate_1
end type
type pb_ddlb from picturebutton within u_cmms_date_applydate_1
end type
type dw_cal from datawindow within u_cmms_date_applydate_1
end type
end forward
...
global u_cmms_date_applydate_1 u_cmms_date_applydate_1
...
on u_cmms_date_applydate_1.create
...
on u_cmms_date_applydate_1.destroy
...
BringToTop = True
id_uo_date = Date(f_cmms_get_date_applydate("%", "%", f_cmms_sysdate()))
