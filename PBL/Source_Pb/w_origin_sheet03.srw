$PBExportHeader$w_origin_sheet03.srw
$PBExportComments$(조회, 입력, 저장, 삭제,미리보기, 닫기, 상세조회, 화면인쇄, 특수문자)
forward
global type w_origin_sheet03 from window
end type
type uo_status from uo_commonstatus within w_origin_sheet03
end type
end forward
...
global w_origin_sheet03 w_origin_sheet03

type variables
// Icon의 Enabled 상태
boolean i_b_retrieve,  i_b_insert,  i_b_save,  i_b_delete
boolean i_b_preview,  i_b_dretrieve, i_b_dprint, i_b_dchar
...
forward prototypes
public subroutine wf_icon_onoff (boolean ag_retrieve, boolean ag_insert, boolean ag_save, boolean ag_delete, boolean ag_preview, boolean ag_dretrieve, boolean ag_dprint, boolean ag_dchar)
end prototypes
...
public subroutine wf_icon_onoff (boolean ag_retrieve, boolean ag_insert, boolean ag_save, boolean ag_delete, boolean ag_preview, boolean ag_dretrieve, boolean ag_dprint, boolean ag_dchar);///////////////////////////////////////////////////////////////////////////////////////////
//       wf_button(조회, 입력, 저장, 삭제, 미리보기, 상세조회, 화면인쇄, 특수문자)
...
////////////////////////////////////////////////////////////////////////////////////////////
f_icon_set(true,  true,  true,  true,  true, false, false, false, false, true, &
