$PBExportHeader$w_bom_find_empno.srw
$PBExportComments$사원정보 가져오기
forward
global type w_bom_find_empno from window
end type
type dw_find from u_vi_std_datawindow within w_bom_find_empno
end type
type pb_find from picturebutton within w_bom_find_empno
end type
type rb_supp from radiobutton within w_bom_find_empno
end type
type rb_line from radiobutton within w_bom_find_empno
end type
type sle_1 from singlelineedit within w_bom_find_empno
end type
type cb_2 from commandbutton within w_bom_find_empno
end type
type cb_enter from commandbutton within w_bom_find_empno
end type
type gb_1 from groupbox within w_bom_find_empno
end type
type gb_2 from groupbox within w_bom_find_empno
end type
end forward
...
global w_bom_find_empno w_bom_find_empno

type variables

end variables

on w_bom_find_empno.create
