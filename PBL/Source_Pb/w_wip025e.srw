$PBExportHeader$w_wip025e.srw
$PBExportComments$재공이체현황(공제전)
forward
global type w_wip025e from w_origin_sheet04
end type
type dw_1 from datawindow within w_wip025e
end type
type dw_2 from datawindow within w_wip025e
end type
type dw_3 from datawindow within w_wip025e
end type
type pb_1 from picturebutton within w_wip025e
end type
type gb_1 from groupbox within w_wip025e
end type
end forward
...
if i_s_iocd = '1' then
	l_n_rowcnt = dw_1.retrieve(g_s_company, ls_plant, ls_dvsn, i_s_iocd, &
			ls_cur_year, ls_cur_month, ls_post_year, ls_post_month)
...
type uo_status from w_origin_sheet04`uo_status within w_wip025e
end type
...
string dataobject = "d_wip025e_linelist"
...
boolean bringtotop = true
string title = "none"
string dataobject = "d_wip025e_linerpt"
boolean livescroll = true
borderstyle borderstyle = stylelowered!
end type
...
if ls_colname = 'wip001_waiocd' then
	if data = '1' then
		dw_1.dataobject = 'd_wip025e_linelist'
		dw_1.settransobject(sqlca)
		dw_2.dataobject = 'd_wip025e_linerpt'
		dw_2.settransobject(sqlca)
	elseif data = '2' then
		dw_1.dataobject = 'd_wip025e_vndlist'
		dw_1.settransobject(sqlca)
		dw_2.dataobject = 'd_wip025e_vndrpt'
		dw_2.settransobject(sqlca) 
	else
		dw_1.dataobject = 'd_wip025e_stklist'
		dw_1.settransobject(sqlca)
		dw_2.dataobject = 'd_wip025e_stkrpt'
		dw_2.settransobject(sqlca)
	end if
end if
end event
