$PBExportHeader$w_pisr030b_bk.srw
$PBExportComments$Work Calendar(지역,공장별)
forward
global type w_pisr030b_bk from w_ipis_sheet01
end type
type uo_area from u_pisc_select_area within w_pisr030b_bk
end type
type uo_division from u_pisc_select_division within w_pisr030b_bk
end type
type uo_product from u_pisc_select_productgroup within w_pisr030b_bk
end type
type uo_month from u_pisc_date_scroll_month within w_pisr030b_bk
end type
type dw_pisr030b_01 from datawindow within w_pisr030b_bk
end type
type gb_1 from groupbox within w_pisr030b_bk
end type
type gb_2 from groupbox within w_pisr030b_bk
end type
end forward
...
global w_pisr030b_bk w_pisr030b_bk

type variables
boolean ib_cal_change, ib_open
end variables

on w_pisr030b_bk.create
int iCurrent
call super::create
...
event ue_postopen;call super::ue_postopen;dw_pisr030b_01.SetTransObject(SQLPIS)
...
type uo_status from w_ipis_sheet01`uo_status within w_pisr030b_bk
end type
