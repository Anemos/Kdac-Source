$PBExportHeader$w_bom201t.srw
$PBExportComments$M-BOM 조회(월별_견적)
forward
global type w_bom201t from w_origin_sheet02
end type
type pb_excel from picturebutton within w_bom201t
end type
type uo_1 from uo_plandiv_pdcd within w_bom201t
end type
type st_1 from statictext within w_bom201t
end type
type uo_date from uo_ccyymm_mps within w_bom201t
end type
type st_2 from statictext within w_bom201t
end type
type sle_1 from singlelineedit within w_bom201t
end type
type pb_1 from picturebutton within w_bom201t
end type
type dw_bom_print from datawindow within w_bom201t
end type
type tab_1 from tab within w_bom201t
end type
...
type st_4 from statictext within w_bom201t
end type
type rb_pre from radiobutton within w_bom201t
end type
type rb_post from radiobutton within w_bom201t
end type
type gb_1 from groupbox within w_bom201t
end type
end forward
...
string  ls_plant,ls_div,ls_pdcd,ls_itno,ls_rtncd,ls_yyyymm,ls_srce,ls_applygubun
...
if tab_1.selectedtab = 1 then
	...
	if tab_1.tabpage_1.dw_bom.retrieve(ls_yyyymm,ls_plant,ls_div,ls_pdcd,ls_itno,ls_applygubun) < 1 then
		...
		uo_status.st_message.text = f_message("I010") + " 조회수: " + string(tab_1.tabpage_1.dw_bom.rowcount())
...
type uo_status from w_origin_sheet02`uo_status within w_bom201t
integer y = 2468
end type
...
integer taborder = 50
boolean bringtotop = true
string dataobject = "d_bom201t_print"
...
integer height = 1936
integer taborder = 80
string dataobject = "d_bom201t_retrieve"
...
integer height = 1812
integer taborder = 90
string dataobject = "d_bom201t_knockdown"
boolean hscrollbar = true
boolean vscrollbar = true
boolean hsplitscroll = true
boolean livescroll = true
