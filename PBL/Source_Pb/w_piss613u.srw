$PBExportHeader$w_piss613u.srw
$PBExportComments$Mixed Shipping Label
forward
global type w_piss613u from w_ipis_sheet01
end type
type gb_4 from groupbox within w_piss613u
end type
type uo_area from u_pisc_select_area within w_piss613u
end type
type uo_division from u_pisc_select_division within w_piss613u
end type
...
type st_3 from statictext within w_piss613u
end type
type dw_3 from datawindow within w_piss613u
end type
type dw_4 from datawindow within w_piss613u
end type
type gb_3 from groupbox within w_piss613u
end type
type gb_2 from groupbox within w_piss613u
end type
type dw_5 from datawindow within w_piss613u
end type
type st_2 from statictext within w_piss613u
end type
type em_1 from editmask within w_piss613u
end type
type em_4 from editmask within w_piss613u
end type
type st_4 from statictext within w_piss613u
end type
type em_3 from editmask within w_piss613u
end type
...
for i = 1 to li_rowcount
	if dw_3.getitemstring(i, 'instcheck') <> 'Y' then
		...
		if li_selectcount = 1 then
			...
			if dw_3.getitemstring(i, 'customeritemcode') <> ls_customeritemcode then
				ls_errcheck = 'Y'
			end if
		end if
	end if
...
if li_selectcount = li_rowcount then
	return -1
end if
...
int		li_row, li_selectedcount, li_currentprintcount, li_currentserial,&
			...
			li_containerrowcount, li_invoicecount
...
For li_selectedcount = 1 To ll_rowcount
	   if dw_2.isselected(li_selectedcount) <> true then
		...
		ls_countryoforigin		=	dw_5.getitemstring(1,'countryoforigin')
		ls_customerdivision		=	dw_5.getitemstring(1,'customerdivision')
		ls_customerplantaddress	=	dw_5.getitemstring(1,'customerplantaddress')
		ls_customerplantcity		=	dw_5.getitemstring(1,'customerplantcity')
		ls_customerstate			=	dw_5.getitemstring(1,'customerstate')
		ls_customerpostal			=	dw_5.getitemstring(1,'customerpostal')		
		ls_segment1					=	dw_5.getitemstring(1,'segment1')
		ls_segment2					=	dw_5.getitemstring(1,'segment2')
		...
		for li_currentserial = 1	to dw_2.getitemnumber(li_selectedcount, 'labelcount')
		 	...
		 	for li_currentprintcount = 1 to ag_printcount
				...
				dw_print.setitem(li_row,'customerdivision',		ls_customerdivision)
				dw_print.setitem(li_row,'customerplantaddress',	ls_customerplantaddress)
				dw_print.setitem(li_row,'customerplantcity',		ls_customerplantcity)
				dw_print.setitem(li_row,'customerstate',			ls_customerstate)
				dw_print.setitem(li_row,'customerpostal',			ls_customerpostal)
...
this.Control[iCurrent+7]=this.uo_customer
...
this.Control[iCurrent+16]=this.em_4
...
type uo_status from w_ipis_sheet01`uo_status within w_piss613u
end type
...
boolean bringtotop = true
string title = "none"
string dataobject = "d_piss613u_06p"
...
integer taborder = 0
boolean bringtotop = true
string dataobject = "d_piss613u_02"
boolean hscrollbar = true
boolean vscrollbar = true
boolean hsplitscroll = true
end type
...
boolean bringtotop = true
string title = "none"
string dataobject = "d_piss613u_04"
boolean livescroll = true
borderstyle borderstyle = stylelowered!
end type
...
integer taborder = 40
string title = "none"
string dataobject = "d_piss613u_05"
boolean livescroll = true
borderstyle borderstyle = stylelowered!
end type
