$PBExportHeader$w_piss270u.srw
$PBExportComments$출고전표취소
forward
global type w_piss270u from w_ipis_sheet01
end type
type dw_sheet from u_vi_std_datawindow within w_piss270u
end type
type uo_area from u_pisc_select_area within w_piss270u
end type
type uo_division from u_pisc_select_division within w_piss270u
end type
type uo_date from u_pisc_date_applydate within w_piss270u
end type
type st_2 from statictext within w_piss270u
end type
type sle_truckno from singlelineedit within w_piss270u
end type
type dw_2 from datawindow within w_piss270u
end type
type dw_save from datawindow within w_piss270u
end type
type dw_kbno_create from datawindow within w_piss270u
end type
type dw_print from datawindow within w_piss270u
end type
type dw_3 from datawindow within w_piss270u
end type
type dw_4 from datawindow within w_piss270u
end type
type gb_1 from groupbox within w_piss270u
end type
end forward
...
type uo_status from w_ipis_sheet01`uo_status within w_piss270u
end type
