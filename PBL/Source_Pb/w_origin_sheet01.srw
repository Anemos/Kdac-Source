$PBExportHeader$w_origin_sheet01.srw
$PBExportComments$(조회, 입력, 저장, 삭제,  닫기, 상세조회, 화면인쇄, 특수문자)
forward
global type w_origin_sheet01 from window
end type
type uo_status from uo_commonstatus within w_origin_sheet01
end type
end forward
...
global w_origin_sheet01 w_origin_sheet01
