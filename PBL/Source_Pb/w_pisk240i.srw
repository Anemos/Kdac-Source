$PBExportHeader$w_pisk240i.srw
$PBExportComments$월별생산추이(라인별)
forward
global type w_pisk240i from w_ipis_sheet01
end type
type dw_1 from u_vi_std_datawindow within w_pisk240i
end type
type uo_area from u_pisc_select_area within w_pisk240i
end type
type uo_division from u_pisc_select_division within w_pisk240i
end type
type uo_workcenter from u_pisc_select_workcenter within w_pisk240i
end type
type uo_line from u_pisc_select_line within w_pisk240i
end type
type dw_detail from datawindow within w_pisk240i
end type
type st_h_bar from uo_xc_splitbar within w_pisk240i
end type
type gb_1 from groupbox within w_pisk240i
end type
type gb_2 from groupbox within w_pisk240i
end type
type uo_year from u_pisc_date_scroll_year within w_pisk240i
end type
type dw_print from datawindow within w_pisk240i
end type
type gb_3 from groupbox within w_pisk240i
end type
end forward
...
global w_pisk240i w_pisk240i

type variables
Boolean	ib_open
end variables

on w_pisk240i.create
int iCurrent
call super::create
...
Else
	...
	MessageBox("월별 생산추이(라인별)", "월별 생산추이 정보가 존재하지 않습니다")
End If
...
lstr_prt.title			= '월별생산추이(라인별)'
lstr_prt.tag			= '월별생산추이(라인별)'
lstr_prt.dwsyntax		= ls_mod
OpenSheetWithParm(w_prt, lstr_prt, w_frame, 0, Layered!)

end event

type uo_status from w_ipis_sheet01`uo_status within w_pisk240i
end type
...
string dataobject = "d_pisk240i_01"
...
event rowfocuschanged;String	ls_prdyear, ls_areacode, ls_divisioncode, ls_workcenter, ls_linecode, &
...
boolean bringtotop = true
string title = "none"
string dataobject = "d_pisk240i_02"
boolean hscrollbar = true
boolean vscrollbar = true
...
string title = "none"
string dataobject = "d_pisk240i_01_print"
boolean hscrollbar = true
boolean vscrollbar = true
