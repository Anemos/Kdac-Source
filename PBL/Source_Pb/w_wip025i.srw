$PBExportHeader$w_wip025i.srw
$PBExportComments$재공수불 현황(공제전)
forward
global type w_wip025i from w_origin_sheet04
end type
type dw_1 from datawindow within w_wip025i
end type
type dw_2 from datawindow within w_wip025i
end type
type dw_3 from datawindow within w_wip025i
end type
type pb_1 from picturebutton within w_wip025i
end type
type gb_1 from groupbox within w_wip025i
end type
end forward
...
if i_s_iocd = '1' then
	dw_1.dataobject = 'd_wip025i_linelist'
	dw_1.settransobject(sqlca)
...
elseif i_s_iocd = '2' then
	if f_spacechk(ls_vndr) = -1 then
		dw_1.dataobject = 'd_wip025i_vndlist'
		dw_1.settransobject(sqlca)
		l_n_rowcnt = dw_1.retrieve(g_s_company, ls_plant, ls_dvsn, i_s_iocd, i_s_fromdt, i_s_todt, i_s_adddt)
	else
		ls_orct   = dw_3.getitemstring(1,"wip001_waorct")
		dw_1.dataobject = 'd_wip025i_vndlist_each'
		dw_1.settransobject(sqlca)
		l_n_rowcnt = dw_1.retrieve(g_s_company, ls_plant, ls_dvsn, ls_orct, i_s_iocd, i_s_fromdt, i_s_todt, i_s_adddt)
	end if
	
   dw_2.dataobject = 'd_wip025i_vndrpt'
	dw_2.settransobject(sqlca) 
else
	dw_1.dataobject = 'd_wip025i_stklist'
	dw_1.settransobject(sqlca)
...
type uo_status from w_origin_sheet04`uo_status within w_wip025i
end type
...
boolean bringtotop = true
string title = "none"
string dataobject = "d_wip025i_01"
