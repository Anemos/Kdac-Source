$PBExportHeader$w_pisr100b.srw
$PBExportComments$입고간판처리/삭제
forward
global type w_pisr100b from w_ipis_sheet01
end type
type uo_area from u_pisc_select_area within w_pisr100b
end type
type uo_division from u_pisc_select_division within w_pisr100b
end type
type dw_2 from datawindow within w_pisr100b
end type
type dw_3 from u_vi_std_datawindow within w_pisr100b
end type
type dw_summary from datawindow within w_pisr100b
end type
type rb_1 from radiobutton within w_pisr100b
end type
type rb_2 from radiobutton within w_pisr100b
end type
type gb_3 from groupbox within w_pisr100b
end type
type dw_scan from datawindow within w_pisr100b
end type
type pb_1 from picturebutton within w_pisr100b
end type
type pb_2 from picturebutton within w_pisr100b
end type
type gb_2 from groupbox within w_pisr100b
end type
type gb_scan from groupbox within w_pisr100b
end type
type gb_4 from groupbox within w_pisr100b
end type
end forward
...
type uo_status from w_ipis_sheet01`uo_status within w_pisr100b
end type
