$PBExportHeader$w_pisr090b.srw
$PBExportComments$입고동시발주간판처리/발주삭제
forward
global type w_pisr090b from w_ipis_sheet01
end type
type uo_area from u_pisc_select_area within w_pisr090b
end type
type uo_division from u_pisc_select_division within w_pisr090b
end type
type dw_pisr090b_01 from datawindow within w_pisr090b
end type
type dw_pisr090b_02 from u_vi_std_datawindow within w_pisr090b
end type
type dw_scan from datawindow within w_pisr090b
end type
type dw_summary from datawindow within w_pisr090b
end type
type dw_lastedit from datawindow within w_pisr090b
end type
type rb_1 from radiobutton within w_pisr090b
end type
type rb_2 from radiobutton within w_pisr090b
end type
type pb_1 from picturebutton within w_pisr090b
end type
type dw_orderseq from datawindow within w_pisr090b
end type
type pb_2 from picturebutton within w_pisr090b
end type
type gb_3 from groupbox within w_pisr090b
end type
type gb_2 from groupbox within w_pisr090b
end type
type gb_scan from groupbox within w_pisr090b
end type
type gb_4 from groupbox within w_pisr090b
end type
end forward
...
type uo_status from w_ipis_sheet01`uo_status within w_pisr090b
end type
...
If f_pisr_ordercalc(dw_pisr090b_01, idt_nowtime, is_jobdate, is_applydate, ls_message) = -1 Then 
