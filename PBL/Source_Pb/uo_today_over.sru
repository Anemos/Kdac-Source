$PBExportHeader$uo_today_over.sru
$PBExportComments$To_Date Calendar sle, pb, dw (ø¿¥√¿Ã»ƒ≥Ø¬• º±≈√ ∞°¥…)  ------------ ªÁøÎ
forward
global type uo_today_over from userobject
end type
type pb_next from picturebutton within uo_today_over
end type
type pb_prev from picturebutton within uo_today_over
end type
type sle_date from singlelineedit within uo_today_over
end type
type pb_ddlb from picturebutton within uo_today_over
end type
type dw_cal from datawindow within uo_today_over
end type
end forward

global type uo_today_over from userobject
string tag = "uo_today_over"
integer width = 421
integer height = 84
...
global uo_today_over uo_today_over
