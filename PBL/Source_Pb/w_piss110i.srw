$PBExportHeader$w_piss110i.srw
$PBExportComments$SR보기
forward
global type w_piss110i from window
end type
type dw_print from datawindow within w_piss110i
end type
type dw_srview from datawindow within w_piss110i
end type
type cb_3 from commandbutton within w_piss110i
end type
type cb_2 from commandbutton within w_piss110i
end type
type cb_1 from commandbutton within w_piss110i
end type
type em_1 from editmask within w_piss110i
end type
type gb_1 from groupbox within w_piss110i
end type
type gb_2 from groupbox within w_piss110i
end type
end forward
...
integer taborder = 40
string title = "none"
string dataobject = "d_piss110i_02"
