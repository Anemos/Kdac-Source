$PBExportHeader$w_piss191i.srw
$PBExportComments$입고/출하/재고현황
forward
global type w_piss191i from w_ipis_sheet01
end type
type dw_sheet from u_vi_std_datawindow within w_piss191i
end type
type uo_area from u_pisc_select_area within w_piss191i
end type
type uo_division from u_pisc_select_division within w_piss191i
end type
type dw_print from datawindow within w_piss191i
end type
type uo_productgroup from u_pisc_select_productgroup within w_piss191i
end type
type ddlb_1 from dropdownlistbox within w_piss191i
end type
type st_2 from statictext within w_piss191i
end type
type st_3 from statictext within w_piss191i
end type
type em_1 from editmask within w_piss191i
end type
type uo_1 from u_pisc_date_applydate_1 within w_piss191i
end type
type uo_date from u_pisc_date_firstday within w_piss191i
end type
type gb_1 from groupbox within w_piss191i
end type
end forward
...
global w_piss191i w_piss191i

type variables
string is_shipdate1,is_shipdate2,is_areacode,is_divisioncode,is_productgroup,is_modelgroup,is_itemtype,is_itemcode
string is_custgubun,is_custcode,is_shipoemgubun
boolean ib_open
end variables

on w_piss191i.create
int iCurrent
call super::create
...
ll_rowcount =  dw_sheet.retrieve(is_areacode,is_divisioncode,is_shipdate1,is_shipdate2,is_productgroup,is_itemtype,ls_itemcode)
...
lstr_prt.dwsyntax = "t_area.Text = '" + uo_area.is_uo_areaName + &
                    "' t_division.text = '" + uo_division.is_uo_divisionName + & 
						  "' t_date.text = '" + is_shipdate1 + " ~~ " + is_shipdate2 + "'" 
...
type uo_status from w_ipis_sheet01`uo_status within w_piss191i
end type
...
string dataobject = "d_piss191i_01"
...
boolean bringtotop = true
string title = "none"
string dataobject = "d_piss191i_02"
boolean minbox = true
...
string item[] = {"전체","원재료","상품","반제품","완제품","기타"}
borderstyle borderstyle = stylelowered!
end type
