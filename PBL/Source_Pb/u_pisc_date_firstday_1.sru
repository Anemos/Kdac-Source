$PBExportHeader$u_pisc_date_firstday_1.sru
$PBExportComments$일자 선택 - 매달 첫째일 - is_uo_date
forward
global type u_pisc_date_firstday_1 from userobject
end type
type pb_next from picturebutton within u_pisc_date_firstday_1
end type
type pb_prev from picturebutton within u_pisc_date_firstday_1
end type
type sle_date from singlelineedit within u_pisc_date_firstday_1
end type
type pb_ddlb from picturebutton within u_pisc_date_firstday_1
end type
type dw_cal from datawindow within u_pisc_date_firstday_1
end type
end forward
...
global u_pisc_date_firstday_1 u_pisc_date_firstday_1
...
on u_pisc_date_firstday_1.create
...
on u_pisc_date_firstday_1.destroy
