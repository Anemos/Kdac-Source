$PBExportHeader$u_per_applydate_to.sru
$PBExportComments$일자 선택 - 시스템 기준일 - is_uo_date
forward
global type u_per_applydate_to from userobject
end type
type pb_next from picturebutton within u_per_applydate_to
end type
type pb_prev from picturebutton within u_per_applydate_to
end type
type sle_date from singlelineedit within u_per_applydate_to
end type
type pb_ddlb from picturebutton within u_per_applydate_to
end type
type dw_cal from datawindow within u_per_applydate_to
end type
end forward
...
global u_per_applydate_to u_per_applydate_to
...
BringToTop = True
id_uo_date = Date(string(g_s_date,'@@@@-@@-@@'))
