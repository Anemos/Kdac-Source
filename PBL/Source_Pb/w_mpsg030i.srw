...
/*######################################################################
#####		재작업지시서정보 체크 - 											 #####
##### 1. stype, srno에 대한 WorkCenter에 진행중인 공순이 있어야 한다.
######################################################################*/

// Tool명, Part 명 셋팅, 공정순서 가져오기
...
// 2006.04.12	간판 초기화에 대한 대응 
// OrderNo, PartNo에 대한 WorkCenter에 진행중인 공순
...
// 재작업지시 여부체크 
// 'A':정상, 'B':불량, 'C':긴급(PartNo:'001000'), 공순자동부여.
...
/*######################################################################
#####		작업지시서정보 체크 - 											    #####
##### 1. OrderNo, PartNo에 대한 WorkCenter에 진행중인 공순이 있어야 한다.
##### 2. 해당 OrderNo는 제작완료상태가 아니어야 한다.
######################################################################*/
...
dw_title.setitem(1, "title_name", "작업지시및실적현황")
