$PBExportHeader$w_wip068i.srw
$PBExportComments$기간별 품목별 재공금액 다운로드
forward
global type w_wip068i from w_origin_sheet04
end type
type dw_1 from datawindow within w_wip068i
end type
type dw_3 from datawindow within w_wip068i
end type
type pb_1 from picturebutton within w_wip068i
end type
type gb_1 from groupbox within w_wip068i
end type
end forward
...
integer width = 4773
integer height = 3000
string title = "일간재공 기간별 재공다운로드"
dw_1 dw_1
dw_3 dw_3
pb_1 pb_1
gb_1 gb_1
end type
global w_wip068i w_wip068i
...
dw_3.setitem(1,"wip001_wainptdt",f_relativedate(g_s_date,-31))
dw_3.setitem(1,"wip001_waupdtdt",f_relativedate(g_s_date,-1))
...
dw_1.settransobject(sqlca)
l_n_rowcnt = dw_1.retrieve(g_s_company, ls_plant, ls_dvsn, i_s_iocd, ls_pdcd, i_s_fromdt, i_s_todt)
...
type uo_status from w_origin_sheet04`uo_status within w_wip068i
end type
...
string dataobject = "d_wip068i_02"
...
boolean bringtotop = true
string title = "none"
string dataobject = "d_wip068i_01"
