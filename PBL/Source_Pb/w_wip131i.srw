$PBExportHeader$w_wip131i.srw
$PBExportComments$재공수불 현황(유상사급)
forward
global type w_wip131i from w_origin_sheet04
end type
type dw_1 from datawindow within w_wip131i
end type
type dw_2 from datawindow within w_wip131i
end type
type dw_3 from datawindow within w_wip131i
end type
type pb_1 from picturebutton within w_wip131i
end type
type gb_1 from groupbox within w_wip131i
end type
end forward
...
dw_3.insertrow(0)
dw_3.setitem(1,"wip001_waiocd",'3')
...
type uo_status from w_origin_sheet04`uo_status within w_wip131i
end type
...
string dataobject = "d_wip131i_vndlist"
...
boolean bringtotop = true
string title = "none"
string dataobject = "d_wip131i_01"
