$PBExportHeader$w_pisk010i.srw
$PBExportComments$간판 번호 List
forward
global type w_pisk010i from w_ipis_sheet01
end type
type dw_1 from u_vi_std_datawindow within w_pisk010i
end type
type uo_area from u_pisc_select_area within w_pisk010i
end type
type uo_division from u_pisc_select_division within w_pisk010i
end type
type uo_workcenter from u_pisc_select_workcenter within w_pisk010i
end type
type uo_line from u_pisc_select_line within w_pisk010i
end type
type dw_detail from datawindow within w_pisk010i
end type
type st_h_bar from uo_xc_splitbar within w_pisk010i
end type
type uo_item from u_pisc_select_item_kb_line within w_pisk010i
end type
type gb_1 from groupbox within w_pisk010i
end type
type gb_2 from groupbox within w_pisk010i
end type
type gb_4 from groupbox within w_pisk010i
end type
end forward
...
global w_pisk010i w_pisk010i

type variables
Boolean	ib_open
end variables

on w_pisk010i.create
int iCurrent
call super::create
...
type uo_status from w_ipis_sheet01`uo_status within w_pisk010i
end type
...
string dataobject = "d_pisk010i_01"
...
boolean bringtotop = true
string title = "none"
string dataobject = "d_pisk010i_02"
boolean hscrollbar = true
boolean vscrollbar = true
boolean hsplitscroll = true
