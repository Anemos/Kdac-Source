$PBExportHeader$u_piss_date_yeoju.sru
$PBExportComments$일자 선택 - 금일 - is_uo_date
forward
global type u_piss_date_yeoju from userobject
end type
type pb_next from picturebutton within u_piss_date_yeoju
end type
type pb_prev from picturebutton within u_piss_date_yeoju
end type
type sle_date from singlelineedit within u_piss_date_yeoju
end type
type pb_ddlb from picturebutton within u_piss_date_yeoju
end type
type dw_cal from datawindow within u_piss_date_yeoju
end type
end forward
...
global u_piss_date_yeoju u_piss_date_yeoju
