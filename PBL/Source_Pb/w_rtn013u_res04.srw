$PBExportHeader$w_rtn013u_res04.srw
$PBExportComments$품번대체라인 Copy 기능[결재]
forward
global type w_rtn013u_res04 from window
end type
type dw_1 from datawindow within w_rtn013u_res04
end type
type sle_line from singlelineedit within w_rtn013u_res04
end type
type st_2 from statictext within w_rtn013u_res04
end type
type st_1 from statictext within w_rtn013u_res04
end type
type p_1 from picture within w_rtn013u_res04
end type
type cb_2 from commandbutton within w_rtn013u_res04
end type
type cb_1 from commandbutton within w_rtn013u_res04
end type
type sle_1 from singlelineedit within w_rtn013u_res04
end type
type gb_1 from groupbox within w_rtn013u_res04
end type
type gb_2 from groupbox within w_rtn013u_res04
end type
end forward
...
global w_rtn013u_res04 w_rtn013u_res04
...
sle_line.text = lstr_parm.string_arg[5] + '-' + lstr_parm.string_arg[6]
...
dw_1.GetChild('rcline1', ldwc)
ldwc.settransobject(sqlca)
ldwc.retrieve(lstr_parm.string_arg[1], lstr_parm.string_arg[2], lstr_parm.string_arg[3])
if ldwc.RowCount() < 1 then
	ldwc.InsertRow(0)
end if

dw_1.setitem( 1, "rcline1", lstr_parm.string_arg[5] + '-' + lstr_parm.string_arg[6])

f_pisc_set_dddw_width(dw_1,'rcline1',ldwc,'displayname',10)
...
integer taborder = 10
string title = "none"
string dataobject = "d_rtn013u_res04_01"
...
string l_s_postline, l_s_postline1, l_s_postline2, l_s_line, l_s_line1, l_s_line2
long   l_n_sqlcount
...
l_s_line = sle_line.text
l_s_line1 = mid(l_s_line,1,pos(l_s_line,"-",1) - 1)
l_s_line2 = mid(l_s_line,pos(l_s_line,"-",1) + 1,1)
...
l_s_postline = dw_1.getitemstring(1,"rcline1")
l_s_postline1 = mid(l_s_postline,1,pos(l_s_postline,"-",1) - 1)
l_s_postline2 = mid(l_s_postline,pos(l_s_postline,"-",1) + 1,1)
...
select rdcmcd,rdplant,rddvsn,:l_s_pcitn,:l_s_postline1,:l_s_postline2,rdopno,rdnvmo,rdmcno,rdterm,
	rdmctm,rdlbtm,rdremk,'A',:g_s_empno,'',:g_s_ipaddr,:g_s_date,:g_s_date 
from pbrtn.rtn014 
where  rdcmcd  = :l_s_cmcd  and rdplant = :l_s_plant and rddvsn = :l_s_div and rditno = :l_s_pitno and
