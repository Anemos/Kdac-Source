$PBExportHeader$w_wip038e.srw
$PBExportComments$재공이체현황(공제분)
forward
global type w_wip038e from w_origin_sheet04
end type
type dw_1 from datawindow within w_wip038e
end type
type dw_2 from datawindow within w_wip038e
end type
type dw_3 from datawindow within w_wip038e
end type
type pb_1 from picturebutton within w_wip038e
end type
type gb_1 from groupbox within w_wip038e
end type
end forward

global type w_wip038e from w_origin_sheet04
string title = "재공이체현황(공제분)"
dw_1 dw_1
dw_2 dw_2
dw_3 dw_3
pb_1 pb_1
...
type uo_status from w_origin_sheet04`uo_status within w_wip038e
end type
...
string dataobject = "d_wip038e_linelist"
...
boolean bringtotop = true
string title = "none"
string dataobject = "d_wip038e_linerpt"
boolean livescroll = true
borderstyle borderstyle = stylelowered!
end type
...
if ls_colname = 'wip001_waiocd' then
	if data = '1' then
		dw_1.dataobject = 'd_wip038e_linelist'
		dw_1.settransobject(sqlca)
		dw_2.dataobject = 'd_wip038e_linerpt'
		dw_2.settransobject(sqlca)
	elseif data = '2' then
		dw_1.dataobject = 'd_wip038e_vndlist'
		dw_1.settransobject(sqlca)
		dw_2.dataobject = 'd_wip038e_vndrpt'
		dw_2.settransobject(sqlca) 
	else
		dw_1.dataobject = 'd_wip038e_stklist'
		dw_1.settransobject(sqlca)
		dw_2.dataobject = 'd_wip038e_stkrpt'
		dw_2.settransobject(sqlca)
	end if
end if
end event
