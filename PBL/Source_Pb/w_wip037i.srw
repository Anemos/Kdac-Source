$PBExportHeader$w_wip037i.srw
$PBExportComments$재공수불총괄표(공제후)
forward
global type w_wip037i from w_origin_sheet04
end type
type dw_2 from datawindow within w_wip037i
end type
type dw_4 from datawindow within w_wip037i
end type
type pb_1 from picturebutton within w_wip037i
end type
type dw_report from datawindow within w_wip037i
end type
type dw_exch_rpt from datawindow within w_wip037i
end type
type gb_1 from groupbox within w_wip037i
end type
end forward
...
string i_s_fromdt, i_s_todt, i_s_postdate
end variables
...
public subroutine wf_exch_set_usat9 (datastore arg_ds)
end prototypes
...
for i = 1 to l_n_rowcnt
    l_s_pdcd    = ds_exch_stock.getitemstring(i,"prodcd")   
	 ...
	 l_n_dsbgat  = ds_exch_stock.getitemnumber(i,"bgat")
...
choose case i_s_ioindex
	case '1'
		...
		lds_01.dataobject = 'd_wip037i_exchange_dvsn'
		lds_01.settransobject(sqlca)
		dw_2.dataobject = 'd_wip037i_exchange_dvsn'
		dw_2.settransobject(sqlca)
		dw_exch_rpt.dataobject = 'd_wip037i_exchange_dvsnrpt'
		dw_exch_rpt.settransobject(sqlca)
		
		lds_01.retrieve(g_s_company, arg_plant, arg_dvsn, i_s_fromdt, i_s_postdate)
				
		ds_exch_stock.retrieve(g_s_company, arg_plant, arg_dvsn, i_s_fromdt, i_s_postdate)
		wf_exch_add_stock(lds_01)
		wf_exch_dvsn_onhand(lds_01)
		wf_exch_set_usat9(lds_01)
   ...
   case '2'
		lds_01 = create datastore
		lds_01.dataobject = 'd_wip037i_exchange_line_vendor'
		lds_01.settransobject(sqlca)
		dw_2.dataobject = 'd_wip037i_exchange_line_vendor'
		dw_2.settransobject(sqlca)
		dw_exch_rpt.dataobject = 'd_wip037i_exchange_line_vendorrpt'
		dw_exch_rpt.settransobject(sqlca)
		
		lds_01.retrieve(g_s_company, arg_plant, arg_dvsn, '1',i_s_fromdt, i_s_postdate)
	...
	case '3'
      ...
      dw_exch_rpt.dataobject = 'd_wip037i_exchange_line_vendorrpt'
		...
		lds_01.retrieve(g_s_company, arg_plant, arg_dvsn, '2', i_s_fromdt, i_s_postdate)
  ...
  case '4'
		lds_01 = create datastore
		lds_01.dataobject = 'd_wip037i_exchange_stock'
		lds_01.settransobject(sqlca)
		dw_2.dataobject = 'd_wip037i_exchange_stock'
		dw_2.settransobject(sqlca)
		dw_exch_rpt.dataobject = 'd_wip037i_exchange_stockrpt'
		dw_exch_rpt.settransobject(sqlca)
...
dec{0} l_n_dsbgat, l_n_dsinat, l_n_dsusat3, l_n_dsusat4, l_n_dsusat5, l_n_dsusat6, l_n_dsusat7, l_n_dsusat8, l_n_dsusat9
dec{0} l_n_dwbgat, l_n_dwinat, l_n_dwusat3, l_n_dwusat4, l_n_dwusat6, l_n_dwusatex, l_n_dwusatex1, l_n_dwusatrtn, l_n_dwusat7
dec{0} l_n_dwusat8, l_n_dwusat9, l_n_dwohat, l_n_dsohat
long   ll_rowcnt02
...
//	 l_n_dsinat  = ds_stock.getitemdecimal(i,"inat")
    ...
    l_n_dsusat4 = ds_stock.getitemdecimal(i,"usat4")
	 ...
	 l_n_dsohat  = ds_stock.getitemdecimal(i,"ohat")
	 l_n_findrow = arg_ds.find("prodcd = '" + l_s_pdcd +"'",l_n_startrow,ll_rowcnt02)
		 if l_n_findrow > 0 then
		 l_n_dwbgat    = arg_ds.getitemdecimal(l_n_findrow,"bgat")
       l_n_dwinat    = arg_ds.getitemdecimal(l_n_findrow,"inat")
...
dec{0} l_n_bgat, l_n_inat, l_n_usat1, l_n_usat2, l_n_usat3, l_n_usat4, l_n_usat5, l_n_usat6, l_n_usat7, l_n_usat8, l_n_usat9, l_n_usatex, l_n_usatex1, l_n_usatrtn, l_n_usata, l_n_ohat
...
for i = 1 to l_n_rowcnt
	 ...
	 l_n_ohat	= arg_ds.getitemdecimal(i,"ohat")
	 l_n_comusat9 = l_n_combgat + l_n_cominat - (l_n_comusat1 + l_n_comusat2 + l_n_comusat3 + &
	 		l_n_comusat4 + l_n_comusat5 + l_n_comusat6 + l_n_comusat7 + l_n_comusat8 + &
			l_n_comusatex + l_n_comusatex1 + l_n_comusatrtn + l_n_comusata + l_n_ohat )
	 arg_ds.setitem(i,"usat9", l_n_comusat9)
...
for ll_cnt = 1 to 16
	...
	choose case i_s_ioindex
		case '1'
			lds_01.reset()
			lds_01.retrieve(g_s_company, ls_plant, ls_dvsn, i_s_fromdt, i_s_postdate)
		
			ds_exch_stock.retrieve(g_s_company, ls_plant, ls_dvsn, i_s_fromdt, i_s_postdate)
			wf_exch_add_stock(lds_01)
			wf_exch_dvsn_onhand(lds_01)
			wf_exch_set_usat9(lds_01)
		...
		case '2'
			lds_01.reset()
			lds_01.retrieve(g_s_company, ls_plant, ls_dvsn, '1', i_s_fromdt, i_s_postdate)
		...
		case '3'
			lds_01.reset()
			lds_01.retrieve(g_s_company, ls_plant, ls_dvsn, '2', i_s_fromdt, i_s_postdate)
...
choose case i_s_ioindex
	case '1'
		lds_01 = create datastore
		lds_01.dataobject = 'd_wip037i_dvsn'
		lds_01.settransobject(sqlca)
		dw_2.dataobject = 'd_wip037i_dvsn'
		dw_2.settransobject(sqlca)
		dw_report.dataobject = 'd_wip037i_dvsnrpt'
		dw_report.settransobject(sqlca)
		
		lds_01.retrieve(g_s_company, arg_plant, arg_dvsn, i_s_fromdt, i_s_fromdt, i_s_postdate)
	   	
		ds_stock.retrieve(g_s_company, arg_plant, arg_dvsn, i_s_fromdt, i_s_fromdt, i_s_postdate)
   	wf_add_stock_amount(lds_01)
   
//		ds_dvsn.retrieve(g_s_company, arg_plant, arg_dvsn, i_s_todt, i_s_fromdt, i_s_fromdt)
//      wf_set_dvsn_onhand_amount(lds_01)
//   	ds_stock.retrieve(g_s_company, arg_plant, arg_dvsn, i_s_todt, i_s_fromdt, i_s_fromdt)
//      wf_set_stock_onhand_amount(lds_01)
   ...
   case '2'
		lds_01 = create datastore
		lds_01.dataobject = 'd_wip037i_line_vendor'
		lds_01.settransobject(sqlca)
		dw_2.dataobject = 'd_wip037i_line_vendor'
		dw_2.settransobject(sqlca)
		dw_report.dataobject = 'd_wip037i_line_vendorrpt'
		dw_report.settransobject(sqlca)
		lds_01.retrieve(g_s_company, arg_plant, arg_dvsn, '1', i_s_fromdt, i_s_fromdt, i_s_postdate)

//		ds_linevendor.retrieve(g_s_company, arg_plant, arg_dvsn, '1', i_s_todt, i_s_fromdt, i_s_fromdt)
//      wf_set_linevendor_onhand_amount(lds_01)
	...
	case '3'
      ...
      dw_report.dataobject = 'd_wip037i_line_vendorrpt'
		dw_report.settransobject(sqlca)
	   lds_01.retrieve(g_s_company, arg_plant, arg_dvsn, '2', i_s_fromdt, i_s_fromdt, i_s_postdate)

//		ds_linevendor.retrieve(g_s_company, arg_plant, arg_dvsn, '2', i_s_todt, i_s_fromdt, i_s_fromdt)
//      wf_set_linevendor_onhand_amount(lds_01)
  ...
  case '4'
		lds_01 = create datastore
		lds_01.dataobject = 'd_wip037i_stock'
		lds_01.settransobject(sqlca)
		dw_2.dataobject = 'd_wip037i_stock'
		dw_2.settransobject(sqlca)
		dw_report.dataobject = 'd_wip037i_stockrpt'
		dw_report.settransobject(sqlca)
		lds_01.retrieve(g_s_company, arg_plant, arg_dvsn, i_s_fromdt, i_s_fromdt, i_s_postdate)
	...
	case 'D'
		for ll_cnt = 1 to 5
			...
			choose case i_s_ioindex
				case '1'
					lds_01.reset()
					lds_01.retrieve(g_s_company, ls_plant, ls_dvsn, i_s_fromdt, i_s_fromdt, i_s_postdate)
						
					ds_stock.retrieve(g_s_company, ls_plant, ls_dvsn, i_s_fromdt, i_s_fromdt, i_s_postdate)
					wf_add_stock_amount(lds_01)
				
//					ds_dvsn.retrieve(g_s_company, ls_plant, ls_dvsn, i_s_todt, i_s_fromdt, i_s_fromdt)
//					wf_set_dvsn_onhand_amount(lds_01)
//					ds_stock.retrieve(g_s_company, ls_plant, ls_dvsn, i_s_todt, i_s_fromdt, i_s_fromdt)
//					wf_set_stock_onhand_amount(lds_01)
				...
				case '2'
					lds_01.reset()
					lds_01.retrieve(g_s_company, ls_plant, ls_dvsn, '1', i_s_fromdt, i_s_fromdt, i_s_postdate)
	
//					ds_linevendor.retrieve(g_s_company, ls_plant, ls_dvsn, '1', i_s_todt, i_s_fromdt, i_s_fromdt)
//					wf_set_linevendor_onhand_amount(lds_01)
				...
				case '3'
					lds_01.reset()
					lds_01.retrieve(g_s_company, ls_plant, ls_dvsn, '2', i_s_fromdt, i_s_fromdt, i_s_postdate)
//					ds_linevendor.retrieve(g_s_company, ls_plant, ls_dvsn, '2', i_s_todt, i_s_fromdt, i_s_fromdt)
//					wf_set_linevendor_onhand_amount(lds_01)
...
public subroutine wf_exch_set_usat9 (datastore arg_ds);integer l_n_rowcnt, i

l_n_rowcnt = arg_ds.RowCount()
for i = 1 to l_n_rowcnt
	 arg_ds.setitem(i,"usat9", arg_ds.getitemdecimal(i,"bgat") + arg_ds.getitemdecimal(i,"inat") &
	 		- ( arg_ds.getitemdecimal(i,"usat1") + arg_ds.getitemdecimal(i,"usat2") + &
			 	 arg_ds.getitemdecimal(i,"usat3") + arg_ds.getitemdecimal(i,"usat4") + &
				 arg_ds.getitemdecimal(i,"usat5") + arg_ds.getitemdecimal(i,"usat6") + &
				 arg_ds.getitemdecimal(i,"usat7") + arg_ds.getitemdecimal(i,"usatex") + &
				 arg_ds.getitemdecimal(i,"usatex1") + arg_ds.getitemdecimal(i,"usatrtn") + &	 
				 arg_ds.getitemdecimal(i,"usat8") + &
				 arg_ds.getitemdecimal(i,"usata") + arg_ds.getitemdecimal(i,"ohat") ) )
next
end subroutine
...
i_s_todt = uf_wip_addmonth(i_s_fromdt,1)
i_s_postdate = uf_wip_addmonth(i_s_fromdt,-1)
...
type uo_status from w_origin_sheet04`uo_status within w_wip037i
end type
...
string title = "none"
string dataobject = "d_wip037i_dvsn"
...
boolean bringtotop = true
string title = "none"
string dataobject = "d_wip037i_01"
