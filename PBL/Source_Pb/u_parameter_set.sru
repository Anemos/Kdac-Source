$PBExportHeader$u_parameter_set.sru
$PBExportComments$Interface Parameter Setting
forward
global type u_parameter_set from userobject
end type
type dw_2 from datawindow within u_parameter_set
end type
type cb_save from commandbutton within u_parameter_set
end type
type dw_1 from datawindow within u_parameter_set
end type
type gb_1 from groupbox within u_parameter_set
end type
end forward
...
global u_parameter_set u_parameter_set
...
integer height = 520
integer taborder = 10
string dataobject = "d_interface_parameter"
