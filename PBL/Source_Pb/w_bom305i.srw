$PBExportHeader$w_bom305i.srw
$PBExportComments$BOM 월간정보조회 윈도우(가공관리비)
forward
global type w_bom305i from w_origin_sheet02
end type
type tab_1 from tab within w_bom305i
end type
...
type st_3 from statictext within w_bom305i
end type
type dw_cost_report from datawindow within w_bom305i
end type
type dw_ind_list from datawindow within w_bom305i
end type
type st_4 from statictext within w_bom305i
end type
type ddlb_dvd from dropdownlistbox within w_bom305i
end type
type uo_1 from uo_plandiv_pdcd within w_bom305i
end type
type uo_2 from uo_ccyymm_mps within w_bom305i
end type
type pb_down from picturebutton within w_bom305i
end type
end forward
...
if ln_write_cnt = 0 then
	...
	for i = 1 to ln_write_cnt
		...
		ls_plant = trim(tab_1.tabpage_2.dw_2.object.BOM109_fplant[i])
		ls_dvsn = trim(tab_1.tabpage_2.dw_2.object.BOM109_fdvsn[i])
...
choose case in_tab_index
	...
	case 2
		...
		SELECT count(*)  
    		INTO :ln_sqlcount  
    	FROM "PBPDM"."BOM109"  
   	WHERE	( "PBPDM"."BOM109"."FCMCD" = :g_s_company ) AND  
         	( "PBPDM"."BOM109"."FDATE" = :is_yearmonth ) AND 
				( "PBPDM"."BOM109"."FGUBUN" = :ls_comseccd ) AND
         	( "PBPDM"."BOM109"."FPLANT" like :is_plant ) AND  
         	( "PBPDM"."BOM109"."FDVSN" like :is_dvsn ) AND
				( "PBPDM"."BOM109"."FPDCD" like :is_pdcd) 
      using sqlca;
...
if in_tab_index 	= 1 then
	...
	for li_cntnum 	= 1 to li_rowcnt
		...
		dw_cost_report.setitem(li_currow,"plant",tab_1.tabpage_2.dw_2.object.BOM109_fplant[li_cntnum])
		dw_cost_report.setitem(li_currow,"dvsn",tab_1.tabpage_2.dw_2.object.BOM109_fdvsn[li_cntnum])
		dw_cost_report.setitem(li_currow,"pdcd",tab_1.tabpage_2.dw_2.object.BOM109_fpdcd[li_cntnum])
...
type uo_status from w_origin_sheet02`uo_status within w_bom305i
end type
...
integer taborder = 50
string title = "none"
string dataobject = "d_bom001_305i_01"
...
is_itno 		= tab_1.tabpage_1.dw_1.object.BOM109_fmdno[row]
...
integer height = 2176
integer taborder = 60
string dataobject = "d_bom001_305i_02"
boolean hscrollbar = true
boolean vscrollbar = true
boolean hsplitscroll = true
boolean livescroll = true
...
boolean bringtotop = true
string title = "none"
string dataobject = "d_bom001_305i_03"
boolean hscrollbar = true
boolean vscrollbar = true
boolean hsplitscroll = true
boolean livescroll = true
...
integer taborder = 50
boolean bringtotop = true
string dataobject = "d_305i_report_costlist_all"
boolean livescroll = true
borderstyle borderstyle = stylelowered!
end type
...
boolean bringtotop = true
string title = "none"
string dataobject = "d_305i_report_indcost"
boolean livescroll = true
borderstyle borderstyle = stylelowered!
end type
