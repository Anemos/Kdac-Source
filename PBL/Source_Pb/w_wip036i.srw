$PBExportHeader$w_wip036i.srw
$PBExportComments$재공수불총괄표(공제분)
forward
global type w_wip036i from w_origin_sheet04
end type
type dw_2 from datawindow within w_wip036i
end type
type dw_4 from datawindow within w_wip036i
end type
type pb_1 from picturebutton within w_wip036i
end type
type dw_report from datawindow within w_wip036i
end type
type dw_exch_rpt from datawindow within w_wip036i
end type
type gb_1 from groupbox within w_wip036i
end type
end forward
...
choose case i_s_ioindex
	case '1'
		...
		lds_01.dataobject = 'd_wip036i_exchange_dvsn'
		lds_01.settransobject(sqlca)
		dw_2.dataobject = 'd_wip036i_exchange_dvsn'
		dw_2.settransobject(sqlca)
		dw_exch_rpt.dataobject = 'd_wip036i_exchange_dvsnrpt'
   ...
   case '2'
		lds_01 = create datastore
		lds_01.dataobject = 'd_wip036i_exchange_line_vendor'
		lds_01.settransobject(sqlca)
		dw_2.dataobject = 'd_wip036i_exchange_line_vendor'
		dw_2.settransobject(sqlca)
		dw_exch_rpt.dataobject = 'd_wip036i_exchange_line_vendorrpt'
		dw_exch_rpt.settransobject(sqlca)
  ...
  case '4'
		lds_01 = create datastore
		lds_01.dataobject = 'd_wip036i_exchange_stock'
		lds_01.settransobject(sqlca)
		dw_2.dataobject = 'd_wip036i_exchange_stock'
		dw_2.settransobject(sqlca)
		dw_exch_rpt.dataobject = 'd_wip036i_exchange_stockrpt'
		dw_exch_rpt.settransobject(sqlca)
...
choose case i_s_ioindex
	case '1'
		lds_01 = create datastore
		lds_01.dataobject = 'd_wip036i_dvsn'
		lds_01.settransobject(sqlca)
		dw_2.dataobject = 'd_wip036i_dvsn'
		dw_2.settransobject(sqlca)
		dw_report.dataobject = 'd_wip036i_dvsnrpt'
...
//      wf_set_stock_onhand_amount(lds_01)
   ...
   case '2'
		lds_01 = create datastore
		lds_01.dataobject = 'd_wip036i_line_vendor'
		lds_01.settransobject(sqlca)
		dw_2.dataobject = 'd_wip036i_line_vendor'
		dw_2.settransobject(sqlca)
		dw_report.dataobject = 'd_wip036i_line_vendorrpt'
		dw_report.settransobject(sqlca)
...
//      wf_set_linevendor_onhand_amount(lds_01)
  ...
  case '4'
		lds_01 = create datastore
		lds_01.dataobject = 'd_wip036i_stock'
		lds_01.settransobject(sqlca)
		dw_2.dataobject = 'd_wip036i_stock'
		dw_2.settransobject(sqlca)
		dw_report.dataobject = 'd_wip036i_stockrpt'
		dw_report.settransobject(sqlca)
		lds_01.retrieve(g_s_company, arg_plant, arg_dvsn, i_s_fromdt, i_s_fromdt, i_s_postdate)
...
type uo_status from w_origin_sheet04`uo_status within w_wip036i
end type
...
string title = "none"
string dataobject = "d_wip036i_dvsn"
...
boolean bringtotop = true
string title = "none"
string dataobject = "d_wip036i_01"
