$PBExportHeader$w_origin_sheet02.srw
$PBExportComments$(조회, 입력, 저장, 삭제, 인쇄, 처음, 이전, 다음, 끝, 닫기, 상세조회, 화면인쇄, 특수문자)
forward
global type w_origin_sheet02 from window
end type
type uo_status from uo_commonstatus within w_origin_sheet02
end type
end forward
...
event ue_prev pbm_custom07
event ue_next pbm_custom08
event ue_last pbm_custom09
event ue_dretrieve pbm_custom16
event ue_dprint pbm_custom17
uo_status uo_status
end type
global w_origin_sheet02 w_origin_sheet02

type variables
// Icon의 Enabled 상태
boolean i_b_retrieve,  i_b_insert,  i_b_save,  i_b_print
boolean i_b_first, i_b_prev, i_b_next, i_b_last, i_b_delete
...
forward prototypes
public subroutine wf_icon_onoff (boolean ag_retrieve, boolean ag_insert, boolean ag_save, boolean ag_delete, boolean ag_print, boolean ag_first, boolean ag_prev, boolean ag_next, boolean ag_last, boolean ag_dretrieve, boolean ag_dprint, boolean ag_dchar)
end prototypes
...
event ue_first;this.uo_status.st_message.text = ""
end event

event ue_prev;this.uo_status.st_message.text = ""
end event

event ue_next;this.uo_status.st_message.text = ""
end event

event ue_last;this.uo_status.st_message.text = ""
end event
...
////////////////////////////////////////////////////////////////////////////////////////////
f_icon_set(true,  true,  true,  true,  true,  true,  true,  true,  true,  false, &
