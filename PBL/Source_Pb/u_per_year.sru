$PBExportHeader$u_per_year.sru
$PBExportComments$일자 선택 - 년선택 - 스크롤 사용 - is_uo_year
forward
global type u_per_year from u_vi_cst_basic
end type
type st_1 from statictext within u_per_year
end type
type em_date from editmask within u_per_year
end type
type vsb_1 from vscrollbar within u_per_year
end type
end forward
