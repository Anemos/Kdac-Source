$PBExportHeader$u_per_month.sru
$PBExportComments$일자 선택 - 월선택 - 스크롤 사용 - is_uo_month
forward
global type u_per_month from u_vi_cst_basic
end type
type st_1 from statictext within u_per_month
end type
type em_date from editmask within u_per_month
end type
type vsb_1 from vscrollbar within u_per_month
end type
end forward
...
global u_per_month u_per_month
