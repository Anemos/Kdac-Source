$PBExportHeader$u_per_frdt.sru
$PBExportComments$일자 선택 - 시스템 기준일 - is_uo_date
forward
global type u_per_frdt from userobject
end type
type st_name from statictext within u_per_frdt
end type
type pb_next from picturebutton within u_per_frdt
end type
type pb_prev from picturebutton within u_per_frdt
end type
type sle_date from singlelineedit within u_per_frdt
end type
type pb_ddlb from picturebutton within u_per_frdt
end type
type dw_cal from datawindow within u_per_frdt
end type
end forward
