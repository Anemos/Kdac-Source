$PBExportHeader$w_tmm211i.srw
$PBExportComments$의뢰서완료현황(의뢰자용)
forward
global type w_tmm211i from w_ipis_sheet01
end type
type dw_tmm211i_02 from datawindow within w_tmm211i
end type
type dw_report from datawindow within w_tmm211i
end type
type uo_startdate from u_tmm_date_applydate within w_tmm211i
end type
type uo_enddate from u_tmm_date_applydate_1 within w_tmm211i
end type
type st_2 from statictext within w_tmm211i
end type
type st_3 from statictext within w_tmm211i
end type
type sle_dept from singlelineedit within w_tmm211i
end type
type pb_finddept from picturebutton within w_tmm211i
end type
type uo_tmgubun from u_tmm_select_tmgubun within w_tmm211i
end type
type st_1 from statictext within w_tmm211i
end type
type sle_orderno from singlelineedit within w_tmm211i
end type
type dw_tmm211i_01 from u_vi_std_datawindow within w_tmm211i
end type
type gb_1 from groupbox within w_tmm211i
end type
end forward
...
dw_tmm211i_01 dw_tmm211i_01
gb_1 gb_1
end type
global w_tmm211i w_tmm211i
...
int iCurrent
call super::create
this.dw_tmm211i_02=create dw_tmm211i_02
...
this.dw_tmm211i_01=create dw_tmm211i_01
this.gb_1=create gb_1
iCurrent=UpperBound(this.Control)
this.Control[iCurrent+1]=this.dw_tmm211i_02
...
this.Control[iCurrent+12]=this.dw_tmm211i_01
this.Control[iCurrent+13]=this.gb_1
end on

on w_tmm211i.destroy
call super::destroy
destroy(this.dw_tmm211i_02)
...
dw_tmm211i_01.Width = newwidth 	- ( ls_gap * 4 )
dw_tmm211i_01.Height= ( newheight * 3 / 6 ) - dw_tmm211i_01.y

dw_tmm211i_02.x = dw_tmm211i_01.x
dw_tmm211i_02.y = dw_tmm211i_01.y + dw_tmm211i_01.Height + ls_split
dw_tmm211i_02.Width = dw_tmm211i_01.Width
dw_tmm211i_02.Height = newheight - ( dw_tmm211i_01.y + dw_tmm211i_01.Height + ls_split + ls_status)


end event

event ue_postopen;call super::ue_postopen;datawindowchild ldwc
dw_tmm211i_01.SetTransObject(sqlca)
dw_tmm211i_02.SetTransObject(sqlca)
dw_report.settransobject(sqlca)

dw_tmm211i_01.GetChild('ingstatus', ldwc)
...
f_pisc_set_dddw_width(dw_tmm211i_01,'ingstatus',ldwc,'codename',5)
end event
...
ll_rowcnt = dw_tmm211i_01.retrieve(ls_startdate, ls_enddate, ls_orderno, ls_orderdept, ls_tmgubun)
...
dw_tmm211i_01.accepttext()
if dw_tmm211i_01.modifiedcount() < 1 then
...
if dw_tmm211i_01.update() = 1 then
	Commit using sqlca;
	sqlca.AutoCommit = True
	
	This.Triggerevent("ue_retrieve")
	li_findrow = dw_tmm211i_01.find("orderno = '" + ls_orderno + "'", 1, dw_tmm211i_01.rowcount())
	if li_findrow > 0 then
		dw_tmm211i_01.Post Event RowFocusChanged(li_findrow)
		dw_tmm211i_01.scrolltorow(li_findrow)
		dw_tmm211i_01.setrow(li_findrow)
	end if
...
type uo_status from w_ipis_sheet01`uo_status within w_tmm211i
end type
...
string dataobject = "d_tmm211i_02"
...
integer taborder = 11
boolean bringtotop = true
string dataobject = "d_tmm211i_01"
...
dw_tmm211i_02.GetChild('toolid', ldwc)
ldwc.settransobject(sqlca)
...
f_pisc_set_dddw_width(dw_tmm211i_02,'toolid',ldwc,'codename',5)

dw_tmm211i_02.retrieve(ls_orderno)
end event
