$PBExportHeader$u_mpms_dw_today.sru
forward
global type u_mpms_dw_today from userobject
end type
type pb_next from picturebutton within u_mpms_dw_today
end type
type pb_prev from picturebutton within u_mpms_dw_today
end type
type dw_cal from datawindow within u_mpms_dw_today
end type
type pb_ddlb from picturebutton within u_mpms_dw_today
end type
type sle_date from singlelineedit within u_mpms_dw_today
end type
end forward
...
global u_mpms_dw_today u_mpms_dw_today
