$PBExportHeader$w_pistest.srw
$PBExportComments$생관SR확정
forward
global type w_pistest from w_ipis_sheet01
end type
type gb_4 from groupbox within w_pistest
end type
type dw_sheet from u_vi_std_datawindow within w_pistest
end type
type uo_division from u_pisc_select_division within w_pistest
end type
type uo_area from u_pisc_select_area within w_pistest
end type
type dw_2 from u_vi_std_datawindow within w_pistest
end type
type st_v_bar from uo_xc_splitbar within w_pistest
end type
type rb_1 from radiobutton within w_pistest
end type
type rb_2 from radiobutton within w_pistest
end type
type rb_3 from radiobutton within w_pistest
end type
type gb_2 from groupbox within w_pistest
end type
type gb_3 from groupbox within w_pistest
end type
type gb_1 from groupbox within w_pistest
end type
type sle_custcode from singlelineedit within w_pistest
end type
end forward
...
type uo_status from w_ipis_sheet01`uo_status within w_pistest
end type
...
string dataobject = "d_piss460u_01_test"
...
integer taborder = 30
boolean bringtotop = true
string dataobject = "d_piss460u_02_test"
boolean hscrollbar = true
boolean vscrollbar = true
boolean hsplitscroll = true
end type
...
rb_3.checked = false
dw_sheet.dataobject = 'd_piss460u_01_test'
//dw_print.dataobject = 'd_piss460u_03'
dw_2.dataobject = 'd_piss460u_02_test'
...
dw_sheet.dataobject = 'd_piss420u_01_test'
