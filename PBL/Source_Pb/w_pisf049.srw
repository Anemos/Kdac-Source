$PBExportHeader$w_pisf049.srw
$PBExportComments$예방정비 계획대비실적
forward
global type w_pisf049 from w_cmms_sheet01
end type
type em_2 from editmask within w_pisf049
end type
type cb_2 from commandbutton within w_pisf049
end type
type cb_1 from commandbutton within w_pisf049
end type
type em_1 from editmask within w_pisf049
end type
type st_2 from statictext within w_pisf049
end type
type st_1 from statictext within w_pisf049
end type
type dw_1 from uo_datawindow within w_pisf049
end type
type uo_area from u_cmms_select_area within w_pisf049
end type
type uo_division from u_cmms_select_division within w_pisf049
end type
type pb_1 from picturebutton within w_pisf049
end type
type gb_1 from groupbox within w_pisf049
end type
end forward
...
type uo_status from w_cmms_sheet01`uo_status within w_pisf049
end type
...
integer height = 1392
integer taborder = 10
string dataobject = "d_task_result"
