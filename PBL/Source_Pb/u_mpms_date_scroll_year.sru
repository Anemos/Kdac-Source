$PBExportHeader$u_mpms_date_scroll_year.sru
$PBExportComments$일자 선택 - 년선택 - 스크롤 사용 - is_uo_year
forward
global type u_mpms_date_scroll_year from u_vi_cst_basic
end type
type st_1 from statictext within u_mpms_date_scroll_year
end type
type em_date from editmask within u_mpms_date_scroll_year
end type
type vsb_1 from vscrollbar within u_mpms_date_scroll_year
end type
end forward
...
global u_mpms_date_scroll_year u_mpms_date_scroll_year
...
on u_mpms_date_scroll_year.create
int iCurrent
call super::create
...
on u_mpms_date_scroll_year.destroy
call super::destroy
destroy(this.st_1)
