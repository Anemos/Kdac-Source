$PBExportHeader$u_pisc_date_tomorrow.sru
$PBExportComments$일자 선택 - 내일 - is_uo_date
forward
global type u_pisc_date_tomorrow from userobject
end type
type st_name from statictext within u_pisc_date_tomorrow
end type
type pb_next from picturebutton within u_pisc_date_tomorrow
end type
type pb_prev from picturebutton within u_pisc_date_tomorrow
end type
type sle_date from singlelineedit within u_pisc_date_tomorrow
end type
type pb_ddlb from picturebutton within u_pisc_date_tomorrow
end type
type dw_cal from datawindow within u_pisc_date_tomorrow
end type
end forward
...
global u_pisc_date_tomorrow u_pisc_date_tomorrow
...
on u_pisc_date_tomorrow.create
...
on u_pisc_date_tomorrow.destroy
