$PBExportHeader$w_wip073i.srw
$PBExportComments$유상사급 실사현황관리(경리)
forward
global type w_wip073i from w_origin_sheet02
end type
type uo_1 from uo_wip_plandiv within w_wip073i
end type
type uo_to from uo_yymm_boongi within w_wip073i
end type
type st_1 from statictext within w_wip073i
end type
type dw_wip05fu_01 from datawindow within w_wip073i
end type
type cb_confirm from commandbutton within w_wip073i
end type
type cb_cancel from commandbutton within w_wip073i
end type
type st_2 from statictext within w_wip073i
end type
type pb_down from picturebutton within w_wip073i
end type
type rb_free from radiobutton within w_wip073i
end type
type rb_cost from radiobutton within w_wip073i
end type
type gb_1 from groupbox within w_wip073i
end type
type gb_2 from groupbox within w_wip073i
end type
end forward
...
type uo_status from w_origin_sheet02`uo_status within w_wip073i
end type
...
boolean bringtotop = true
string title = "none"
string dataobject = "d_wip073i_01"
...
long textcolor = 128
long backcolor = 12632256
string text = "경리확정은 전지역, 전업체가 입력확정상태여야 합니다. 확정취소는 선택된 업체만 입력확정상태로 바뀝니다."
boolean focusrectangle = false
end type
