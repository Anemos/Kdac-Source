...
//**** ProcessRatio Check
//* 입력된 데이타와 해당공순에 대한 진행율합은 100보다 같거나 적어야 한다.
...
event open;STRING	ls_kbno, ls_orderno, ls_partno	// 간판번호
STRING	ls_message, ls_stype, ls_srno    // 선택된 실적데이타
