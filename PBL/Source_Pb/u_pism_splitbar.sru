$PBExportHeader$u_pism_splitbar.sru
$PBExportComments$Splitbar
forward
global type u_pism_splitbar from statictext
end type
end forward
...
global u_pism_splitbar u_pism_splitbar
...
on u_pism_splitbar.create
end on

on u_pism_splitbar.destroy
end on
