$PBExportHeader$w_bpm402u.srw
$PBExportComments$M-BOM Update
forward
global type w_bpm402u from w_origin_sheet01
end type
type tv_1 from treeview within w_bpm402u
end type
type st_3 from statictext within w_bpm402u
end type
type sle_1 from singlelineedit within w_bpm402u
end type
type cb_1 from commandbutton within w_bpm402u
end type
type cb_2 from commandbutton within w_bpm402u
end type
type cb_5 from commandbutton within w_bpm402u
end type
type cb_3 from commandbutton within w_bpm402u
end type
type cb_4 from commandbutton within w_bpm402u
end type
type dw_edit from datawindow within w_bpm402u
end type
type rb_1 from radiobutton within w_bpm402u
end type
type rb_2 from radiobutton within w_bpm402u
end type
type cb_6 from commandbutton within w_bpm402u
end type
type cb_7 from commandbutton within w_bpm402u
end type
type pb_1 from picturebutton within w_bpm402u
end type
type gb_1 from groupbox within w_bpm402u
end type
type gb_2 from groupbox within w_bpm402u
end type
type gb_framemove from groupbox within w_bpm402u
end type
type dw_2 from datawindow within w_bpm402u
end type
type dw_3 from datawindow within w_bpm402u
end type
type uo_1 from uo_plandiv_pdcd within w_bpm402u
end type
type uo_year from uo_ccyy_mps within w_bpm402u
end type
type st_1 from statictext within w_bpm402u
end type
type cb_stop from commandbutton within w_bpm402u
end type
type cb_go from commandbutton within w_bpm402u
end type
type cb_8 from commandbutton within w_bpm402u
end type
type uo_2 from u_bpm_select_arev within w_bpm402u
end type
type gb_3 from groupbox within w_bpm402u
end type
end forward
...
event ue_postopen();long l_n_root, l_n_rows
integer l_n_cnt
...
if f_bpm_check_ingflag(i_s_applyyear,i_s_revno,'w_bpm402u') = 'C' then
	...
	WHERE COMLTD = :g_s_company AND XYEAR = :i_s_applyyear AND 
			REVNO = :i_s_revno AND WINDOWID = 'w_bpm402u'
	using sqlca;
	...
	if f_bpm_check_jobemp(i_s_applyyear,i_s_revno,'w_bpm402u',g_s_empno) <> -1 then	
		if ls_taskstatus = 'C' then
			cb_stop.enabled = False
			cb_go.enabled = True
		else
...
if rb_2.checked = true then
	...
	l_n_rows = ids_data2[l_n_level].retrieve(i_s_applyyear,i_s_revno,l_s_plant,l_s_div,l_tvi_current.data, i_s_applydate)
	if l_n_rows > 0 then
...
if rb_1.checked = true then	
	...
	l_n_rows = ids_data1[l_n_level].retrieve(i_s_applyyear,i_s_revno,l_s_plant,l_s_div,l_tvi_current.data, i_s_applydate)
   if l_n_rows > 0 then
     	wf_add_items(ag_handle,l_n_level,l_n_rows,ag_tvcurrent)
   end if
end if
...
//   DELETE FROM "PBBPM"."BPM505"
		WHERE "PBBPM"."BPM505"."OCMCD" = '01' AND
				...
				"PBBPM"."BPM505"."OPITN"= :a_second_itno  
//				and	
//				( "PBBPM"."BPM505"."OEDTE" =  '' OR "PBBPM"."BPM505"."OEDTE" >= :a_to_date )
		using sqlca;
		...
		UPDATE "PBBPM"."BPM505"
				SET "OEDTE"= :i_s_enddate, "OCHCD" = :a_update_code 
//	DELETE FROM "PBBPM"."BPM505"	
		WHERE "PBBPM"."BPM505"."OCMCD" = '01' AND
				"PBBPM"."BPM505"."XYEAR" = :i_s_applyyear AND
				"PBBPM"."BPM505"."REVNO" = :i_s_revno AND
				"PBBPM"."BPM505"."OPLANT" = :a_plant AND
				"PBBPM"."BPM505"."ODVSN" = :a_div AND	
				"PBBPM"."BPM505"."OFITN" = :a_second_itno
//				and
//				( "PBBPM"."BPM505"."OEDTE" = '' OR "PBBPM"."BPM505"."OEDTE" >= :a_to_date )
		using sqlca;
	if sqlca.sqlcode <> 0 then
...
//			"PBBPM"."BPM505"."OPLANT" = :a_plant AND
//			"PBBPM"."BPM505"."ODVSN" = :a_div AND	
//			"PBBPM"."BPM505"."OPITN" = :a_first_itno and
//			"PBBPM"."BPM505"."OFITN" = :a_second_itno  
//	using sqlca;
	UPDATE "PBBPM"."BPM505"
...
if rb_1.checked = true then
	if f_spacechk(sle_1.text) = -1 and ag_level = 1  then
      ...
      l_s_citno = string(ids_data1[ag_level].object.pcitn[ag_row],"@@@@@@@@@@@@")
		l_s_clsbsrce = f_bpm_get_balance(i_s_applyyear,i_s_revno,l_s_plant,l_s_div, l_s_citno)
...
if rb_2.checked = true then
	SELECT count(*) INTO :l_n_check FROM "PBBPM"."BPM504" 
   	WHERE "PBBPM"."BPM504"."PCMCD" = '01' AND
				"PBBPM"."BPM504"."XYEAR" = :i_s_applyyear AND
				"PBBPM"."BPM504"."REVNO" = :i_s_revno AND
				"PBBPM"."BPM504"."PLANT" = :l_s_plant AND
				"PBBPM"."BPM504"."PCITN" = :l_s_citno AND
				"PBBPM"."BPM504"."PDVSN" = :l_s_div  AND  
         	(( "PBBPM"."BPM504"."PEDTE" = '' ) OR  
         	( "PBBPM"."BPM504"."PEDTE" <> '' AND  
         	"PBBPM"."BPM504"."PEDTE" >= :i_s_enddate AND  "PBBPM"."BPM504"."PEDTE" >= "PBBPM"."BPM504"."PEDTM"))   
		using sqlca;
else
   SELECT count(*) INTO :l_n_check FROM "PBBPM"."BPM504" 
   	WHERE "PBBPM"."BPM504"."PCMCD" = '01' AND
				...
				"PBBPM"."BPM504"."REVNO" = :i_s_revno AND
				"PBBPM"."BPM504"."PLANT" = :l_s_plant AND
				"PBBPM"."BPM504"."PPITN" = :l_s_citno AND
   			"PBBPM"."BPM504"."PDVSN" = :l_s_div  AND   
         	(( "PBBPM"."BPM504"."PEDTE" = '' ) OR  
         	( "PBBPM"."BPM504"."PEDTE" <> '' AND  
         	"PBBPM"."BPM504"."PEDTE" >= :i_s_enddate AND  "PBBPM"."BPM504"."PEDTE" >= "PBBPM"."BPM504"."PEDTM"))       
...
this.Control[iCurrent+21]=this.uo_year
this.Control[iCurrent+22]=this.st_1
this.Control[iCurrent+23]=this.cb_stop
this.Control[iCurrent+24]=this.cb_go
this.Control[iCurrent+25]=this.cb_8
this.Control[iCurrent+26]=this.uo_2
this.Control[iCurrent+27]=this.gb_3
end on

on w_bpm402u.destroy
call super::destroy
destroy(this.tv_1)
destroy(this.st_3)
destroy(this.sle_1)
...
if f_spacechk(l_s_itno) = -1  and rb_1.checked = true then 
	 ...
	 l_n_rows = ids_data3.retrieve(i_s_applyyear,i_s_revno,l_s_plant,l_s_div,l_s_pdcd)
	 l_n_check = 1
else
	...
	SELECT "PBBPM"."BPM503"."PDCD"  
   	INTO :l_s_pdcd1  
   	FROM "PBBPM"."BPM503"  
   	WHERE ( "PBBPM"."BPM503"."XYEAR" = :i_s_applyyear ) AND
				( "PBBPM"."BPM503"."REVNO" = :i_s_revno ) AND
         	( "PBBPM"."BPM503"."XPLANT" = :l_s_plant ) AND  
         	( "PBBPM"."BPM503"."DIV" = :l_s_div ) AND  
         	( "PBBPM"."BPM503"."ITNO" = :l_s_itno )  using sqlca;
	...
	if f_spacechk(sle_1.text) <> -1 and rb_1.checked = true then
		l_s_clsbsrce = f_bpm_get_balance(i_s_applyyear,i_s_revno,l_s_plant,l_s_div, l_s_itno)
		l_s_itno = string(l_s_itno, "@@@@@@@@@@@@" )
      root_nm = l_s_itno  + "    "  + l_s_clsbsrce
		root_data = l_s_itno
   	l_n_rows = ids_data1[1].retrieve(i_s_applyyear,i_s_revno,l_s_plant,l_s_div,l_s_itno, i_s_applydate)
   else 
		if f_spacechk(sle_1.text) <> -1 and rb_2.checked = true then
			l_s_clsbsrce = f_bpm_get_balance(i_s_applyyear,i_s_revno,l_s_plant,l_s_div, l_s_itno)
			l_s_itno = string(l_s_itno, "@@@@@@@@@@@@" )
			root_nm = l_s_itno  + "    "  + l_s_clsbsrce
			root_data = l_s_itno
			l_n_rows = ids_data2[1].retrieve(i_s_applyyear,i_s_revno,l_s_plant,l_s_div,l_s_itno, i_s_applydate)
		end if
	end if
end if
if l_n_rows < 1 then
...
if l_s_handle = -1 or l_s_handle = 1 then
	...
	SELECT "PBBPM"."BPM503"."PDCD"  
   	...
   	WHERE ( "PBBPM"."BPM503"."XYEAR" = :i_s_applyyear ) AND
         	...
         	( "PBBPM"."BPM503"."XPLANT" = :l_s_plant ) AND  
         	( "PBBPM"."BPM503"."DIV" = :l_s_div ) AND  
         	( "PBBPM"."BPM503"."ITNO" = :l_s_ppitn )   using sqlca;
...
l_s_rtncd = f_bpm_get_balance(i_s_applyyear,i_s_revno,l_s_plant, l_s_div, l_s_ppitn)
...
dw_edit.object.xyear[1] = i_s_applyyear
dw_edit.object.revno[1] = i_s_revno
wf_rgbclear()
...
dw_edit.object.pedtm.protect = true
dw_edit.object.pedte.protect = true
...
if rb_1.checked = true then
	...
	do until l_n_row = 0 
		...
		l_s_chkitno = f_option_chk_after_bpm(i_s_applyyear,i_s_revno,l_s_plant, l_s_div, l_s_citno, i_s_applydate)
		if f_spacechk(l_s_chkitno) <> -1 then
			if f_option_check_bpm(i_s_applyyear,i_s_revno,l_s_plant,l_s_div,l_s_chkitno) = 0 then
				l_s_chkitno = mid(l_s_chkitno,1,12)
				l_s_parm = i_s_applyyear + i_s_revno + l_s_plant + l_s_div + l_s_chkitno
				openwithparm(w_bpm402u_res_04, l_s_parm)
			...
			UPDATE  "PBBPM"."BPM504" 
				SET  "PEDTE" = :i_s_enddate, "PCHCD" = 'D'
//         delete from "PBBPM"."BPM504"
				WHERE "PCMCD" = '01' AND "PLANT" = :l_s_plant AND 
				      "XYEAR" = :i_s_applyyear AND "REVNO" = :i_s_revno AND
				      "PDVSN" = :l_s_div and "PPITN" = :l_s_ppitn AND 
	...
	loop
	 dw_2.reset()
    dw_2.retrieve(i_s_applyyear,i_s_revno,l_s_plant,l_s_div,l_s_ppitn, i_s_applydate)
end if
	...
	if l_n_rcnt <> l_n_row1 then	
		...
		if f_spacechk(l_s_chkitno) <> -1 then
			...
			if l_n_yesno <> 1 then
				...
				wf_option_update(l_s_plant,l_s_div,l_s_chkitno,l_s_citno,'D', '   ' , i_s_applydate)
			end if
		end if
	end if
	do until l_n_row = 0
...
//      delete from "PBBPM"."BPM504" 
	...
	loop
	dw_3.reset()
	dw_3.retrieve(i_s_applyyear,i_s_revno,l_s_plant,l_s_div,l_s_citno,i_s_applydate)
end if

f_bpm_job_end(i_s_applyyear,i_s_revno,'w_bpm402u',g_s_empno,'C','사업계획BOM정보 삭제 :' + i_s_revno)
...
l_s_itclsb = f_bpm_get_balance(i_s_applyyear,i_s_revno,l_s_plant,l_s_div,l_s_ppitn)
...
if l_s_sel = "A" then
	 if f_spacechk(l_s_pcitn) = -1 then
	   ...
	   select count(*) into : l_n_cnt from "PBBPM"."BPM503"
	   	where "PBBPM"."BPM503"."XYEAR" = :i_s_applyyear and
					"PBBPM"."BPM503"."REVNO" = :i_s_revno and
					"PBBPM"."BPM503"."XPLANT" = :l_s_plant and
					"PBBPM"."BPM503"."DIV" = :l_s_div and 
   	...
   	if l_n_cnt = 0 then
   	   ...
   	   select count(*) into : l_n_cnt from "PBBPM"."BPM504"
	     	 	where "PBBPM"."BPM504"."PCMCD" = '01' AND
						...
						"PBBPM"."BPM504"."PLANT" = :l_s_plant AND 
						"PBBPM"."BPM504"."PDVSN" = :l_s_div AND 
						"PBBPM"."BPM504"."PCITN" = :l_s_pcitn AND "PBBPM"."BPM504"."PPITN" = :l_s_ppitn AND 
						(( "PBBPM"."BPM504"."PEDTE" = ' '  and "PBBPM"."BPM504"."PEDTM" <= :i_s_applydate ) or
  						( "PBBPM"."BPM504"."PEDTE" <> ' ' and "PBBPM"."BPM504"."PEDTM"<= :i_s_applydate
                		and "PBBPM"."BPM504"."PEDTE" >= :i_s_applydate ))
				    using sqlca;
	      if l_n_cnt > 0 then
		     l_s_errchk = 1
   	     ...
   	     if l_s_ppitn = l_s_pcitn then
			     ...
			     uo_status.st_message.text = f_message("E330")
					...
					if f_chk_bom_bpm(i_s_applyyear,i_s_revno,l_s_plant,l_s_div,l_s_ppitn,l_s_pcitn,i_s_applydate) = 1 then	
		            l_s_errchk = 1 
			         uo_status.st_message.text = f_message("E330")
	            end if
	        end if
...
l_s_errchk = 0
l_s_srce1   = f_bpm_get_srce(i_s_applyyear,i_s_revno,l_s_plant,l_s_div,l_s_pcitn)
...
if f_spacechk(l_s_edte) <> -1 and f_spacechk(l_s_edtm) <> -1 then
	if l_s_edte >= i_s_applydate then
			if f_spacechk(l_s_column) = -1 then
	         l_s_column = "pedte"
         end if
			dw_edit.object.pedte.background.color = rgb(255,255,0)
...
if l_s_sel = "A" then
	...
	l_s_chdt  = g_s_date
	l_s_chkitno = f_option_chk_after_bpm(i_s_applyyear,i_s_revno,l_s_plant,l_s_div,l_s_pcitn,i_s_applydate) 
	if f_spacechk(l_s_chkitno) <> -1 and f_option_check_bpm(i_s_applyyear,i_s_revno,l_s_plant,l_s_div,l_s_chkitno) = 0 then
		...
		select "PBBPM"."BPM505"."OFITN" from "PBBPM"."BPM505"
			  where "PBBPM"."BPM505"."OCMCD" = '01' AND
			  			"PBBPM"."BPM505"."XYEAR" = :i_s_applyyear AND
						"PBBPM"."BPM505"."REVNO" = :i_s_revno AND
			  			"PBBPM"."BPM505"."OPITN" = :l_s_chkitno AND
					  "PBBPM"."BPM505"."ODVSN" = :l_s_div AND  
						("PBBPM"."BPM505"."OEDTE" = ''  OR  
						"PBBPM"."BPM505"."OEDTE" >= :i_s_applydate )    
			  using SQLCA ;
			open optchk_cur ;
		 ...
		 for k = 1 to i
			DELETE FROM "PBBPM"."BPM504"  
			WHERE PCMCD = :G_S_COMPANY AND  XYEAR = :i_s_applyyear AND REVNO = :i_s_revno AND
					PLANT = :L_S_plant AND PDVSN = :L_S_DIV AND 
			...
			INSERT INTO "PBBPM"."BPM504"  
				...
				VALUES (:g_s_company,:i_s_applyyear,:i_s_revno,:l_s_plant,:l_s_div,:l_s_ppitn,:l_s_rout,:l_s_oitno[k],:l_s_chdt,:l_s_qtym,:l_s_qtye
		...
		INSERT INTO "PBBPM"."BPM504"  
			( "PCMCD","XYEAR","REVNO","PLANT","PDVSN","PPITN","PROUT","PCITN","PCHDT","PQTYM","PQTYE", "PWKCT","PEDTM",   
			  "PEDTE","POPCD","PEXPLANT","PEXDV","PCHCD","POSCD","PEBST",
			  "PMACADDR","PIPADDR","PINDT","PEMNO","PREMK" )  
			VALUES (:g_s_company,:i_s_applyyear,:i_s_revno,:l_s_plant,:l_s_div,:l_s_ppitn,:l_s_rout,:l_s_pcitn,:l_s_chdt,:l_s_qtym,:l_s_qtye
			  ,:l_s_wkct,:l_s_edtm,:l_s_edte,' ',:l_s_explant,:l_s_exdv,'A',:l_s_oscd,:l_s_ebst
			  ,:g_s_macaddr,:g_s_ipaddr,:g_s_date,:g_s_empno,' ')
			using sqlca;
   ...
   INSERT INTO "PBBPM"."BPM504"  
			( "PCMCD","XYEAR","REVNO","PLANT","PDVSN","PPITN","PROUT","PCITN","PCHDT","PQTYM","PQTYE", "PWKCT","PEDTM",   
			  "PEDTE","POPCD","PEXPLANT","PEXDV","PCHCD","POSCD","PEBST",
			  "PMACADDR","PIPADDR","PINDT","PEMNO","PREMK" )  
			VALUES (:g_s_company,:i_s_applyyear,:i_s_revno,:l_s_plant,:l_s_div,:l_s_ppitn,:l_s_rout,:l_s_pcitn,:g_s_date,:l_s_qtym,:l_s_qtye
	...
	if f_spacechk(l_s_chkitno) <> -1 and l_s_chkitno <> l_s_pcitn then
		l_s_valid_date = f_bpm_vaild_datechk(i_s_applyyear,i_s_revno,l_s_plant,l_s_div,l_s_ppitn,l_s_pcitn,'  ','  ')
...
f_bpm_job_end(i_s_applyyear,i_s_revno,'w_bpm402u',g_s_empno,'C','사업계획BOM정보 저장 :' + i_s_revno)
...
if rb_2.checked = true then
	dw_3.reset()
	dw_edit.reset()
   dw_3.retrieve(i_s_applyyear,i_s_revno,l_s_plant,l_s_div,l_s_pcitn, i_s_applydate)
end if
...
type uo_status from w_origin_sheet01`uo_status within w_bpm402u
integer y = 2480
end type
...
if l_n_level <> 1 or f_spacechk(sle_1.text) <> -1  then
	if rb_1.checked = true then
		dw_2.reset()
		dw_2.retrieve(i_s_applyyear,i_s_revno,l_s_plant,l_s_div,l_tvi_current.data,i_s_applydate)
	end if
	if rb_2.checked = true then
		dw_3.reset()
		dw_3.retrieve(i_s_applyyear,i_s_revno,l_s_plant,l_s_div,l_tvi_current.data,i_s_applydate)
	end if
end if
...
wf_rgbclear()
dw_edit.retrieve(i_s_applyyear,i_s_revno,l_s_plant,l_s_div, l_s_itno1, l_s_itno2,l_s_date)
...
l_s_parm = i_s_applyyear + i_s_revno + l_s_plant + l_s_div + l_s_ppitn_01 + l_s_errchk

openwithparm(w_bpm402u_res_02, l_s_parm)
...
l_s_chkitno = f_option_chk_after_bpm(i_s_applyyear,i_s_revno,l_s_plant,l_s_div,l_s_ppitn,g_s_date) 	

if l_s_chkitno <> "" then
	l_s_parm = ""
   if f_option_check_bpm(i_s_applyyear,i_s_revno,l_s_plant,l_s_div,l_s_chkitno) = 1 then
		l_s_parm = i_s_applyyear + i_s_revno + l_s_plant + l_s_div + l_s_chkitno
      openwithparm(w_bpm402u_res_04, l_s_parm)	
	end if
end if
...
openwithparm(w_bpm402u_res_01, l_s_parm)
...
boolean bringtotop = true
string dataobject = "d_bpm504_105u_update"
...
string dataobject = "d_bpm504_explo_04"
boolean hscrollbar = true
...
wf_rgbclear()
dw_edit.retrieve(i_s_applyyear,i_s_revno,l_s_plant,l_s_div, l_s_itno1, l_s_itno2,l_s_chdt)
...
for i = 1 to rowcount
	ls_midval = f_option_chk_after_BPM(i_s_applyyear,i_s_revno,this.object.plant[i],this.object.pdvsn[i],trim(this.object.pcitn[i]),g_s_date) 
...
string dataobject = "d_bpm504_implo_04"
boolean hscrollbar = true
boolean vscrollbar = true
boolean hsplitscroll = true
boolean livescroll = true
...
event ue_modify;call super::ue_modify;w_bpm402u.triggerevent("ue_retrieve")
end event
...
event clicked;f_bpm_job_stop(uo_year.uf_return(),i_s_revno,'w_bpm402u',g_s_empno,'C','BOM등록 확정작업')
...
event clicked;f_bpm_job_go(i_s_applyyear,i_s_revno,'w_bpm402u',g_s_empno,'C','BOM등록 확정취소작업')
...
openwithparm(w_bpm402u_res_05, l_s_parm)
...
if f_dateedit(i_s_applydate) = space(8) then
	messagebox("확인","BOM기준일자가 잘못 되었습니다.")
end if
