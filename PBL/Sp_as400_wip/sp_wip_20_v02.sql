...
WHERE WCCMCD = a_cmcd AND WCPLANT = a_plant AND WCDVSN = a_dvsn AND
  WCYEAR = a_yy01 AND WCMONTH = a_mm01 AND WCSRCE <> '04' AND
  WCBGAT1 = 0 AND WCBGAT2 = 0 AND WCINAT1 = 0 AND WCINAT2 = 0 AND
  WCUSAT1 = 0 AND WCUSAT2 = 0 AND WCUSAT3 = 0 AND WCUSAT4 = 0 AND
  WCUSAT5 = 0 AND WCUSAT6 = 0 AND WCUSAT7 = 0 AND WCUSAT8 = 0 AND
  WCUSAT9 = 0 ;
