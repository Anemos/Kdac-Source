...
-- create qtemp.bomtemp02

 create table qtemp.bomtemp02 (tcmcd char(2) not null,
...
insert into qtemp.bomtemp02(tcmcd,tplnt,tdvsn,tmodl,
...
loop
 ...
 if a_chk = 'C' or a_chk = 'D'
    or a_chk = 'G' or a_chk = 'H' or a_chk = 'K' then
    if p_srce = '05' or p_srce = '06' then
       goto inc_loop01;
    end if;
 end if;
 if a_chk = 'E' or a_chk = 'F' or a_chk = 'K' or
