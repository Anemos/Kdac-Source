-- file name : sp_wip_10
-- procedure name : pbwip.sp_wip_10
-- desc : WIP002 Line WIP Update

drop procedure pbwip.sp_wip_10;

create procedure pbwip.sp_wip_10 (
...
select xplant, div, slno, itno, xuse, rtngub, dept,
       vsrno, tdte4, tqty1, tqty2, tqty3, tqty4, updtdt
into p_plant,p_dvsn,p_slno,p_itno,p_xuse,p_rtngub,p_dept,
       p_prdpt,p_tdte4,p_tqty1,p_tqty2,p_tqty3,p_tqty4,p_inpttm
from pbinv.inv401
