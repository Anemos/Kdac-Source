-- file name : sp_wip_051
-- procedure name : pbwip.sp_wip_051
-- desc : WIP History Deploy Check ( include iocd = 03 )
-- retrieve condition add : fromdate to enddate

drop procedure pbwip.sp_wip_051;
create procedure pbwip.sp_wip_051 (
...
declare wipchk_cur cursor for
  ...
  where wdcmcd = a_comltd and wdplant = a_plant and
        wddvsn = a_dvsn and
        wdslty = 'WC' and
        wddate >= a_fromdate and wddate <= a_todate and
        wdupdtid <> 'Y'
