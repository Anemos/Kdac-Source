-- file name : sf_bom_ske
-- procedure name : pbpdm.sf_bom_ske
-- desc : bom explosion for inv101 현재월기준
...
drop function pbpdm.sf_bom_ske;
create function pbpdm.sf_bom_ske (
a_comltd varchar(2),
a_plant varchar(1),
a_dvsn varchar(1),
a_itno   varchar(15),
...
select a.plant,a.pdvsn,a.pcitn,a.pwkct,a.poscd,a.pedtm,a.pedte,
 a.pqtym,a.pexplant,a.pexdv,ifnull(b.cls,''),ifnull(b.srce,''),
 (case when ifnull(b.convqty,1) = 0 then 1 else 
  ifnull(b.convqty,1) end),ifnull(b.comcd,'')
from pbpdm.bom001 a left outer join pbinv.inv101 b
