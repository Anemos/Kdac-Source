-- file name : sf_bom_103
-- procedure name : pbpdm.sf_bom_103
-- desc : BOM 전체 재료비 데이타생성함수 : 고객사유상포함 'A'
-- a_comltd, a_plant, a_dvsn, a_itno, a_pdcd, a_costdiv,
-- a_yyyymm, a_createdate, a_rtn
drop function pbpdm.sf_bom_103;
create function pbpdm.sf_bom_103 (
a_comltd char(2),
a_plant char(1),
a_dvsn char(1),
a_itno varchar(15),
