-- file name : pbpdm.sp_bom_102
-- procedure name : pbpdm.sp_bom_102
...
drop procedure pbpdm.sp_bom_102;
create procedure pbpdm.sp_bom_102 (
in a_comltd char(2),
...
loop
  ...
  -- call sp_bom_101
  call pbpdm.sp_bom_101(a_comltd,p_plant,p_dvsn,
