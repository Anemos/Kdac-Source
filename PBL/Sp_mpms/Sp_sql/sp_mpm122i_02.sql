/*
  File Name : sp_mpm122i_02.SQL
  SYSTEM    : MPMS System
  Procedure Name  : sp_mpm122i_02
  Description : 완료상태인 금형 진행정보
  Use DataBase  : MPMS
  Use Program :
...
If Exists (Select * From sysobjects
      Where id = object_id(N'[dbo].[sp_mpm122i_02]')
        And OBJECTPROPERTY(id, N'IsProcedure') = 1)
  Drop Procedure [dbo].[sp_mpm122i_02]
GO

/*
Execute sp_mpm122i_02 '20040001'
*/

Create Procedure sp_mpm122i_02
  @ps_orderno char(8)

As
Begin

select aa.orderno, aa.toolname, aa.duedate, bb.partno, 
