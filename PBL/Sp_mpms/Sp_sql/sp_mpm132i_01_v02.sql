/*
  File Name : sp_mpm132i_01.SQL
  SYSTEM    : MPMS System
  Procedure Name  : sp_mpm132i_01
  Description : 부서,모델별 진행집계표
  적용년월을 기준으로 하여 진행되고있는 Order에 대한 집계
...
If Exists (Select * From sysobjects
      Where id = object_id(N'[dbo].[sp_mpm132i_01]')
        And OBJECTPROPERTY(id, N'IsProcedure') = 1)
  Drop Procedure [dbo].[sp_mpm132i_01]
GO

/*
Execute sp_mpm132i_01 '2009.01.01','2009.01.31'
*/

Create Procedure sp_mpm132i_01
  @ps_fromdt char(10),
  @ps_todt char(10)
As
Begin
...
( select OrderDept = aa.OrderDept,
  ...
  where convert(char(10),aa.startdate,102) <= @ps_todt and
        ( aa.enddate is null or convert(char(10),aa.enddate,102) > @ps_todt )
