/*
  File Name : sp_mpm134i_01_test.SQL
  SYSTEM    : 금형공정관리시스템
  View Name  : sp_mpm134i_01_test
...
If Exists (Select * From sysobjects
      Where id = object_id(N'[dbo].[sp_mpm134i_01_test]')
        And OBJECTPROPERTY(id, N'IsProcedure') = 1)
  Drop Procedure [dbo].[sp_mpm134i_01_test]
GO

/*
Execute sp_mpm134i_01_test '20050101','20050131','%'
*/

Create Procedure sp_mpm134i_01_test
...
group by aa.wccode, bb.wcserial, aa.mchno, cc.orderno, dd.toolname
...
group by tmp.wccode, bb.wcserial, tmp.mchno

Union all

Select wccode = tmp_a.wccode,
  wcserial = tmp_b.wcserial,
...
From  ( select distinct wccode, (select top 1 aa.mchno  from tmachine aa where aa.wccode = bb.wccode ) as mchno
  ...
  Where cc.workdate >= @ps_fromdt and cc.workdate <= @ps_todt and
    cc.orderno like @ps_orderno
  group by aa.wccode, bb.wcserial ) tmp_b
...
Where cc.workdate >= @ps_fromdt and cc.workdate <= @ps_todt and
  cc.orderno like @ps_orderno
group by aa.wccode, bb.wcserial, aa.mchno
