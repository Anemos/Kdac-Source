/*
  ...
  Use DataBase  : MPMS
  Use Program :
  Parameter : @ps_orderno varchar(9), @ps_toolname varchar(50)
  Use Table :
  Initial   : 2004.03
  Author    : Kiss Kim
*/
...
/*
Execute sp_mpms_find_orderno @ps_orderno, @ps_toolname
*/

Create Procedure sp_mpms_find_orderno
  @ps_orderno  varchar(9),
  @ps_toolname varchar(50)
...
where isnull(aa.deptgubun,'') = '1' and
      aa.orderno like @ps_orderno and aa.toolname like @ps_toolname
