...
declare @li_detailno int, @li_gubuncnt int, @li_serialno int
declare @ls_toolname  varchar(100), @ls_duedate varchar(8), @ls_enddate varchar(8)
declare @ls_partno char(6), @ls_operno char(3), @ls_wccode char(3), @ls_outflag char(1)
...
CREATE TABLE #oper_tmp (
  ...
  [OutFlag01]   [char]    (1)     NULL,
  [Oper02]      [char]    (3)     NULL,
  [EndDt02]     [varchar] (8)     NULL,
  [OutFlag02]   [char]    (1)     NULL,
  [Oper03]      [char]    (3)     NULL,
  [EndDt03]     [varchar] (8)     NULL,
  [OutFlag03]   [char]    (1)     NULL,
  [Oper04]      [char]    (3)     NULL,
  [EndDt04]     [varchar] (8)     NULL,
  [OutFlag04]   [char]    (1)     NULL,
  [Oper05]      [char]    (3)     NULL,
  [EndDt05]     [varchar] (8)     NULL,
  [OutFlag05]   [char]    (1)     NULL,
  [Oper06]      [char]    (3)     NULL,
  [EndDt06]     [varchar] (8)     NULL,
  [OutFlag06]   [char]    (1)     NULL,
  [Oper07]      [char]    (3)     NULL,
  [EndDt07]     [varchar] (8)     NULL,
  [OutFlag07]   [char]    (1)     NULL,
  [Oper08]      [char]    (3)     NULL,
  [EndDt08]     [varchar] (8)     NULL,
  [OutFlag08]   [char]    (1)     NULL,
  [Oper09]      [char]    (3)     NULL,
  [EndDt09]     [varchar] (8)     NULL,
  [OutFlag09]   [char]    (1)     NULL,
  [Oper10]      [char]    (3)     NULL,
  [EndDt10]     [varchar] (8)     NULL,
  [OutFlag10]   [char]    (1)     NULL
   )
...
begin
  ...
  insert into #oper_tmp
    select @li_serialno, @li_gubuncnt, @li_totcnt, aa.DetailNo, aa.SheetNo, aa.RevNo, aa.PartNo,
      aa.PartName, aa.Spec, aa.Material, isnull(aa.Qty1,0) + isnull(aa.Qty2,0),
    bb.maxdt, null, null, 'N', null, null, 'N', null, null, 'N', null, null, 'N',
    null, null, 'N', null, null, 'N', null, null, 'N', null, null, 'N', null, null,
    'N', null, null, 'N'
  ...
  select operno, wccode, outflag into #routing_tmp
  from trouting
  where orderno = @ps_orderno and partno = @ls_partno
  order by operno
  ...
  while @li_subcnt < @li_subtot
    Begin
      ...
      if (@li_subcnt % 10) = 1
        update #oper_tmp
        set oper01 = @ls_wccode, enddt01 = @ls_enddate, outflag01 = @ls_outflag
        where partno = @ls_partno and gubunno = @li_gubuncnt
      if (@li_subcnt % 10) = 2
        update #oper_tmp
        set oper02 = @ls_wccode, enddt02 = @ls_enddate, outflag02 = @ls_outflag
        where partno = @ls_partno and gubunno = @li_gubuncnt
      if (@li_subcnt % 10) = 3
        update #oper_tmp
        set oper03 = @ls_wccode, enddt03 = @ls_enddate, outflag03 = @ls_outflag
        where partno = @ls_partno and gubunno = @li_gubuncnt
      if (@li_subcnt % 10) = 4
        update #oper_tmp
        set oper04 = @ls_wccode, enddt04 = @ls_enddate, outflag04 = @ls_outflag
        where partno = @ls_partno and gubunno = @li_gubuncnt
      if (@li_subcnt % 10) = 5
        update #oper_tmp
        set oper05 = @ls_wccode, enddt05 = @ls_enddate, outflag05 = @ls_outflag
        where partno = @ls_partno and gubunno = @li_gubuncnt
      if (@li_subcnt % 10) = 6
        update #oper_tmp
        set oper06 = @ls_wccode, enddt06 = @ls_enddate, outflag06 = @ls_outflag
        where partno = @ls_partno and gubunno = @li_gubuncnt
      if (@li_subcnt % 10) = 7
        update #oper_tmp
        set oper07 = @ls_wccode, enddt07 = @ls_enddate, outflag07 = @ls_outflag
        where partno = @ls_partno and gubunno = @li_gubuncnt
      if (@li_subcnt % 10) = 8
        update #oper_tmp
        set oper08 = @ls_wccode, enddt08 = @ls_enddate, outflag08 = @ls_outflag
        where partno = @ls_partno and gubunno = @li_gubuncnt
      if (@li_subcnt % 10) = 9
        update #oper_tmp
        set oper09 = @ls_wccode, enddt09 = @ls_enddate, outflag09 = @ls_outflag
        where partno = @ls_partno and gubunno = @li_gubuncnt
      if (@li_subcnt % 10) = 0
        update #oper_tmp
        set oper10 = @ls_wccode, enddt10 = @ls_enddate, outflag10 = @ls_outflag
        where partno = @ls_partno and gubunno = @li_gubuncnt
    End
