/*
  File Name : sp_mpm240i_02.SQL
  SYSTEM    : MPMS System
  Procedure Name  : sp_mpm240i_02
  Description : 원가정보(완료)
  Use DataBase  : MPMS
  Use Program :
...
If Exists (Select * From sysobjects
      Where id = object_id(N'[dbo].[sp_mpm240i_02]')
        And OBJECTPROPERTY(id, N'IsProcedure') = 1)
  Drop Procedure [dbo].[sp_mpm240i_02]
GO

/*
Execute sp_mpm240i_02 '2004.04.01','2004.05.06','%','%'
*/

Create Procedure sp_mpm240i_02
