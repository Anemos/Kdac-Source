/*
  File Name : sp_mpm220u_03_left.SQL
  SYSTEM    : 금형공정관리 시스템
  Procedure Name  : sp_mpm220u_03_left
...
If Exists (Select * From sysobjects
      Where id = object_id(N'[dbo].[sp_mpm220u_03_left]')
        And OBJECTPROPERTY(id, N'IsProcedure') = 1)
  Drop Procedure [dbo].[sp_mpm220u_03_left]
GO

/*
Execute sp_mpm220u_03_left '@ps_orderno', '@ps_partno'
*/

Create Procedure sp_mpm220u_03_left
  @ps_orderno char(8),
  @ps_partno char(6)
