/*
  File Name : sp_mpm250u_02.SQL
  SYSTEM    : MPMS System
  Procedure Name  : sp_mpm250u_02
  Description : 외주가공발주관리 - 외주가공상세현황
  Use DataBase  : MPMS
  Use Program :
  Parameter : @ps_serialno char(10) - SerialNo
...
If Exists (Select * From sysobjects
      Where id = object_id(N'[dbo].[sp_mpm250u_02]')
        And OBJECTPROPERTY(id, N'IsProcedure') = 1)
  Drop Procedure [dbo].[sp_mpm250u_02]
GO

/*
Execute sp_mpm250u_02 '2006000001'
*/

Create Procedure sp_mpm250u_02
  @ps_serialno char(10)
...
from torder aa inner join toutprocess bb
  ...
  inner join toutorderdetail ee
  on ee.serialno = @ps_serialno and ee.orderno = bb.orderno and
    ee.partno = bb.partno and ee.outserial = bb.outserial
