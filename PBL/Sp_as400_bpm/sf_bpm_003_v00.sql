-- file name : pbbpm.sf_bpm_003
-- function name : pbbpm.sf_bpm_003 내수가 적용
-- desc : 하위레벨의 유상단가 차이의 누계금액 계산
-- woct '9999' : 하위전체 8888인 품목의 차이금액 합계 계산
-- woct '8888' : 1레벨 하위 8888 품목의 차이 합계 계산

drop   function  pbbpm.sf_bpm_003 ;
create function  pbbpm.sf_bpm_003(
   a_comltd            varchar(2),
   a_xyear             varchar(4),
   a_rev               varchar(2),
   a_gubun             varchar(1),
   ...
   begin
      ...
      select sum(a.zwondamt - a.zwonsamt) into ld_amtsum
