...
select [cause_code],[cause_name],[area_code],'M'
from [CMMS].[dbo].[cause_master]
where [area_code] = 'J' and [factory_code] = 'S'
...
SELECT [class_div_code],[class_div_name],[area_code],'M'
FROM [CMMS].[dbo].[class_div_master]
WHERE [AREA_CODE] = 'J' AND [FACTORY_CODE] = 'S'
...
SELECT [cycle_code],[cycle_name],[area_code],'M'
FROM [CMMS].[dbo].[cycle_master]
WHERE [AREA_CODE] = 'J' AND [FACTORY_CODE] = 'S'
...
SELECT [emp_code],[certify_name],[certify_rank],[certify_number],[certify_institution],[certify_expire],[area_code],'M'
FROM [CMMS].[dbo].[emp_certify]
WHERE [AREA_CODE] = 'J' AND [FACTORY_CODE] = 'S'
...
SELECT [equip_code],[change_date],[change_descript],[change_remark],[area_code],'M'
FROM [CMMS].[dbo].[equip_change]
WHERE [AREA_CODE] = 'J' AND [FACTORY_CODE] = 'S'
...
[class_est_time_hour],[class_est_time_min],[part_code],[class_qty],[area_code],'M'
FROM [CMMS].[dbo].[equip_class]
WHERE [AREA_CODE] = 'J' AND [FACTORY_CODE] = 'S'
...
SELECT [equip_div_code]
           ...
           ,[area_code]
           ,'M'
FROM [CMMS].[dbo].[equip_div_master]
WHERE [AREA_CODE] = 'J' AND [FACTORY_CODE] = 'S'
...
SELECT [equip_code]
           ...
           ,[area_code]
           ,'M'
FROM [CMMS].[dbo].[equip_meter_master]
WHERE [AREA_CODE] = 'J' AND [FACTORY_CODE] = 'S'
...
SELECT [sched_div_code]
           ...
           ,[area_code]
           ,'M'
FROM [CMMS].[dbo].[sched_div_master]
WHERE [AREA_CODE] = 'J' AND [FACTORY_CODE] = 'S'
