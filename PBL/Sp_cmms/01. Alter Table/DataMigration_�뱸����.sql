...
from [CMMS_MOR].[dbo].[cause_master] a
...
FROM [CMMS_MOR].[dbo].[class_div_master] a
...
select [area_code]
           ...
           ,[part_cost_sum]
           ,[repair_cost_sum]
from [CMMS_MOR].[dbo].[cmms_wo_cost_sum] a
...
select [area_code]
           ...
           ,[wo_time_sum]
           ,[wo_count]
from [CMMS_MOR].[dbo].[cmms_wo_sum] a
...
select [comp_div_code]
           ,[comp_div_name]
from [CMMS_MOR].[dbo].[comp_div_master] a
...
select [comp_code]
           ...
           ,[comp_email]
           ,[comp_remark]
from [CMMS_MOR].[dbo].[comp_master] a
...
select [comp_code]
           ...
           ,[comp_hour_value]
           ,[comp_work_value]
from [CMMS_MOR].[dbo].[comp_service] a
...
FROM [CMMS_MOR].[dbo].[cycle_master] a
...
select [dept_code]
           ,[dept_name]
FROM [CMMS_MOR].[dbo].[dept_master] a
...
[certify_expire],[area_code],[factory_code]
FROM [CMMS_MOR].[dbo].[emp_certify] a
...
select [emp_code]
           ...
           ,[emp_pass]
           ,[pic_path]
FROM [CMMS_MOR].[dbo].[emp_master] a
...
FROM [CMMS_MOR].[dbo].[equip_change] a
...
[class_est_time_hour],[class_est_time_min],[part_code],[class_qty],[area_code],[factory_code]
FROM [CMMS_MOR].[dbo].[equip_class] a
...
select [area_code]
           ,[factory_code]
           ,[equip_count]
FROM [CMMS_MOR].[dbo].[equip_count] a
...
,[area_code]
,[factory_code]
FROM [CMMS_MOR].[dbo].[equip_daily_01] a
...
SELECT [equip_code]
           ...
           ,[area_code]
           ,[factory_code]
FROM [CMMS_MOR].[dbo].[equip_daily_02] a
...
SELECT [equip_code]
           ...
           ,[area_code]
           ,[factory_code]
FROM [CMMS_MOR].[dbo].[equip_daily_03] a
...
SELECT [equip_div_a_code]
           ...
           ,[area_code]
           ,[factory_code]
FROM [CMMS_MOR].[dbo].[equip_div_a] a
...
SELECT [equip_div_a_code]
           ...
           ,[area_code]
           ,[factory_code]
FROM [CMMS_MOR].[dbo].[equip_div_b] a
...
SELECT [equip_div_code]
           ...
           ,[area_code]
           ,[factory_code]
FROM [CMMS_MOR].[dbo].[equip_div_master] a
...
SELECT [equip_code]
           ...
           ,[area_code]
           ,[factory_code]
FROM [CMMS_MOR].[dbo].[equip_file] a
...
select [File_id]
           ...
           ,[LastEmp]
           ,[LastDate]
FROM [CMMS_MOR].[dbo].[EQUIP_FTPFILE] a
...
select [AREA_CODE]
           ...
           ,[LASTEMP]
           ,[LASTDATE]
FROM [CMMS_MOR].[dbo].[EQUIP_FTPUSER] a
...
SELECT [equip_code]
           ...
           ,[area_code]
           ,[factory_code]
FROM [CMMS_MOR].[dbo].[equip_guide] a
...
INSERT INTO [CMMS].[dbo].[EQUIP_GUIDE_CODE]
           ([GUIDE_CODE])
select [GUIDE_CODE]
FROM [CMMS_MOR].[dbo].[EQUIP_GUIDE_CODE] a
...
SELECT [equip_code]
           ...
           ,[area_code]
           ,[factory_code]
FROM [CMMS_MOR].[dbo].[equip_list] a
...
select [equip_code]
           ...
           ,[target_area]
           ,[target_factory]
FROM [CMMS_MOR].[dbo].[equip_master] a
...
select [area_code]
           ...
           ,[up_div]
           ,[last_dttm]
FROM [CMMS_MOR].[dbo].[equip_master_upload] a
...
SELECT [equip_code]
           ...
           ,[area_code]
           ,[factory_code]
FROM [CMMS_MOR].[dbo].[equip_meter] a
...
SELECT [equip_code]
           ...
           ,[area_code]
           ,[factory_code]
FROM [CMMS_MOR].[dbo].[equip_meter_master] a
...
SELECT [equip_code]
           ...
           ,[area_code]
           ,[factory_code]
FROM [CMMS_MOR].[dbo].[equip_safe] a
...
select [Area_code]
           ...
           ,[Part_flag]
           ,[Spare_desc]
FROM [CMMS_MOR].[dbo].[EQUIP_SPARE] a
...
SELECT [guide_code]
           ...
           ,[area_code]
           ,[factory_code]
FROM [CMMS_MOR].[dbo].[guide_master] a
...
select [area_code]
           ...
           ,[lastemp]
           ,[lastdate]
FROM [CMMS_MOR].[dbo].[LINE_MASTER] a
...
select [AreaCode]
           ...
           ,[LastEmp]
           ,[LastDate]
FROM [CMMS_MOR].[dbo].[part_buyback] a
...
select [area_code]
           ...
           ,[comp_code]
           ,[part_location]
FROM [CMMS_MOR].[dbo].[part_master] a
...
select [area_code]
           ...
           ,[comp_code]
           ,[down_div]
FROM [CMMS_MOR].[dbo].[part_master_in] a
...
select [part_location]
           ...
           ,[part_unit]
           ,[part_cost]
FROM [CMMS_MOR].[dbo].[part_master_real] a
...
select [EQUIP_CODE]
           ...
           ,[AREA_CODE]
           ,[FACTORY_CODE]
FROM [CMMS_MOR].[dbo].[PART_OUT_HIST] a
...
select [scandate]
           ...
           ,[ipaddr]
           ,[macaddr]
FROM [CMMS_MOR].[dbo].[part_out_temp] a
...
select [area_code]
           ...
           ,[input_div]
           ,[up_div]
FROM [CMMS_MOR].[dbo].[part_return] a
...
SELECT [process_code]
           ...
           ,[area_code]
           ,[factory_code]
FROM [CMMS_MOR].[dbo].[process_master] a
...
SELECT [sched_div_code]
           ...
           ,[area_code]
           ,[factory_code]
FROM [CMMS_MOR].[dbo].[sched_div_master] a
...
SELECT [equip_code]
           ...
           ,[area_code]
           ,[factory_code]
FROM [CMMS_MOR].[dbo].[schedule_next] a
...
SELECT [equip_code]
           ...
           ,[area_code]
           ,[factory_code]
FROM [CMMS_MOR].[dbo].[schedule_next2] a
...
SELECT [section_code]
           ...
           ,[area_code]
           ,[factory_code]
FROM [CMMS_MOR].[dbo].[section_master] a
...
SELECT [skill_code]
           ...
           ,[area_code]
           ,[factory_code]
FROM [CMMS_MOR].[dbo].[skill_master] a
...
SELECT [status_code]
           ...
           ,[area_code]
           ,[factory_code]
FROM [CMMS_MOR].[dbo].[status_master] a
...
SELECT [no_code]
           ...
           ,[area_code]
           ,[factory_code]
FROM [CMMS_MOR].[dbo].[task_autonumber] a
...
SELECT [task_code]
           ...
           ,[area_code]
           ,[factory_code]
FROM [CMMS_MOR].[dbo].[task_class] a
...
SELECT [task_code]
           ...
           ,[area_code]
           ,[factory_code]
FROM [CMMS_MOR].[dbo].[task_equip] a
...
SELECT [team_code]
           ...
           ,[area_code]
           ,[factory_code]
FROM [CMMS_MOR].[dbo].[team_master] a
...
SELECT [title_code]
           ...
           ,[area_code]
           ,[factory_code]
FROM [CMMS_MOR].[dbo].[title_master] a
...
SELECT [NOTYPE]
           ...
           ,[area_code]
           ,[factory_code]
FROM [CMMS_MOR].[dbo].[TMSTAUTONO] a
...
SELECT [DDATE]
           ...
           ,[area_code]
           ,[factory_code]
FROM [CMMS_MOR].[dbo].[TMSTCALENDAR] a
...
SELECT [used_code]
           ...
           ,[area_code]
           ,[factory_code]
FROM [CMMS_MOR].[dbo].[used_master] a
...
select [area_code]
           ...
           ,[no_name]
           ,[next_no]
FROM [CMMS_MOR].[dbo].[wo_autonumber] a
...
select [Area_Code]
           ...
           ,[except_time_time]
           ,[check_box]
FROM [CMMS_MOR].[dbo].[wo_except_time] a
...
select [mchno]
           ...
           ,[comp_code]
           ,[wo_value]
FROM [CMMS_MOR].[dbo].[wo_lab_list] a
