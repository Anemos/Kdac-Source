/*
  file name : sp_part_trans_down_new.sql
  system    : cmms system
  procedure name  : sp_part_trans_down_new
  description :
  use database  : cmms
  use program :
  parameter :
...
if exists (select * from sysobjects
      where id = object_id(N'[dbo].[sp_part_trans_down_new]')
        and objectproperty(id, N'isprocedure') = 1)
  drop procedure [dbo].[sp_part_trans_down_new]
go

/*
execute sp_part_trans_down_new
*/

create procedure [dbo].[sp_part_trans_down_new]
AS
BEGIN
