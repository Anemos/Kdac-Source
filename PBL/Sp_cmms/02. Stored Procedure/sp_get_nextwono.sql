/*
  file name : sp_get_nextwono.sql
  system    : cmms system
  procedure name  : sp_get_nextwono
  description :
  use database  : cmms
  use program :
  parameter :
...
if exists (select * from sysobjects
      where id = object_id(N'[dbo].[sp_get_nextwono]')
        and objectproperty(id, N'isprocedure') = 1)
  drop procedure [dbo].[sp_get_nextwono]
go

/*
execute sp_get_nextwono
*/

create procedure [dbo].[sp_get_nextwono]
@area_code char(1),
@factory_code char(1),
@psNOCODE   VARCHAR(30),
